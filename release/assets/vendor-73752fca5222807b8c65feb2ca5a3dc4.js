...
return e},{}):void 0}class l{static authorize(e,{authURL:t,scope:r,redirectUri:n,clientId:s}){if(i.default("[Authorize] authURL = ",t,"scope = ",r,"redirectUri = ",n,"clientId = ",s),!o.localStorageAvailable()&&"remotestorage"===e.backend){n+=n.indexOf("#")>0?"&":"#"
...
function s(){return i("Authorization was canceled")}o.addEventListener("loadstart",function(e){if(0!==e.url.indexOf(t))return
o.removeEventListener("exit",s),o.close()
const r=u(e.url)
return r?n(r):i("Authorization error")}),o.addEventListener("exit",s)})},l._rs_init=function(e){const t=u()
let r
...
var n=this&&this.__importDefault||function(e){return e&&e.__esModule?e:{default:e}}
const i=n(r(23)),o=n(r(24)),s=n(r(25)),a=n(r(2)),u=n(r(3)),l=r(0)
...
throw new s.default(e["@context"])}_defaultTypeURI(e){return"http://remotestorage.io/spec/modules/"+encodeURIComponent(this.moduleName)+"/"+encodeURIComponent(e)}_attachType(e,t){e["@context"]=c.Types.resolveAlias(this.moduleName+"/"+t)||this._defaultTypeURI(t)}makePath(e){return this.base+(e||"")}_fireChange(e){u.default.changeEvents[e.origin]&&(["new","old","lastCommon"].forEach(function(t){if((!e[t+"ContentType"]||/^application\/(.*)json(.*)/.exec(e[t+"ContentType"]))&&"string"==typeof e[t+"Value"])try{e[t+"Value"]=JSON.parse(e[t+"Value"])}catch(e){}}),this._emit("change",e))}static _rs_init(){}}c.Types=o.default,l.applyMixins(c,[a.default]),e.exports=c},function(e,t,r){"use strict";(function(t){var n=this&&this.__awaiter||function(e,t,r,n){return new(r||(r=Promise))(function(i,o){function s(e){try{u(n.next(e))}catch(e){o(e)}}function a(e){try{u(n.throw(e))}catch(e){o(e)}}function u(e){var t
...
var n=this&&this.__importDefault||function(e){return e&&e.__esModule?e:{default:e}}
const i=n(r(2)),o=n(r(3)),s=n(r(1)),a=r(0)
...
let s,a=n[o]
a||(n[o]=a=p(o)),0===i?(s=l(a),a.local={body:t,contentType:r,previousBody:s?s.body:void 0,previousContentType:s?s.contentType:void 0}):a=h(a,e[i-1].substring(o.length))}return n}catch(e){throw s.default("[Cachinglayer] Error during PUT",n,e),e}})}delete(e){const t=a.pathsFromRoot(e)
...
return Promise.all(i).then(()=>r)}):Promise.resolve([e])}_getInternals(){return{getLatest:l,makeNode:p,isOutdated:c}}}function l(e){if("object"==typeof e&&"string"==typeof e.path)if(a.isFolder(e.path)){if(e.local&&e.local.itemsMap)return e.local
...
for(const s of r.items)(null===(o=s.labels)||void 0===o?void 0:o.trashed)||(n=m(s.etag),"application/vnd.google-apps.folder"===s.mimeType?(this._fileIdCache.set(e+a.cleanPath(s.title)+"/",s.id),i[s.title+"/"]={ETag:n}):(this._fileIdCache.set(e+a.cleanPath(s.title),s.id),i[s.title]={ETag:n,"Content-Type":s.mimeType,"Content-Length":s.fileSize}))
...
return(o=s?this._getMetadata(e).then(e=>n&&"*"===n.ifNoneMatch&&e||n&&n.ifMatch&&e&&e.rev!==n.ifMatch?Promise.resolve({statusCode:412,revision:e.rev}):this._uploadSimple(a)):this._uploadSimple(a)).then(t=>(this._shareIfNeeded(e),t))}delete(e,t){if(!this.connected)throw new Error("not connected (path: "+e+")")
const r=this._revCache.get(e)
...
return void 0!==t.minProperties&&n.length<t.minProperties&&(r=this.createError(y.OBJECT_PROPERTIES_MINIMUM,{propertyCount:n.length,minimum:t.minProperties},"","/minProperties",null,e,t),this.handleError(r))||void 0!==t.maxProperties&&n.length>t.maxProperties&&(r=this.createError(y.OBJECT_PROPERTIES_MAXIMUM,{propertyCount:n.length,maximum:t.maxProperties},"","/maxProperties",null,e,t),this.handleError(r))?r:null},l.prototype.validateObjectRequiredProperties=function(e,t){if(void 0!==t.required)for(var r=0;r<t.required.length;r++){var n=t.required[r]
