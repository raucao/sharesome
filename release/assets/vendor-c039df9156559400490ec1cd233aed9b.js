...
return!!t&&(t===g||"GeneratorFunction"===(t.displayName||t.name))},a.mark=function(e){return Object.setPrototypeOf?Object.setPrototypeOf(e,y):(e.__proto__=y,o in e||(e[o]="GeneratorFunction")),e.prototype=Object.create(f),e},a.awrap=function(e){return new _(e)},b(w.prototype),a.async=function(e,t,r,n){var i=new w(d(e,t,r,n))
...
if(d.arg!==h)return v
n.delegate&&"next"===o&&(s=t)}else"throw"===d.type&&(i=p,o="throw",s=d.arg)}}}(e,n,a),s}function m(e,t,r){try{return{type:"normal",arg:e.call(t,r)}}catch(n){return{type:"throw",arg:n}}}function v(){}function g(){}function y(){}function b(e){["next","throw","return"].forEach(function(t){e[t]=function(e){return this._invoke(t,e)}})}function _(e){this.arg=e}function w(e){function t(r,n,i,o){var s=m(e[r],e,n)
...
var r=[],n=e.document,i=Object.getPrototypeOf,o=r.slice,s=r.concat,a=r.push,u=r.indexOf,l={},c=l.toString,p=l.hasOwnProperty,h=p.toString,f=h.call(Object),d={},m=function(e){return"function"==typeof e&&"number"!=typeof e.nodeType},v=function(e){return null!=e&&e===e.window},g={type:!0,src:!0,noModule:!0}
...
var x=function(e){var t,r,n,i,o,s,a,u,l,c,p,h,f,d,m,v,g,y,b,_="sizzle"+1*new Date,w=e.document,E=0,x=0,C=se(),T=se(),A=se(),R=function(e,t){return e===t&&(p=!0),0},k={}.hasOwnProperty,O=[],S=O.pop,P=O.push,N=O.push,M=O.slice,j=function(e,t){for(var r=0,n=e.length;r<n;r++)if(e[r]===t)return r
...
return n!=n||r?t:n<0?String.fromCharCode(n+65536):String.fromCharCode(n>>10|55296,1023&n|56320)},te=/([\0-\x1f\x7f]|^-?\d)|^-$|[^\0-\x1f\x7f-\uFFFF\w-]/g,re=function(e,t){return t?"\0"===e?"�":e.slice(0,-1)+"\\"+e.charCodeAt(e.length-1).toString(16)+" ":"\\"+e},ne=function(){h()},ie=ye(function(e){return!0===e.disabled&&("form"in e||"label"in e)},{dir:"parentNode",next:"legend"})
try{N.apply(O=M.call(w.childNodes),w.childNodes),O[w.childNodes.length].nodeType}catch(xe){N={apply:O.length?function(e,t){P.apply(e,M.call(t))}:function(e,t){for(var r=e.length,n=0;e[r++]=t[n++];);e.length=r-1}}}function oe(e,t,n,i){var o,a,l,c,p,d,g,y=t&&t.ownerDocument,E=t?t.nodeType:9
...
if(l.id===o)return n.push(l),n}else if(y&&(l=y.getElementById(o))&&b(t,l)&&l.id===o)return n.push(l),n}else{if(p[2])return N.apply(n,t.getElementsByTagName(e)),n
if((o=p[3])&&r.getElementsByClassName&&t.getElementsByClassName)return N.apply(n,t.getElementsByClassName(o)),n}if(r.qsa&&!A[e+" "]&&(!v||!v.test(e))){if(1!==E)y=t,g=e
...
g=d.join(","),y=X.test(e)&&me(t.parentNode)||t}if(g)try{return N.apply(n,y.querySelectorAll(g)),n}catch(x){}finally{c===_&&t.removeAttribute("id")}}}return u(e.replace(U,"$1"),t,n,i)}function se(){var e=[]
...
for(;s[n]===a[n];)n++
return n?ce(s[n],a[n]):s[n]===w?-1:a[n]===w?1:0},f):f},oe.matches=function(e,t){return oe(e,null,null,t)},oe.matchesSelector=function(e,t){if((e.ownerDocument||e)!==f&&h(e),t=t.replace(V,"='$1']"),r.matchesSelector&&m&&!A[t+" "]&&(!g||!g.test(t))&&(!v||!v.test(t)))try{var n=y.call(e,t)
...
return 1===n&&0===i?function(e){return!!e.parentNode}:function(t,r,u){var l,c,p,h,f,d,m=o!==s?"nextSibling":"previousSibling",v=t.parentNode,g=a&&t.nodeName.toLowerCase(),y=!u&&!a,b=!1
...
break}}else if(y&&(b=f=(l=(c=(p=(h=t)[_]||(h[_]={}))[h.uniqueID]||(p[h.uniqueID]={}))[e]||[])[0]===E&&l[1]),!1===b)for(;(h=++f&&h&&h[m]||(b=f=0)||d.pop())&&((a?h.nodeName.toLowerCase()!==g:1!==h.nodeType)||!++b||(y&&((c=(p=h[_]||(h[_]={}))[h.uniqueID]||(p[h.uniqueID]={}))[e]=[E,b]),h!==t)););return(b-=i)===n||b%n==0&&b/n>=0}}},PSEUDO:function(e,t){var r,i=n.pseudos[e]||n.setFilters[e.toLowerCase()]||oe.error("unsupported pseudo: "+e)
...
return r}(t||"*",a.nodeType?[a]:a,[]),v=!e||!o&&t?m:_e(m,h,e,a,u),g=r?i||(o?e:d||n)?[]:s:v
if(r&&r(v,g,a,u),n)for(l=_e(g,f),n(l,[],a,u),c=l.length;c--;)(p=l[c])&&(g[f[c]]=!(v[f[c]]=p))
if(o){if(i||e){if(i){for(l=[],c=g.length;c--;)(p=g[c])&&l.push(v[c]=p)
i(null,g=[],l,u)}for(c=g.length;c--;)(p=g[c])&&(l=i?j(o,p):h[c])>-1&&(o[l]=!(s[l]=p))}}else g=_e(g===s?g.splice(d,g.length):g),i?i(null,s,g,u):N.apply(s,g)})}function Ee(e){for(var t,r,i,o=e.length,s=n.relative[e[0].type],a=s||n.relative[" "],u=s?1:0,c=ye(function(e){return e===t},a,!0),p=ye(function(e){return j(t,e)>-1},a,!0),h=[function(e,r,n){var i=!s&&(n||r!==l)||((t=r).nodeType?c(e,r,n):p(e,r,n))
return t=null,i}];u<o;u++)if(r=n.relative[e[u].type])h=[ye(be(h),r)]
else{if((r=n.filter[e[u].type].apply(null,e[u].matches))[_]){for(i=++u;i<o&&!n.relative[e[i].type];i++);return we(u>1&&be(h),u>1&&ge(e.slice(0,u-1).concat({value:" "===e[u-2].type?"*":""})).replace(U,"$1"),r,u<i&&Ee(e.slice(u,i)),i<o&&Ee(e=e.slice(i)),i<o&&ge(e))}h.push(r)}return be(h)}return ve.prototype=n.filters=n.pseudos,n.setFilters=new ve,s=oe.tokenize=function(e,t){var r,i,o,s,a,u,l,c=T[e+" "]
...
if(!a){for(t||(t=s(e)),r=t.length;r--;)(a=Ee(t[r]))[_]?i.push(a):o.push(a);(a=A(e,function(e,t){var r=t.length>0,i=e.length>0,o=function(o,s,a,u,c){var p,d,v,g=0,y="0",b=o&&[],_=[],w=l,x=o||i&&n.find.TAG("*",c),C=E+=null==w?1:Math.random()||.1,T=x.length
for(c&&(l=s===f||s||c);y!==T&&null!=(p=x[y]);y++){if(i&&p){for(d=0,s||p.ownerDocument===f||(h(p),a=!m);v=e[d++];)if(v(p,s||f,a)){u.push(p)
break}c&&(E=C)}r&&((p=!v&&p)&&g--,o&&b.push(p))}if(g+=y,r&&y!==g){for(d=0;v=t[d++];)v(b,_,s,a)
...
h&&(t=t.parentNode),e=e.slice(u.shift().value.length)}for(o=G.needsContext.test(e)?0:u.length;o--&&(l=u[o],!n.relative[c=l.type]);)if((p=n.find[c])&&(i=p(l.matches[0].replace(Z,ee),X.test(u[0].type)&&me(t.parentNode)||t))){if(u.splice(o,1),!(e=i.length&&ge(u)))return N.apply(r,i),r
...
return t&&11!==t.nodeType?t:null},parents:function(e){return C(e,"parentNode")},parentsUntil:function(e,t,r){return C(e,"parentNode",r)},next:function(e){return j(e,"nextSibling")},prev:function(e){return j(e,"previousSibling")},nextAll:function(e){return C(e,"nextSibling")},prevAll:function(e){return C(e,"previousSibling")},nextUntil:function(e,t,r){return C(e,"nextSibling",r)},prevUntil:function(e,t,r){return C(e,"previousSibling",r)},siblings:function(e){return T((e.parentNode||{}).firstChild,e)},children:function(e){return T(e.firstChild)},contents:function(e){return R(e,"iframe")?e.contentDocument:(R(e,"template")&&(e=e.content||e),_.merge([],e.childNodes))}},function(e,t){_.fn[e]=function(r,n){var i=_.map(this,t,r)
...
var Re=/<(?!area|br|col|embed|hr|img|input|link|meta|param)(([a-z][^\/\0>\x20\t\r\n\f]*)[^>]*)\/>/gi,ke=/<script|<style|<link/i,Oe=/checked\s*(?:[^=]|=\s*.checked.)/i,Se=/^\s*<!(?:\[CDATA\[|--)|(?:\]\]|--)>\s*$/g
function Pe(e,t){return R(e,"table")&&R(11!==t.nodeType?t:t.firstChild,"tr")&&_(e).children("tbody")[0]||e}function Ne(e){return e.type=(null!==e.getAttribute("type"))+"/"+e.type,e}function Me(e){return"true/"===(e.type||"").slice(0,5)?e.type=e.type.slice(5):e.removeAttribute("type"),e}function je(e,t){var r,n,i,o,s,a,u,l
...
if(h&&(o=(i=ye(t,e[0].ownerDocument,!1,e,n)).firstChild,1===i.childNodes.length&&(i=o),o||n)){for(u=(a=_.map(fe(i,"script"),Ne)).length;p<h;p++)l=i,p!==f&&(l=_.clone(l,!0,!0),u&&_.merge(a,fe(l,"script"))),r.call(e[p],l,p)
if(u)for(c=a[a.length-1].ownerDocument,_.map(a,Me),p=0;p<u;p++)l=a[p],pe.test(l.type||"")&&!Q.access(l,"globalEval")&&_.contains(c,l)&&(l.src&&"module"!==(l.type||"").toLowerCase()?_._evalUrl&&_._evalUrl(l.src):y(l.textContent.replace(Se,""),c,l))}return e}function Le(e,t,r){for(var n,i=t?_.filter(t,e):e,o=0;null!=(n=i[o]);o++)r||1!==n.nodeType||_.cleanData(fe(n)),n.parentNode&&(r&&_.contains(n.ownerDocument,n)&&de(fe(n,"script")),n.parentNode.removeChild(n))
...
return r&&r.opener||(r=e),r.getComputedStyle(t)},Fe=new RegExp(re.join("|"),"i")
function Be(e,t,r){var n,i,o,s,a=e.style
return(r=r||ze(e))&&(""!==(s=r.getPropertyValue(t)||r[t])||_.contains(e.ownerDocument,e)||(s=_.style(e,t)),!d.pixelBoxStyles()&&De.test(s)&&Fe.test(t)&&(n=a.width,i=a.minWidth,o=a.maxWidth,a.minWidth=a.maxWidth=a.width=s,s=r.width,a.width=n,a.minWidth=i,a.maxWidth=o)),void 0!==s?s+"":s}function Ue(e,t){return{get:function(){if(!e())return(this.get=t).apply(this,arguments)
...
return!n&&o>=0&&(u+=Math.max(0,Math.ceil(e["offset"+t[0].toUpperCase()+t.slice(1)]-o-u-a-.5))),u}function Je(e,t,r){var n=ze(e),i=Be(e,t,n),o="border-box"===_.css(e,"boxSizing",!1,n),s=o
if(De.test(i)){if(!r)return i
i="auto"}return s=s&&(d.boxSizingReliable()||i===e.style[t]),("auto"===i||!parseFloat(i)&&"inline"===_.css(e,"display",!1,n))&&(i=e["offset"+t[0].toUpperCase()+t.slice(1)],s=!0),(i=parseFloat(i)||0)+$e(e,t,r||(o?"border":"content"),s,n,i)+"px"}function Xe(e,t,r,n,i){return new Xe.prototype.init(e,t,r,n,i)}_.extend({cssHooks:{opacity:{get:function(e,t){if(t){var r=Be(e,"opacity")
...
_.extend(_.event,{trigger:function(t,r,i,o){var s,a,u,l,c,h,f,d,g=[i||n],y=p.call(t,"type")?t.type:t,b=p.call(t,"namespace")?t.namespace.split("."):[]
if(a=d=u=i=i||n,3!==i.nodeType&&8!==i.nodeType&&!vt.test(y+_.event.triggered)&&(y.indexOf(".")>-1&&(b=y.split("."),y=b.shift(),b.sort()),c=y.indexOf(":")<0&&"on"+y,(t=t[_.expando]?t:new _.Event(y,"object"==typeof t&&t)).isTrigger=o?2:3,t.namespace=b.join("."),t.rnamespace=t.namespace?new RegExp("(^|\\.)"+b.join("\\.(?:.*\\.|)")+"(\\.|$)"):null,t.result=void 0,t.target||(t.target=i),r=null==r?[t]:_.makeArray(r,[t]),f=_.event.special[y]||{},o||!f.trigger||!1!==f.trigger.apply(i,r))){if(!o&&!f.noBubble&&!v(i)){for(l=f.delegateType||y,vt.test(l+y)||(a=a.parentNode);a;a=a.parentNode)g.push(a),u=a
u===(i.ownerDocument||n)&&g.push(u.defaultView||u.parentWindow||e)}for(s=0;(a=g[s++])&&!t.isPropagationStopped();)d=a,t.type=s>1?l:f.bindType||y,(h=(Q.get(a,"events")||{})[t.type]&&Q.get(a,"handle"))&&h.apply(a,r),(h=c&&a[c])&&h.apply&&G(a)&&(t.result=h.apply(a,r),!1===t.result&&t.preventDefault())
return t.type=y,o||t.isDefaultPrevented()||f._default&&!1!==f._default.apply(g.pop(),r)||!G(i)||c&&m(i[y])&&!v(i)&&((u=i[c])&&(i[c]=null),_.event.triggered=y,t.isPropagationStopped()&&d.addEventListener(y,gt),i[y](),t.isPropagationStopped()&&d.removeEventListener(y,gt),_.event.triggered=void 0,u&&(i[c]=u)),t.result}},simulate:function(e,t,r){var n=_.extend(new _.Event,r,{type:e,isSimulated:!0})
...
var At=/%20/g,Rt=/#.*$/,kt=/([?&])_=[^&]*/,Ot=/^(.*?):[ \t]*([^\r\n]*)$/gm,St=/^(?:GET|HEAD)$/,Pt=/^\/\//,Nt={},Mt={},jt="*/".concat("*"),It=n.createElement("a")
...
var i,o,s,a,u,l,c,p,h,f,d=_.ajaxSetup({},r),m=d.context||d,v=d.context&&(m.nodeType||m.jquery)?_(m):_.event,g=_.Deferred(),y=_.Callbacks("once memory"),b=d.statusCode||{},w={},E={},x="canceled",C={readyState:0,getResponseHeader:function(e){var t
...
if(g.promise(C),d.url=((t||d.url||yt.href)+"").replace(Pt,yt.protocol+"//"),d.type=r.method||r.type||d.method||d.type,d.dataTypes=(d.dataType||"*").toLowerCase().match(I)||[""],null==d.crossDomain){l=n.createElement("a")
...
for(h in(p=_.event&&d.global)&&0==_.active++&&_.event.trigger("ajaxStart"),d.type=d.type.toUpperCase(),d.hasContent=!St.test(d.type),o=d.url.replace(Rt,""),d.hasContent?d.data&&d.processData&&0===(d.contentType||"").indexOf("application/x-www-form-urlencoded")&&(d.data=d.data.replace(At,"+")):(f=d.url.slice(o.length),d.data&&(d.processData||"string"==typeof d.data)&&(o+=(_t.test(o)?"&":"?")+d.data,delete d.data),!1===d.cache&&(o=o.replace(kt,"$1"),f=(_t.test(o)?"&":"?")+"_="+bt+++f),d.url=o+f),d.ifModified&&(_.lastModified[o]&&C.setRequestHeader("If-Modified-Since",_.lastModified[o]),_.etag[o]&&C.setRequestHeader("If-None-Match",_.etag[o])),(d.data&&d.hasContent&&!1!==d.contentType||r.contentType)&&C.setRequestHeader("Content-Type",d.contentType),C.setRequestHeader("Accept",d.dataTypes[0]&&d.accepts[d.dataTypes[0]]?d.accepts[d.dataTypes[0]]+("*"!==d.dataTypes[0]?", "+jt+"; q=0.01":""):d.accepts["*"]),d.headers)C.setRequestHeader(h,d.headers[h])
if(d.beforeSend&&(!1===d.beforeSend.call(m,C,d)||c))return C.abort()
if(x="abort",y.add(d.complete),C.done(d.success),C.fail(d.error),i=Dt(Mt,d,r,C)){if(C.readyState=1,p&&v.trigger("ajaxSend",[C,d]),c)return C
...
var R=(0,o.taggedTemplateLiteralLoose)(["template:components/-default"],["template:components/-default"]),k=(0,o.taggedTemplateLiteralLoose)(["component:-default"],["component:-default"]),O=(0,o.taggedTemplateLiteralLoose)(["template:-root"],["template:-root"]),S=(0,o.taggedTemplateLiteralLoose)(["template-compiler:main"],["template-compiler:main"])
...
return(0,p.get)(e,t)},t.prototype[F]=function(e){(0,p.set)(this._parentValue,this._propertyKey,e)},t}(W),G=function(e){function t(t,r){var n=(0,o.possibleConstructorReturn)(this,e.call(this)),i=t.tag,s=c.UpdatableTag.create(c.CONSTANT_TAG)
...
void 0!==r&&void 0!==r[F]&&r[F]((0,p.get)(this,e))}},A.getAttr=function(e){return this.get(e)},A.readDOMAttr=function(e){var r=(0,h.getViewElement)(this),n=r.namespaceURI===t.SVG_NAMESPACE,i=(0,t.normalizeProperty)(r,e),o=i.type,s=i.normalized
...
return 0===r?Se:new this(e,r,t)},t.fromForEachable=function(e,t){var r=[]
...
return i.array=t,i}return(0,o.inherits)(t,e),t.from=function(e,t){var r=e.length
return 0===r?Se:new this(e,r,t)},t.prototype.valueFor=function(e){return(0,p.objectAt)(this.array,e)},t}(xe),Ae=function(e){function t(t,r,n,i){var s=(0,o.possibleConstructorReturn)(this,e.call(this,n,i))
...
return 0===i?Se:new this(r,n,i,t)},t.fromForEachable=function(e,t){var r=arguments,n=[],i=[],o=0,s=!1
return e.forEach(function(e,t){(s=s||r.length>=2)&&n.push(t),i.push(e),o++}),0===o?Se:s?new this(n,i,o,t):new Ce(i,o,t)},t.prototype.valueFor=function(e){return this.values[e]},t.prototype.memoFor=function(e){return this.keys[e]},t}(xe),Re=function(){function e(e,t,r){this.iterable=e,this.result=t,this.keyFor=r,this.position=0}return e.from=function(e,t){var r=e[Symbol.iterator](),n=r.next(),i=n.value
return n.done?Se:Array.isArray(i)&&2===i.length?new this(r,n,t):new ke(r,n,t)},e.prototype.isEmpty=function(){return!1},e.prototype.next=function(){var e=this.iterable,t=this.result,r=this.position,n=this.keyFor
if(t.done)return null
var i=this.valueFor(t,r),o=this.memoFor(t,r),s=n(i,o,r)
return this.position++,this.result=e.next(),{key:s,value:i,memo:o}},e}(),ke=function(e){function t(){return(0,o.possibleConstructorReturn)(this,e.apply(this,arguments))}return(0,o.inherits)(t,e),t.prototype.valueFor=function(e){return e.value},t.prototype.memoFor=function(e,t){return t},t}(Re),Oe=function(e){function t(){return(0,o.possibleConstructorReturn)(this,e.apply(this,arguments))}return(0,o.inherits)(t,e),t.prototype.valueFor=function(e){return e.value[1]},t.prototype.memoFor=function(e){return e.value[0]},t}(Re),Se={isEmpty:function(){return!0},next:function(){return null}},Pe=function(){function e(e,t){this.ref=e,this.keyPath=t,this.valueTag=c.UpdatableTag.create(c.CONSTANT_TAG),this.tag=(0,c.combine)([e.tag,this.valueTag])}return e.prototype.iterate=function(){var e,t=this.ref,r=this.valueTag,n=t.value(),i=(0,p.tagFor)(n)
return(0,l.isProxy)(n)&&(n=(0,u._contentFor)(n)),r.inner.update(i),null===(e=n)||"object"!=typeof e&&"function"!=typeof e?Se:Array.isArray(n)||(0,u.isEmberArray)(n)?Ae.fromIndexable(n,this.keyFor(!0)):l.HAS_NATIVE_SYMBOL&&je(n)?Oe.from(n,this.keyFor()):Me(n)?Ae.fromForEachable(n,this.keyFor()):Ae.fromIndexable(n,this.keyFor(!0))},e.prototype.valueReferenceFor=function(e){return new K(e.value)},e.prototype.updateValueReference=function(e,t){e.update(t.value)},e.prototype.memoReferenceFor=function(e){return new K(e.memo)},e.prototype.updateMemoReference=function(e,t){e.update(t.memo)},e.prototype.keyFor=function(){var e=arguments.length>0&&void 0!==arguments[0]&&arguments[0],t=this.keyPath
switch(t){case"@key":return e?Le:Be(De)
case"@index":return Ie
case"@identity":return Be(ze)
default:return Be(Fe(t))}},e}(),Ne=function(){function e(e,t){this.ref=e,this.keyPath=t,this.valueTag=c.UpdatableTag.create(c.CONSTANT_TAG),this.tag=(0,c.combine)([e.tag,this.valueTag])}return e.prototype.iterate=function(){var e=this.ref,t=this.valueTag,r=e.value()
if(t.inner.update((0,p.tagForProperty)(r,"[]")),null===r||"object"!=typeof r)return Se
var n=this.keyFor()
return Array.isArray(r)?Ce.from(r,n):(0,u.isEmberArray)(r)?Te.from(r,n):l.HAS_NATIVE_SYMBOL&&je(r)?ke.from(r,n):Me(r)?Ce.fromForEachable(r,n):Se},e.prototype.valueReferenceFor=function(e){return new K(e.value)},e.prototype.updateValueReference=function(e,t){e.update(t.value)},e.prototype.memoReferenceFor=function(e){return new K(e.memo)},e.prototype.updateMemoReference=function(e,t){e.update(t.memo)},e.prototype.keyFor=function(){var e=this.keyPath
...
"function"==typeof u&&u[U]?r[s]=u:a[F]&&(r[s]=new bt(a,u)),i[s]=a,n[s]=u}return n.attrs=r,n}var yt=(0,l.symbol)("REF"),bt=function(){function e(e,t){this[h.MUTABLE_CELL]=!0,this[yt]=e,this.value=t}return e.prototype.update=function(e){this[yt][F](e)},e}()
var _t=(0,w.privatize)(R),wt=function(e){function n(){return(0,o.possibleConstructorReturn)(this,e.apply(this,arguments))}return(0,o.inherits)(n,e),n.prototype.getLayout=function(e,t){return{handle:e.handle,symbolTable:e.symbolTable}},n.prototype.templateFor=function(e,t){var r=(0,p.get)(e,"layout")
...
i[u]=t.positional.at(a)}}return{positional:r.EMPTY_ARRAY,named:i}},n.prototype.create=function(e,t,r,n,i,o){var s=n.view,a=t.ComponentClass,u=r.named.capture(),l=gt(u);(function(e,t){e.named.has("id")&&(t.elementId=t.id)})(r,l),l.parentView=s,l[ae]=o,l._targetObject=i.value(),t.template&&(l.layout=t.template)
...
if(e.finalizer=(0,m._instrumentStart)("render.component",xt,t),r&&!r.tag.validate(n)){var o=gt(r)
...
this.symbolTable=s,this.template=n,this.args=i,this.state={name:e,ComponentClass:t,handle:r,template:n,capabilities:Ct,symbolTable:s}},Rt=function(e){function t(t){var r=(0,o.possibleConstructorReturn)(this,e.call(this))
...
this.state={name:r.fullName.slice(10),capabilities:kt,ComponentClass:r,handle:null}}return e.prototype.getTag=function(e){return e.component[ne]},e}(),St=function(){function e(e,t){this.view=e,this.outletState=t}return e.prototype.child=function(){return new e(this.view,this.outletState)},e.prototype.get=function(e){return this.outletState},e.prototype.set=function(e,t){return this.outletState=t,t},e}(),Pt=function(){function e(e,r,n,i,o,s,a){var u=this
...
this._appendDefinition(e,(0,t.curry)(n),r)},e.prototype._appendDefinition=function(e,r,n){var i=new Z(r),o=new St(null,t.UNDEFINED_REFERENCE),s=new Pt(e,this._env,this._rootTemplate,i,n,o,this._builder)
...
return n!==e&&(t=pr(this.sourceReference,n),r.inner.update(t.tag),this.innerReference=t,this.lastPath=n),t.value()},r.prototype[F]=function(e){(0,p.set)(this.sourceReference.value(),this.pathReference.value(),e)},r}(H)
...
var t=e.named
return new T.QueryParams((0,y.assign)({},t.value()))}var yr=["alt","shift","meta","ctrl"],br=/^click|mouse|touch/
...
"function"!=typeof r[B]?"function"!=typeof r?(n.name=r,a.send?(0,m.flaggedInstrument)("interaction.ember-action",n,function(){a.send.apply(a,[r].concat(e))}):(0,m.flaggedInstrument)("interaction.ember-action",n,function(){a[r].apply(a,e)})):(0,m.flaggedInstrument)("interaction.ember-action",n,function(){r.apply(a,e)}):(0,m.flaggedInstrument)("interaction.ember-action",n,function(){r[B].apply(r,e)})}),u)},e.prototype.destroy=function(){wr(this)},e}(),xr=function(){function e(){}return e.prototype.create=function(e,t,r,n,i){var o=r.capture(),s=o.named,a=o.positional,u=o.tag,c=void 0,p=void 0,h=void 0
...
return lt(r),n.component.static(i,[t||[],Tr(r),null,null]),!0}function Rr(e,t,r,n){var i=n.compiler.resolver.lookupComponentDefinition(e,n.referrer)
return n.component.static(i,[t,Tr(r),null,null]),!0}function kr(e,t,r,n){if(null===t&&(t=[]),null!==r){var i=r[0],o=r[1],s=i.indexOf("type")
if(s>-1){var a=o[s]
if(Array.isArray(a)){var u=t[0]
return n.dynamicComponent(u,null,t.slice(1),r,!0,null,null),!0}if("checkbox"===a)return lt(r),Rr("-checkbox",t,r,n)}}return Rr("-text-field",t,r,n)}function Or(e,t,r,n,i){return null!==r&&(null!==e?(i.compileParams(e),i.invokeStaticBlock(r,e.length)):i.invokeStatic(r)),!0}var Sr={dynamicLayout:!0,dynamicTag:!1,prepareArgs:!1,createArgs:!1,attributeHook:!1,elementHook:!1,createCaller:!0,dynamicScope:!0,updateHook:!0,createInstance:!0},Pr=new(function(e){function t(){return(0,o.possibleConstructorReturn)(this,e.apply(this,arguments))}return(0,o.inherits)(t,e),t.prototype.getDynamicLayout=function(e,t){var r=e.engine.lookup("template:application").asLayout()
...
return(l="function"==typeof o[B]?ur(o,o,o[B],u):(0,c.isConst)(a)&&(0,c.isConst)(o)?ur(i.value(),a.value(),o.value(),u):function(e,t,r,n,i){return function(){return ur(e,t.value(),r.value(),n).apply(void 0,arguments)}}(i.value(),a,o,u))[U]=!0,new Z(l)},concat:function(e,t){return new X(cr,t.capture())},get:function(e,t){return hr.create(t.positional.at(0),t.positional.at(1))},hash:function(e,t){return t.named.capture()},array:function(e,t){return t.positional.capture()},log:function(e,t){return new X(dr,t.capture())},mut:function(e,t){var r,n=t.positional.at(0)
if((r=n)&&r[mr])return n
var i=Object.create(n)
return i[vr]=n,i[B]=n[F],i[mr]=!0,i},"query-params":function(e,t){return new X(gr,t.capture())},readonly:function(e,t){var r=function(e){return e[vr]||e}(t.positional.at(0))
...
t.add("outlet",zr),t.add("mount",Mr),t.add("input",kr),t.add("textarea",Ar),t.addMissing(Br),r.add("let",Or),r.addMissing(Ur)
...
if(o&&!s&&g.ENV._TEMPLATE_ONLY_GLIMMER_COMPONENTS){var c=new rr(o)
return l(),this.componentDefinitionCache.set(a,c),c}if(s&&s.class){var p=Hr(s.class)
if(p){var f=p(t.owner),d=new Zt(r,s,f,o||t.owner.lookup((0,w.privatize)(R)))
return l(),this.componentDefinitionCache.set(a,d),d}}var v=o||s?new At(r,s||t.owner.factoryFor((0,w.privatize)(k)),null,o):null
...
if(null==e)return""
if(!e)return e+""
e=""+e}return He.test(e)?e.replace(Ve,We):e},e.htmlSafe=Ye,e.isHTMLSafe=Ge,e.Renderer=Dt,e.InertRenderer=zt,e.InteractiveRenderer=Ft,e._resetRenderers=function(){Nt.length=0},e.renderSettled=function(){return null===It&&(It=C.default.defer(),(0,x.getCurrentRunLoop)()||x.backburner.schedule("actions",null,jt)),It.promise},e.getTemplate=function(e){if(Bt.hasOwnProperty(e))return Bt[e]},e.setTemplate=function(e,t){return Bt[e]=t},e.hasTemplate=function(e){return Bt.hasOwnProperty(e)},e.getTemplates=function(){return Bt},e.setTemplates=function(e){Bt=e},e.setupEngineRegistry=function(e){e.register("view:-outlet",tn),e.register("template:-outlet",Xr),e.injection("view:-outlet","template","template:-outlet"),e.injection("service:-dom-changes","document","service:-document"),e.injection("service:-dom-tree-construction","document","service:-document"),e.register((0,w.privatize)(R),Jr),e.register("service:-glimmer-environment",Xe),e.register((0,w.privatize)(S),$r),e.injection("template","compiler",(0,w.privatize)(S)),e.optionsForType("helper",{instantiate:!1}),e.register("helper:loc",Ut),e.register("component:-text-field",fe),e.register("component:-text-area",de),e.register("component:-checkbox",pe),e.register("component:link-to",ve),g.ENV._TEMPLATE_ONLY_GLIMMER_COMPONENTS||e.register((0,w.privatize)(k),le)},e.setupApplicationRegistry=function(e){e.injection("service:-glimmer-environment","appendOperations","service:-dom-tree-construction"),e.injection("renderer","env","service:-glimmer-environment"),e.register("service:-dom-builder",{create:function(e){switch(e.bootOptions._renderMode){case"serialize":return n.serializeBuilder.bind(null)
case"rehydrate":return t.rehydrationBuilder.bind(null)
default:return t.clientBuilder.bind(null)}}}),e.injection("service:-dom-builder","bootOptions","-environment:main"),e.injection("renderer","builder","service:-dom-builder"),e.register((0,w.privatize)(O),M),e.injection("renderer","rootTemplate",(0,w.privatize)(O)),e.register("renderer:-dom",Ft),e.register("renderer:-inert",zt),d.hasDOM&&e.injection("service:-glimmer-environment","updateOperations","service:-dom-changes"),e.register("service:-dom-changes",{create:function(e){var r=e.document
...
e.UpdatableReference=K,e.INVOKE=B,e.iterableFor=Ee,e.DebugStack=ye,e.OutletView=tn,e.capabilities=function(e){var t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{}
...
if((0,n.isProxy)(e))return R(e,o)
var s=o.writableTags(),u=s[t]
return u||(s[t]=T())}function R(e,t){return"object"==typeof e&&null!==e?(void 0===t?(0,i.meta)(e):t).writableTag(T):a.CONSTANT_TAG}var k=void 0,O=void 0
function S(e,t,r){var i=r.readableTag()
void 0!==i&&((0,n.isProxy)(e)?i.inner.first.inner.dirty():i.inner.dirty())
var o=r.readableTags(),a=void 0!==o?o[t]:void 0
void 0!==a&&k(a),void 0===i&&void 0===a||C()&&s.backburner.ensureInstance()}k=function(e){e.inner.dirty()}
...
var n=F
n&&(F=!1);(function(e,t,r,n,o){var s=n.get(t)
if(void 0===s&&(s=new Set,n.set(t,s)),!s.has(r)){var a=void 0
o.forEachInDeps(r,function(r){void 0!==(a=(0,i.descriptorFor)(t,r,o))&&a._suspended===t||e(t,r,o)})}})(D,e,t,z,r),n&&(z.clear(),F=!0)}(e,t,n),function(e,t,r){var n=r.readableChainWatchers()
...
return n(e,"@array:before",t,o),n(e,"@array:change",t,s),a===i&&D(e,"hasArrayObservers"),e}function ce(e,t,r,n){_(e,b(t),r,n),ke(e,t)}function pe(e,t,r,n){Se(e,t),w(e,b(t),r,n)}function he(e){var t=K.get(e)
...
function ye(){return new ge}function be(e){return new Te(null,null,e)}function _e(e,t,r){var n=(0,i.meta)(e)
n.writableChainWatchers(ye).add(t,r),Y(e,t,n)}function we(e,t,r,n){if(ve(e)){var o=void 0===n?(0,i.peekMeta)(e):n
...
n.writeWatching(t,o+1),0===o&&n.writableChains(be).add(t)}function Re(e,t,r){var n=void 0===r?(0,i.peekMeta)(e):r
if(void 0!==n){var o=n.peekWatching(t)
o>0&&(n.writeWatching(t,o-1),1===o&&n.writableChains(be).remove(t))}}function ke(e,t,r){g(t)?Ae(e,t,r):Y(e,t,r)}function Oe(e,t){var r=(0,i.peekMeta)(e)
return void 0!==r&&r.peekWatching(t)||0}function Se(e,t,r){g(t)?Re(e,t,r):G(e,t,r)}function Pe(e,t,r,n){var i=e._dependentKeys
if(null!=i)for(var o=0;o<i.length;o++){var s=i[o]
n.writeDeps(s,r,n.peekDeps(s,r)+1),ke(t,s,n)}}function Ne(e,t,r,n){var i=e._dependentKeys
if(null!=i)for(var o=0;o<i.length;o++){var s=i[o]
n.writeDeps(s,r,n.peekDeps(s,r)-1),Se(t,s,n)}}var Me=/\.@each$/
...
t+=r.substring(0,n)
u=l.length
for(;s<u;)(a=c.indexOf("{"))<0?i((t+l[s++]+c).replace(Me,".[]")):e(t+l[s++],c,a,i)}("",e,r,t)}function Ie(e,t,r,n){if(!e.isDestroyed){if(g(t))return function(e,t,r,n){var i=t.split("."),o=i.pop()
...
return this.consume(e,t,(0,i.meta)(e)),r},r.prototype.unconsume=function(e,t,r){var n=d(e,t)===Be;(n||r.peekWatching(t)>0)&&Ne(this,e,t,r),n&&f(e).delete(t)},r.prototype.consume=function(e,t,r){var n=f(e)
n.get(t)!==Be&&(n.set(t,Be),Pe(this,e,t,r))},r.prototype.set=function(e,t,r){return Ie(e,this.altKey,r)},r.prototype.readOnly=function(){return this.set=qe,this},r.prototype.oneWay=function(){return this.set=He,this},r}(V)
...
for(var p=0;p<a.length;p++)if("constructor"!==(u=a[p])&&o.hasOwnProperty(u)){for(c=r[u],l=o[u];c&&c instanceof gt;){var h=pt(e,c,r,o)
...
void 0!==t&&t.revalidateAll(),void 0!==e.readableChains()&&e.writableChains(be)},e.removeChainWatcher=we,e.watchPath=Ae,e.unwatchPath=Re,e.isWatching=function(e,t){return Oe(e,t)>0},e.unwatch=Se,e.watch=ke,e.watcherCount=Oe,e.libraries=Ge,e.Libraries=Ye,e.getProperties=function(e,t){var r={},n=arguments,i=1
...
return(0,n.setObservers)(i,s),i},e.applyMixin=dt,e.InjectedProperty=yt,e.setHasViews=function(e){C=e},e.tagForProperty=A,e.tagFor=R,e.markObjectAsDirty=S,e.runInTransaction=P,e.didRender=N,e.assertNotRendered=M,e.descriptor=function(e){return new _t(e)},e.tracked=function(){for(var e=arguments.length,t=Array(e),r=0;r<e;r++)t[r]=arguments[r]
var n=t[1],i=t[2]
return void 0===i||"initializer"in i?function(e,t){var r=Symbol(e)
return{enumerable:!0,configurable:!0,get:function(){return ee&&ee.add(A(this,e)),r in this||(this[r]=t.value),this[r]},set:function(t){R(this).inner.dirty(),k(A(this,e)),this[r]=t,te()}}}(n,i):function(e,t){var r=t.get,n=t.set
return{enumerable:!0,configurable:!1,get:r&&function(){var t=ee,n=ee=new Z,i=r.call(this)
ee=t
var o=n.combine()
return ee&&ee.add(o),O(A(this,e),o),i},set:n&&function(){k(A(this,e)),n.apply(this,arguments)}}}(n,i)},e.NAMESPACES=Xe,e.NAMESPACES_BY_ID=Ze,e.addNamespace=function(e){$e.unprocessedNamespaces=!0,Xe.push(e)},e.classToString=nt,e.findNamespace=function(e){return Qe||rt(),Ze[e]},e.findNamespaces=et,e.processNamespace=tt,e.processAllNamespaces=rt,e.removeNamespace=function(e){var t=(0,n.getName)(e)
...
s(v,"loading"),s(v,"error",{path:f}),a.class.call(v),h=v.generate(),d&&(this.options.engineInfo=m)}var g=(0,r.assign)({localFullName:"application"},c)
if(this.enableLoadingSubstates){var y=u+"_loading",b="application_loading",_=(0,r.assign)({localFullName:b},c)
s(this,y,{resetNamespace:i.resetNamespace}),this.options.addRouteForEngine(y,_),y=u+"_error",b="application_error",_=(0,r.assign)({localFullName:b},c),s(this,y,{resetNamespace:i.resetNamespace,path:f}),this.options.addRouteForEngine(y,_)}this.options.addRouteForEngine(l,g),this.push(p,l,h)},e}()
...
var x=y.type||(0,o.typeOf)(E),C=this.serializeQueryParam(E,w,x),T=s+":"+g,A={undecoratedDefaultValue:(0,n.get)(u,g),defaultValue:E,serializedDefaultValue:C,serializedValue:C,type:x,urlKey:w,prop:g,scopedPropertyName:T,controllerName:s,route:this,parts:_,values:null,scope:b}
m[g]=m[w]=m[T]=A,d.push(A),v.push(g)}return{qps:d,map:m,propertyNames:v,states:{inactive:function(t,r){var n=m[t]
...
if(a.has(h.urlKey)?(v=(0,n.get)(d,h.prop),y=f.serializeQueryParam(v,h.urlKey,h.type)):m?void 0!==(y=e[m])&&(v=f.deserializeQueryParam(y,h.urlKey,h.type)):(y=h.serializedDefaultValue,v=g(h.defaultValue)),d._qpDelegate=(0,n.get)(f,"_qp.states.inactive"),y!==h.serializedValue){if(r.queryParamsOnly&&!1!==u){var b=f._optionsForQueryParam(h),_=(0,n.get)(b,"replace")
_?u=!0:!1===_&&(u=!1)}(0,n.set)(d,h.prop,v)}h.serializedValue=y,h.serializedDefaultValue===y&&!r._keepDefaultQueryParamValues||t.push({value:y,visible:!0,key:m||h.urlKey})}u&&r.method("replace"),s.qps.forEach(function(e){var t=(0,n.get)(e.route,"_qp")
...
return this._doTransition(i,o,s)},o.prototype.intermediateTransitionTo=function(e){for(var t,r=arguments.length,n=Array(r>1?r-1:0),i=1;i<r;i++)n[i-1]=arguments[i];(t=this._routerMicrolib).intermediateTransitionTo.apply(t,[e].concat(n)),k(this)},o.prototype.replaceWith=function(){return this.transitionTo.apply(this,arguments).method("replace")},o.prototype.generate=function(e){for(var t,r=arguments.length,n=Array(r>1?r-1:0),i=1;i<r;i++)n[i-1]=arguments[i]
...
S(this,e,t,function(e,n,o){if(o)delete t[e],t[o.urlKey]=o.route.serializeQueryParam(n,o.urlKey,o.type)
else{if(void 0===n)return
t[e]=r._serializeQueryParam(n,(0,i.typeOf)(n))}})},o.prototype._serializeQueryParam=function(e,t){return null==e?e:"array"===t?JSON.stringify(e):""+e},o.prototype._deserializeQueryParams=function(e,t){S(this,e,t,function(e,r,n){n&&(delete t[e],t[n.prop]=n.route.deserializeQueryParam(r,n.urlKey,n.type))})},o.prototype._deserializeQueryParam=function(e,t){return null==e?e:"boolean"===t?"true"===e:"number"===t?Number(e).valueOf():"array"===t?(0,i.A)(JSON.parse(e)):e},o.prototype._pruneDefaultQueryParamValues=function(e,t){var r=this._queryParamsFor(e)
...
this._fullyScopeQueryParams(e,t,n),this._fullyScopeQueryParams(e,t,i),(0,u.assign)(r,i)}},o.prototype._prepareQueryParams=function(e,t,r,n){var i=R(this,e,t)
...
var h={qps:s,map:o}
return i&&(this._qpCache[r]=h),h},o.prototype._fullyScopeQueryParams=function(e,t,r){for(var n=R(this,e,t).routeInfos,i=void 0,o=0,s=n.length;o<s;++o)if(i=this._getQPMeta(n[o]))for(var a=void 0,u=void 0,l=0,c=i.qps.length;l<c;++l)(u=(a=i.qps[l]).prop in r&&a.prop||a.scopedPropertyName in r&&a.scopedPropertyName||a.urlKey in r&&a.urlKey)&&u!==a.scopedPropertyName&&(r[a.scopedPropertyName]=r[u],delete r[u])},o.prototype._hydrateUnsuppliedQueryParams=function(e,t,r){for(var n=e.routeInfos,i=this._bucketCache,o=void 0,s=void 0,a=void 0,u=0;u<n.length;++u)if(o=this._getQPMeta(n[u]))for(var l=0,c=o.qps.length;l<c;++l)if(s=o.qps[l],a=s.prop in t&&s.prop||s.scopedPropertyName in t&&s.scopedPropertyName||s.urlKey in t&&s.urlKey)a!==s.scopedPropertyName&&(t[s.scopedPropertyName]=t[a],delete t[a])
...
else if(!i&&!t)throw new a.default("Nothing handled the action '"+r+"'. If you did handle the action, this error can be caused by returning true from an action handler in a controller, causing the action to bubble.")}function R(e,t,r){for(var n=e._routerMicrolib.applyIntent(t,r),i=n.routeInfos,o=n.params,s=0;s<i.length;++s){var a=i[s]
...
function g(e){var t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:v,n=N(),i=new Set,o="function"==typeof t?t:function(e){return(0,r.get)(e,t)}
...
if("array"===r)return!0
var n=t.length
return"number"==typeof n&&n==n&&"object"===r}function R(){var e=r.computed.apply(void 0,arguments)
return e.enumerable=!1,e}var k=r.Mixin.create(o.default,((h={})[m]=!0,h.objectsAt=function(e){var t=this
return e.map(function(e){return(0,r.objectAt)(t,e)})},h["[]"]=R({get:function(){return this},set:function(e,t){return this.replace(0,this.length,t),this}}),h.firstObject=R(function(){return(0,r.objectAt)(this,0)}).readOnly(),h.lastObject=R(function(){return(0,r.objectAt)(this,this.length-1)}).readOnly(),h.slice=function(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:0,t=arguments[1],n=N(),i=this.length
...
return this.filter(t)},h["@each"]=t.ARRAY_AT_EACH?R(function(){return(0,r.eachProxyFor)(this)}).readOnly():void 0,h)),O=r.Mixin.create(k,c.default,{clear:function(){var e=this.length
...
return(0,r.beginPropertyChanges)(),e.forEach(function(e){return t.addObject(e)}),(0,r.endPropertyChanges)(),this}}),S=r.Mixin.create(O,u.default,{objectAt:function(e){return this[e]},replace:function(e,t){var n=arguments.length>2&&void 0!==arguments[2]?arguments[2]:d
...
var N=void 0
a.ENV.EXTEND_PROTOTYPES.Array?(S.apply(Array.prototype),e.A=N=function(e){return e||[]}):e.A=N=function(e){return e||(e=[]),k.detect(e)?e:S.apply(e)},e.A=N,e.NativeArray=S,e.MutableArray=O,e.default=k}),e("@ember/-internals/runtime/lib/mixins/comparable",["exports","@ember/-internals/metal"],function(e,t){"use strict"
...
if(!v){var g=e[f]
l&&o.indexOf(f)>-1&&(d=g?(0,i.makeArray)(g).concat(d):(0,i.makeArray)(d)),c&&u.indexOf(f)>-1&&(d=(0,n.assign)({},g,d))}v?m.set(e,f,d):"function"!=typeof e.setUnknownProperty||f in e?e[f]=d:e.setUnknownProperty(f,d)}e.init(t),r.unsetInitializing(),(0,a.finishChains)(r),(0,a.sendEvent)(e,"init",void 0,void 0,void 0,r)}var v=function(){function e(e){var t=h.get(this.constructor)
...
if(r&&e.indexOf(m)>-1){var g=s[m]
v=g?(0,i.makeArray)(g).concat(v):(0,i.makeArray)(v)}if(o&&t.indexOf(m)>-1){var y=s[m]
v=(0,n.assign)({},y,v)}s[m]=v}return s}.apply(this,arguments)),r},e.reopen=function(){return this.willReopen(),c.apply(this.PrototypeMixin,arguments),this},e.willReopen=function(){var e=this.prototype
...
return this._super=r,n}return C.add(r),b(r,_(e)),E(r,x(e)),r}var A=Object.prototype.toString,R=Function.prototype.toString,k=Array.isArray,O=Object.keys,S=JSON.stringify,P=100,N=4,M=/^[\w$]+$/
...
break}var s=i[o]
n+=I(s)+": "+j(e[s],t,r)}return n+=" }"}(e,r+1,n)}function I(e){return M.test(e)?e:S(e)}function L(e,t){return null!=e&&"function"==typeof e[t]}var D=Array.isArray
var z=new WeakMap
...
t="string"===r?"st"+o():"number"===r?"nu"+o():"symbol"===r?"sy"+o():"("+e+")",u.set(e,t)}return t},e.intern=r,e.checkHasSuper=d,e.ROOT=v,e.wrap=function(e,t){return g(e)?!C.has(t)&&g(t)?T(e,T(t,v)):T(e,t):e},e.getObservers=_,e.getListeners=x,e.setObservers=b,e.setListeners=E,e.inspect=function(e){return"number"==typeof e&&2===arguments.length?this:j(e,0)},e.lookupDescriptor=function(e,t){var r=e
...
e.assert=a,e.info=u,e.warn=l,e.debug=c,e.deprecate=p,e.debugSeal=h,e.debugFreeze=f,e.runInDebug=d,e.deprecateFunc=g,e.setDebugFunction=m,e.getDebugFunction=v,e._warnIfUsingStrippedFeatureFlags=void 0}),e("@ember/debug/lib/deprecate",["exports","@ember/-internals/environment","@ember/debug/index","@ember/debug/lib/handlers"],function(e,t,r,n){"use strict"
...
e._setStrings=e._getStrings=void 0,Object.defineProperty(e,"_getStrings",{enumerable:!0,get:function(){return t.getStrings}}),Object.defineProperty(e,"_setStrings",{enumerable:!0,get:function(){return t.setStrings}}),e.loc=_,e.w=w,e.decamelize=E,e.dasherize=x,e.camelize=C,e.classify=T,e.underscore=A,e.capitalize=R
...
return _(this,t)}},camelize:{configurable:!0,enumerable:!1,writeable:!0,value:function(){return C(this)}},decamelize:{configurable:!0,enumerable:!1,writeable:!0,value:function(){return E(this)}},dasherize:{configurable:!0,enumerable:!1,writeable:!0,value:function(){return x(this)}},underscore:{configurable:!0,enumerable:!1,writeable:!0,value:function(){return A(this)}},classify:{configurable:!0,enumerable:!1,writeable:!0,value:function(){return T(this)}},capitalize:{configurable:!0,enumerable:!1,writeable:!0,value:function(){return R(this)}}})}),e("@ember/string/lib/string_registry",["exports"],function(e){"use strict"
...
void 0===s?(0,this.missing)(e,t,r,n,i,o):(0,this.funcs[s])(t,r,n,i,o)},e}(),g=function(){function e(){this.names=(0,n.dict)(),this.funcs=[]}return e.prototype.add=function(e,t){this.funcs.push(t),this.names[e]=this.funcs.length-1},e.prototype.addMissing=function(e){this.missing=e},e.prototype.compile=function(e,t){var r=e[1]
...
this.fetch(i.Register.s0),this.dup(i.Register.sp,1),this.load(i.Register.s0),this.pushFrame(),this.pushEmptyArgs(),this.prepareArgs(i.Register.s0),this.invokePreparedComponent(!1,!1,!0,function(){e.getComponentLayout(i.Register.s0),e.populateLayout(i.Register.s0)}),this.load(i.Register.s0)},e.prototype.isComponent=function(){this.push(69)},e.prototype.contentType=function(){this.push(70)},e.prototype.pushBlockScope=function(){this.push(47)},(0,r.createClass)(e,[{key:"pos",get:function(){return this.encoder.typePos}},{key:"nextPos",get:function(){return this.encoder.size}},{key:"labels",get:function(){return this.labelsStack.current}}]),e}(),R=function(e){function t(t,n){var i=(0,r.possibleConstructorReturn)(this,e.call(this,t,n?n.block.symbols.length:0))
...
var g=s[0],y=s[1],b=m
a&&(b=m.slice(1))
var _=g.indexOf(b);-1!==_&&(this.expr(y[_]),f.push({symbol:d+1,isBlock:!1}))}}this.pushRootScope(h.length+1,!!(u||l||r))
...
var s=n.EMPTY_ARRAY
if(t){s=t[0]
for(var a=t[1],u=0;u<a.length;u++)this.expr(a[u])}this.pushArgs(s,o)},t.prototype.template=function(e){return e?this.inlineBlock(e):null},(0,r.createClass)(t,[{key:"referrer",get:function(){return this.containingLayout&&this.containingLayout.referrer}}]),t}(A),k=function(e){function t(){return(0,r.possibleConstructorReturn)(this,e.apply(this,arguments))}return(0,r.inherits)(t,e),t.prototype.pushBlock=function(e){e?this.pushOther(e):this.primitive(null)},t.prototype.resolveBlock=function(){this.push(46)},t.prototype.pushLayout=function(e){e?this.pushOther(e):this.primitive(null)},t.prototype.resolveLayout=function(){this.push(46)},t.prototype.invokeStatic=function(e){this.pushOther(e),this.push(46),this.pushMachine(49)},t.prototype.pushOther=function(e){this.push(12,this.other(e))},t.prototype.other=function(e){return this.constants.other(e)},t}(R),O=function(e){function t(){return(0,r.possibleConstructorReturn)(this,e.apply(this,arguments))}return(0,r.inherits)(t,e),t.prototype.pushBlock=function(e){var t=e?e.compile():null
this.primitive(t)},t.prototype.resolveBlock=function(){},t.prototype.pushLayout=function(e){e?this.primitive(e.compile()):this.primitive(null)},t.prototype.resolveLayout=function(){},t.prototype.invokeStatic=function(e){var t=e.compile();-1===t?this.pushMachine(50,function(){return e.compile()}):this.pushMachine(50,t)},t}(R),S=function(e){function t(t,n,i){var o=new a.LazyConstants(n),s=new a.Program(o)
return(0,r.possibleConstructorReturn)(this,e.call(this,i,s,t))}return(0,r.inherits)(t,e),t.prototype.builderFor=function(e){return new k(this,e)},t}(E),P=function(){function e(e,t){this.name=e,this.template=t}return e.prototype.getPartial=function(){var e=this.template.asPartial(),t=e.compile()
...
this.blocks=t,this.inlines=r},e.LazyCompiler=S,e.compile=_,e.AbstractCompiler=E,e.debugCompiler=void 0,e.CompilableBlock=b,e.CompilableProgram=y,e.LazyOpcodeBuilder=k,e.EagerOpcodeBuilder=O,e.OpcodeBuilder=R,e.StdOpcodeBuilder=A,e.PartialDefinition=P,e.templateFactory=function(e){var t=e.id,r=e.meta,i=e.block,o=void 0,s=t||"client-"+N++
...
return e.peek(),t},r.prototype.evaluate=function(e){var t=this.cache;(0,n.isModified)(t.revalidate())&&e.throw()},r}(a),S=function(e){function r(r,n){var i=(0,t.possibleConstructorReturn)(this,e.call(this))
...
t.push(R.create(r))}),s.add(70,function(e){var t=e.stack,r=t.peek()
t.push(new k(r))}),s.add(71,function(e,t){var r=t.op1,n=e.stack,o=n.pop(),s=n.pop(),a=e.constants.getSerializable(r),u=e.constants.resolver
...
o.setup(n,y,p,v,!0)}n.push(o)}else n.push(o)}),s.add(81,function(e,t){var r=t.op1,i=t.op2,o=e.fetchValue(i),s=o.definition,a=o.manager,u=o.capabilities=z(a.getCapabilities(s.state)),l=null
...
o.state=f
var d=a.getTag(f)
F(u,256)&&!(0,n.isConstTag)(d)&&e.updateWith(new H(d,f,a,l))}),s.add(82,function(e,t){var r=t.op1,n=e.fetchValue(r),i=n.manager,o=n.state,s=i.getDestructor(o)
...
function U(e,t){return!1===F(e,1)}function q(e,t,r,n,i){var o=r.table.symbols.indexOf(e),s=n.get(t);-1!==o&&i.scope().bindBlock(o+1,s),r.lookup&&(r.lookup[e]=s)}s.add(93,function(e,t){var r=t.op1,n=e.fetchValue(r),o=n.definition,s=n.state,a=o.manager,u=e.fetchValue(i.Register.t0)
...
b[E]=x}if(y)for(var C=0;C<m.length;C++){var T=C+1,A=y[m[C]]
...
de=ie(le,de)
var me=de=ne(le,de,oe),ve=ce.DOMTreeConstruction,ge=["javascript:","vbscript:"],ye=["A","BODY","LINK","IMG","IFRAME","BASE","FORM"],be=["EMBED"],_e=["href","src","background","action"],we=["src"]
function Ee(e,t){return-1!==e.indexOf(t)}function xe(e,t){return(null===e||Ee(ye,e))&&Ee(_e,t)}function Ce(e,t){return null!==e&&(Ee(be,e)&&Ee(we,t))}function Te(e,t){return xe(e,t)||Ce(e,t)}function Ae(e,t,r,n){var i=null
if(null==n)return n
if(x(n))return n.toHTML()
i=t?t.tagName.toUpperCase():null
var o=w(n)
if(xe(i,r)){var s=e.protocolForURL(o)
if(Ee(ge,s))return"unsafe:"+o}return Ce(i,r)?"unsafe:"+o:o}function Re(e,t){var r,n,i,o=void 0,s=void 0
if(t in e)s=t,o="prop"
else{var a=t.toLowerCase()
a in e?(o="prop",s=a):(o="attr",s=t)}return"prop"===o&&("style"===s.toLowerCase()||(r=e.tagName,n=s,(i=ke[r.toUpperCase()])&&i[n.toLowerCase()]))&&(o="attr"),{normalized:s,type:o}}var ke={INPUT:{form:!0,autocorrect:!0,list:!0},SELECT:{form:!0},OPTION:{form:!0},TEXTAREA:{form:!0},LABEL:{form:!0},FIELDSET:{form:!0},LEGEND:{form:!0},OBJECT:{form:!0},BUTTON:{form:!0}}
function Oe(e,t,r){var n=e.tagName,i={element:e,name:t,namespace:r}
if(e.namespaceURI===oe)return Se(n,t,i)
var o=Re(e,t),s=o.type,a=o.normalized
return"attr"===s?Se(n,a,i):function(e,t,r){if(Te(e,t))return new je(t,r)
...
return new Me(t,r)}(n,a,i)}function Se(e,t,r){return Te(e,t)?new Ie(r):new Ne(r)}var Pe=function(e){this.attribute=e},Ne=function(e){function r(){return(0,t.possibleConstructorReturn)(this,e.apply(this,arguments))}return(0,t.inherits)(r,e),r.prototype.set=function(e,t,r){var n=ze(t)
...
i.clear()
var l=Ye.resume(u.env,n,n.reset(u.env)),c=gt.resume(t,u,l),p=new r.LinkedList
...
return l.pc=l.heap.getaddr(a),l.updatingOpcodeStack.push(new r.LinkedList),l},e.empty=function(t,n,i,o){var s={get:function(){return p},set:function(){return p},child:function(){return s}},a=new e({program:t,env:n},Fe.root(p,0),s,i)
...
return t&&t[1]?Number(t[1]):null}function Ct(e){return 1===e.nodeType}function Tt(e){return 8===e.nodeType&&"%glmr%"===e.nodeValue}function At(e){return 8===e.nodeType&&"% %"===e.nodeValue}function Rt(e,t){for(var r=0;r<e.length;r++){var n=e[r]
if(n.name===t)return n}}e.renderMain=function(e,t,r,n,i,o){var s=gt.initial(e,t,r,n,i,o)
return new yt(s)},e.renderComponent=function(e,t,r,n,i){var o=arguments.length>5&&void 0!==arguments[5]?arguments[5]:{},s=gt.empty(e,t,r,n),a=s.constants.resolver,u=I(a,i,null),l=u.manager,c=u.state,p=void 0
...
return new bt(r,n)},e.LowLevelVM=gt,e.UpdatingVM=et,e.RenderResult=st,e.SimpleDynamicAttribute=Ne,e.DynamicAttribute=Pe,e.EMPTY_ARGS=vt,e.Scope=Fe,e.Environment=Ue,e.DefaultEnvironment=qe,e.DEFAULT_CAPABILITIES={dynamicLayout:!0,dynamicTag:!0,prepareArgs:!0,createArgs:!0,attributeHook:!1,elementHook:!1,dynamicScope:!0,createCaller:!1,updateHook:!0,createInstance:!0},e.MINIMAL_CAPABILITIES={dynamicLayout:!1,dynamicTag:!1,prepareArgs:!1,createArgs:!1,attributeHook:!1,elementHook:!1,dynamicScope:!1,createCaller:!1,updateHook:!1,createInstance:!1},e.CurriedComponentDefinition=_,e.isCurriedComponentDefinition=b,e.curry=function(e){var t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:null
return new _(e,t)},e.DOMChanges=me,e.SVG_NAMESPACE=oe,e.IDOMChanges=he,e.DOMTreeConstruction=ve,e.isWhitespace=function(e){return ue.test(e)},e.insertHTMLBefore=fe,e.normalizeProperty=Re
...
e=o[0],t=o[1],void 0===(n=o[2])?i=0:a(i=n.pop())||(r=!0===i,i=n.pop())}return[e,t,n,i=parseInt(i,10),r]}var _=0,w=0,E=0,x=0,C=0,T=0,A=0,R=0,k=0,O=0,S=0,P=0,N=0,M=0,j=0,I=0,L=0,D=0,z=0,F=0,B=0,U=function(){function e(e,t){var r=this
...
return this.schedule.apply(this,[e,t,r].concat(i))},e.prototype.schedule=function(e){R++
...
for(var n=arguments.length,i=Array(n>3?n-3:0),o=3;o<n;o++)i[o-3]=arguments[o]
return this.scheduleOnce.apply(this,[e,t,r].concat(i))},e.prototype.scheduleOnce=function(e){S++
for(var t=arguments.length,r=Array(t>1?t-1:0),n=1;n<t;n++)r[n-1]=arguments[n]
var i=y.apply(void 0,r),o=i[0],s=i[1],a=i[2],u=this.DEBUG?new Error:void 0
...
if(-1===a)u=this._later(t,r,s?g:n,i),s&&this._join(t,r,n)
else{u=this._timers[a+1]
var l=a+4
this._timers[l]!==g&&(this._timers[l]=n)}return u},e.prototype.debounce=function(){j++
var e=b.apply(void 0,arguments),t=e[0],r=e[1],n=e[2],i=e[3],o=e[4],a=void 0!==o&&o,u=this._timers,l=c(t,r,u),p=void 0
if(-1===l)p=this._later(t,r,a?g:n,i),a&&this._join(t,r,n)
...
this._autorun=e()},(0,t.createClass)(e,[{key:"counters",get:function(){return{begin:w,end:E,events:{begin:x,end:0},autoruns:{created:D,completed:z},run:C,join:T,defer:A,schedule:R,scheduleIterable:k,deferOnce:O,scheduleOnce:S,setTimeout:P,later:N,throttle:M,debounce:j,cancelTimers:I,cancel:L,loops:{total:F,nested:B}}}},{key:"defaultQueue",get:function(){return this._defaultQueue}}]),e}()
...
return k.ENCODE_AND_DECODE_PATH_SEGMENTS?p(r):r},y[2]=function(e,t){return m(t,e.value)},y[4]=function(){return""}
...
k.prototype.add=function(e,t){for(var r,n=this.rootState,i="^",o=[0,0,0],s=new Array(e.length),a=[],u=!0,l=0,c=0;c<e.length;c++){for(var p=e[c],h=w(a,p.path,o),f=h.names,d=h.shouldDecodes;l<a.length;l++){var m=a[l]
4!==m.type&&(u=!1,n=n.put(47,!1,!1),i+="/",n=v[m.type](m,n),i+=g[m.type](m))}s[c]={handler:p.handler,names:f,shouldDecodes:d}}u&&(n=n.put(47,!1,!1),i+="/"),n.handlers=s,n.pattern=i+"$",n.types=o,"object"==typeof t&&null!==t&&t.as&&(r=t.as),r&&(this.names[r]={segments:a,handlers:s})},k.prototype.handlersFor=function(e){var t=this.names[e]
...
t.push(u)}else s+="="+encodeURIComponent(o),t.push(s)}}return 0===t.length?"":"?"+t.join("&")},k.prototype.parseQueryString=function(e){for(var t=e.split("&"),r={},n=0;n<t.length;n++){var i=t[n].split("="),o=R(i[0]),s=o.length,a=!1,u=void 0
1===i.length?u="true":(s>2&&"[]"===o.slice(s-2)&&(a=!0,r[o=o.slice(0,s-2)]||(r[o]=[])),u=i[1]?R(i[1]):""),a?r[o].push(u):r[o]=u}return r},k.prototype.recognize=function(e){var t,r=[this.rootState],n={},i=!1,o=e.indexOf("#");-1!==o&&(e=e.substr(0,o))
var s=e.indexOf("?")
...
var m=c[d],v=o&&o[s++]
h===b&&(h={}),k.ENCODE_AND_DECODE_PATH_SEGMENTS&&p[d]?h[m]=v&&decodeURIComponent(v):h[m]=v}a[u]={handler:l.handler,params:h,isDynamic:f}}return a}(d,l,n)),t},k.VERSION="0.3.4",k.ENCODE_AND_DECODE_PATH_SEGMENTS=!0,k.Normalizer={normalizeSegment:l,normalizePath:a,encodePathSegment:p},k.prototype.map=function(e,t){var r=new i
...
return Object.isFrozen(e)||e.hasOwnProperty("attributes")?Object.freeze((0,r.assign)({},e,n)):(0,r.assign)(e,n)}function A(e){return null!=e&&void 0!==e.buildRouteInfoMetadata?e.buildRouteInfoMetadata():null}var R=function(){function e(e,t,r,n){this._routePromise=void 0,this._route=null,this.params={},this.isResolved=!1,this.name=t,this.paramNames=r,this.router=e,n&&this._processRoute(n)}return e.prototype.getModel=function(e){return n.Promise.resolve(this.context)},e.prototype.serialize=function(e){return this.params||{}},e.prototype.resolve=function(e,t){var r=this
...
var o=x.get(this),s=new k(this.router,this.name,this.paramNames,r,this.route,n)
...
return this.routePromise=n.Promise.resolve(e),null!==(t=e)&&"object"==typeof t&&"function"==typeof t.then?(this.routePromise=this.routePromise.then(function(e){return r.updateRoute(e)}),this.route=void 0):e?this.updateRoute(e):void 0},(0,t.createClass)(e,[{key:"route",get:function(){return null!==this._route?this._route:this.fetchRoute()},set:function(e){this._route=e}},{key:"routePromise",get:function(){return this._routePromise?this._routePromise:(this.fetchRoute(),this._routePromise)},set:function(e){this._routePromise=e}}]),e}(),k=function(e){function r(r,n,i,o,s,a){var u=(0,t.possibleConstructorReturn)(this,e.call(this,r,n,i,s))
return u.params=o,u.isResolved=!0,u.context=a,u}return(0,t.inherits)(r,e),r.prototype.resolve=function(e,t){return t&&t.resolvedModels&&(t.resolvedModels[this.name]=this.context),n.Promise.resolve(this)},r}(R),O=function(e){function r(r,n,i,o,s){var a=(0,t.possibleConstructorReturn)(this,e.call(this,r,n,i,s))
...
return r.deserialize?i=r.deserialize(t,e):r.model&&(i=r.model(t,e)),i&&E(i)&&(i=void 0),n.Promise.resolve(i)},r}(R),S=function(e){function r(r,n,i,o){var s=(0,t.possibleConstructorReturn)(this,e.call(this,r,n,i))
...
s=a&&a.context}return new S(this.router,e,t,s)},r.prototype.createParamHandlerInfo=function(e,t,r,n){for(var i={},o=t.length;o--;){var s=n&&e===n.name&&n.params||{},a=r[r.length-1],u=t[o]
if(h(a))i[u]=""+r.pop()
...
if(e[s]!==t[s])return!1}return!0}e.default=D,e.InternalTransition=_,e.logAbort=w,e.STATE_SYMBOL=g,e.PARAMS_SYMBOL=y,e.QUERY_PARAMS_SYMBOL=b,e.TransitionState=N,e.TransitionError=M,e.InternalRouteInfo=R}),e("rsvp",["exports","node-module","ember-babel"],function(e,t,r){"use strict"
...
return v=null,e.apply(this,arguments)}catch(t){return d.error=t,d}}function y(e){return v=e,g}function b(e,t,r){if(t.constructor===e.constructor&&r===R&&e.constructor.resolve===l)(function(e,t){t._state===h?E(e,t._result):t._state===f?(t._onError=null,x(e,t._result)):C(t,void 0,function(r){t===r?E(e,r):_(e,r)},function(t){return x(e,t)})})(e,t)
else if(r===d){var n=d.error
d.error=null,x(e,n)}else"function"==typeof r?function(e,t,r){o.async(function(e){var n=!1,i=y(r).call(t,function(r){n||(n=!0,t===r?E(e,r):_(e,r))},function(t){n||(n=!0,x(e,t))},"Settle: "+(e._label||" unknown promise"))
if(!n&&i===d){n=!0
var o=d.error
...
if(o=i?y(r)(n):n,t._state!==p);else if(o===t)x(t,new TypeError("A promises callback cannot return that same promise."))
else if(o===d){var s=d.error
d.error=null,x(t,s)}else i?_(t,o):e===h?E(t,o):e===f&&x(t,o)}function R(e,t,r){var n=this._state
...
o.async(function(){return A(n,i,a,s)})}return i}var k=function(){function e(e,t,r,n){this._instanceConstructor=e,this.promise=new e(c,n),this._abortOnReject=r,this._isUsingOwnPromise=e===N,this._isUsingOwnResolve=e.resolve===l,this._init.apply(this,arguments)}return e.prototype._init=function(e,t){var r=t.length||0
...
if(i===R&&e._state!==p)e._onError=null,this._settledAt(e._state,t,e._result,r)
...
function O(e,t,r){this._remaining--,this._result[t]=e===h?{state:"fulfilled",value:r}:{state:"rejected",reason:r}}var S="rsvp_"+Date.now()+"-",P=0
...
return r.__proto__=e,r}function I(e,t,r,n){if(y(r).apply(n,t)===d){var i=d.error
d.error=null,x(e,i)}return e}function L(e){return null!==e&&"object"==typeof e&&(e.constructor===N||m(e))}function D(e,t){return N.all(e,t)}N.cast=l,N.all=function(e,t){return Array.isArray(e)?new k(this,e,!0,t).promise:this.reject(new TypeError("Promise.all must be called with an array"),t)},N.race=function(e,t){var r=new this(c,t)
...
return x(r,e),r},N.prototype._guidKey=S,N.prototype.then=R
var z=function(e){function t(t,n,i){return(0,r.possibleConstructorReturn)(this,e.call(this,t,n,!1,i))}return(0,r.inherits)(t,e),t}(k)
function F(e,t){return Array.isArray(e)?new z(N,e,t).promise:N.reject(new TypeError("Promise.allSettled must be called with an array"),t)}function B(e,t){return N.race(e,t)}z.prototype._setResultAt=O
...
i===d?this._settledAt(f,t,i.error,!1):this._eachEntry(i,t,!1)}else this._remaining--,this._result[t]=r},t}(k)
...
for(var xe in s("instrument",!0),Ee)Ee.hasOwnProperty(xe)&&_e(xe,Ee[xe])}var Ce={asap:re,cast:ye,Promise:N,EventTarget:i,all:D,allSettled:F,race:B,hash:q,hashSettled:V,rethrow:W,defer:Y,denodeify:j,configure:s,on:_e,off:we,resolve:Q,reject:$,map:K,async:be,filter:Z}
e.default=Ce,e.asap=re,e.cast=ye,e.Promise=N,e.EventTarget=i,e.all=D,e.allSettled=F,e.race=B,e.hash=q,e.hashSettled=V,e.rethrow=W,e.defer=Y,e.denodeify=j,e.configure=s,e.on=_e,e.off=we,e.resolve=Q,e.reject=$,e.map=K,e.async=be,e.filter=Z}),t("ember")}(),function(){return function e(t,r,n){function i(s,a){if(!r[s]){if(!t[s]){var u="function"==typeof require&&require
if(!a&&u)return u(s,!0)
if(o)return o(s,!0)
...
n=self,i=function(){return(()=>{"use strict"
var e={d:(t,r)=>{for(var n in r)e.o(r,n)&&!e.o(t,n)&&Object.defineProperty(t,n,{enumerable:!0,get:r[n]})},o:(e,t)=>Object.prototype.hasOwnProperty.call(e,t)},t={}
e.d(t,{default:()=>r})
const r=function(){function e(t){var r=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{}
...
return t=e,(r=[{key:"log",value:function(){if(this.logging){for(var e,t=arguments.length,r=new Array(t),n=0;n<t;n++)r[n]=arguments[n];(e=console).debug.apply(e,["[RS-WIDGET] "].concat(r))}}},{key:"eventHandler",value:function(e,t){var r=this
switch(this.log("EVENT: ",e),e){case"ready":this.setState(this.state)
break
case"sync-req-done":this.syncInProgress=!0,this.rsSyncButton.classList.add("rs-rotate"),setTimeout(function(){r.syncInProgress&&(r.rsConnectedLabel.textContent="Synchronizing")},1e3)
break
...
r&&(r.classList.add("rs-selected"),r.setAttribute("aria-hidden","false"))
var n=this.rsWidget.className.match(/rs-state-\S+/g)[0]
this.rsWidget.classList.remove(n),this.rsWidget.classList.add("rs-state-".concat(e||this.state)),this.state=e}}},{key:"setInitialState",value:function(){this.skipInitial?this.showChooseOrSignIn():this.setState("initial")}},{key:"createHtmlTemplate",value:function(){var e=document.createElement("div")
...
this.rs.on("connected",function(){return e.eventHandler("connected")}),this.rs.on("ready",function(){return e.eventHandler("ready")}),this.rs.on("disconnected",function(){return e.eventHandler("disconnected")}),this.rs.on("network-online",function(){return e.eventHandler("network-online")}),this.rs.on("network-offline",function(){return e.eventHandler("network-offline")}),this.rs.on("error",function(t){return e.eventHandler("error",t)}),this.setEventListeners(),this.setClickHandlers()}},{key:"attach",value:function(e){var t,r=this.createHtmlTemplate()
if(e){if(t=document.getElementById(e),!parent)throw'Failed to find target DOM element with id="'+e+'"'}else t=document.body
t.appendChild(r),this.setupElements(),this.setupHandlers(),this.setInitialState(),this.setModalClass()}},{key:"setEventListeners",value:function(){var e=this
...
document.querySelector(".rs-box-connected .rs-sub-headline").innerHTML="Synced ".concat(t," seconds ago")}}},{key:"isSmallScreen",value:function(){return window.innerWidth<421}}])&&function(e,t){for(var r=0;r<t.length;r++){var n=t[r]
n.enumerable=n.enumerable||!1,n.configurable=!0,"value"in n&&(n.writable=!0),Object.defineProperty(e,n.key,n)}}(t.prototype,r),Object.defineProperty(t,"prototype",{writable:!1}),e}()
return t.default})()},"object"==typeof r&&"object"==typeof t?t.exports=i():"function"==typeof define&&define.amd?define([],i):"object"==typeof r?r.Widget=i():n.Widget=i()},{}],3:[function(e,t,r){var n,i
...
return e.replace(/\/+/g,"/").replace(/[^\/]+\/?$/,"")}),t.isFolder=(e=>"/"===e.slice(-1)),t.isDocument=(e=>!t.isFolder(e)),t.baseName=(e=>{const r=e.split("/")
...
for(let i=0,o=e.length;i<o;i++)if(!t.equal(e[i],r[i],n))return!1}else{for(i in e)if(e.hasOwnProperty(i)&&!(i in r))return!1
for(i in r){if(!r.hasOwnProperty(i))continue
if(!(i in e))return!1
let o
if("object"==typeof r[i]){if(n.indexOf(r[i])>=0)continue;(o=n.slice()).push(r[i])}if(!t.equal(e[i],r[i],o))return!1}}return!0}),t.deepClone=(e=>{if(void 0!==e){const t=JSON.parse(JSON.stringify(e))
...
const o=t.globalContext
if(o.BlobBuilder=o.BlobBuilder||o.WebKitBlobBuilder,void 0!==o.BlobBuilder){const t=new o.BlobBuilder
t.append(e),r=t.getBlob()}else r=new Blob([e])
const s=new FileReader
"function"==typeof s.addEventListener?s.addEventListener("loadend",function(e){i(e.target.result)}):s.onloadend=function(e){i(e.target.result)},s.readAsText(r,n)}})),t.toBase64=(e=>{const n=t.getGlobalContext()
...
e.exports=class extends Error{constructor(e,t={}){super(),this.name="Unauthorized",this.message=void 0===e?"App authorization expired or revoked.":e,void 0!==t.code&&(this.code=t.code),this.stack=(new Error).stack}}},function(e,t){var r
...
e.rsDiscovery=JSON.parse(atob(n)),(t=t.replace(new RegExp("&?rsDiscovery="+n),"")).length>0&&(e.state=t)}else e[decodeURIComponent(r[0])]=decodeURIComponent(r[1])
return e},{}):void 0}class l{static authorize(e,{authURL:t,scope:r,redirectUri:n,clientId:s}){if(i.default("[Authorize] authURL = ",t,"scope = ",r,"redirectUri = ",n,"clientId = ",s),!r)throw new Error("Cannot authorize due to undefined or empty scope; did you forget to access.claim()?")
if(!r)throw new Error("Cannot authorize due to undefined or empty scope; did you forget to access.claim()?")
if(!o.localStorageAvailable()&&"remotestorage"===e.backend){n+=n.indexOf("#")>0?"&":"#"
...
n+="rsDiscovery="+o.toBase64(JSON.stringify(t))}const a=function(e,t,r,n){const i=t.indexOf("#")
let o=e
return o+=e.indexOf("?")>0?"&":"?",o+="redirect_uri="+encodeURIComponent(t.replace(/#.*$/,"")),o+="&scope="+encodeURIComponent(r),o+="&client_id="+encodeURIComponent(n),-1!==i&&i+1!==t.length&&(o+="&state="+encodeURIComponent(t.substring(i+1))),o+="&response_type=token"}(t,n,r,s)
o.globalContext.cordova?l.openWindow(a,n,"location=yes,clearsessioncache=yes,clearcache=yes").then(t=>{e.remote.configure({token:t.access_token})}):l.setLocation(a)}static setLocation(e){if("string"==typeof e)document.location.href=e
else{if("object"!=typeof e)throw"Invalid location "+e
document.location=e}}static _rs_supported(){return"undefined"!=typeof document}static _rs_cleanup(e){e.removeEventListener("features-loaded",a)}}l.IMPLIED_FAKE_TOKEN=!1,l.getLocation=function(){return document.location},l.openWindow=function(e,t,r){return new Promise((n,i)=>{const o=open(e,"_blank",r)
function s(){i("Authorization was canceled")}o&&!o.closed?(o.addEventListener("loadstart",function(e){if(0!==e.url.indexOf(t))return
o.removeEventListener("exit",s),o.close()
const r=u(e.url)
r?n(r):i("Authorization error")}),o.addEventListener("exit",s)):i("Authorization popup was blocked")})},l._rs_init=function(e){const t=u()
let r
t&&((r=l.getLocation()).hash=""),a=function(){let n=!1
if(t){if(t.error)throw"access_denied"===t.error?new s.default("Authorization failed: access denied",{code:"access_denied"}):new s.default(`Authorization failed: ${t.error}`)
...
var n=this&&this.__awaiter||function(e,t,r,n){return new(r||(r=Promise))(function(i,o){function s(e){try{u(n.next(e))}catch(e){o(e)}}function a(e){try{u(n.throw(e))}catch(e){o(e)}}function u(e){var t
e.done?i(e.value):(t=e.value,t instanceof r?t:new r(function(e){e(t)})).then(s,a)}u((n=n.apply(e,t||[])).next())})},i=this&&this.__importDefault||function(e){return e&&e.__esModule?e:{default:e}}
const o=i(r(23)),s=i(r(24)),a=i(r(25)),u=i(r(2)),l=i(r(3)),c=r(0)
class p{constructor(e,t){if(this.schemas={configurable:!0,get(){return p.Types.inScope(this.moduleName)}},"/"!==t[t.length-1])throw"Not a folder: "+t
"/"===t&&(this.makePath=(e=>("/"===e[0]?"":"/")+e)),this.storage=e,this.base=t,this.moduleName=function(e){const t=e.split("/")
return e.length>2?t[1]:"root"}(this.base),this.addEvents(["change"]),this.on=this.on.bind(this),e.onChange(this.base,this._fireChange.bind(this))}scope(e){return new p(this.storage,this.makePath(e))}getListing(e,t){return n(this,void 0,void 0,function*(){if("string"!=typeof e)e=""
else if(e.length>0&&!c.isFolder(e))return Promise.reject("Not a folder: "+e)
return this.storage.get(this.makePath(e),t).then(e=>404===e.statusCode?{}:e.body)})}getAll(e,t){return n(this,void 0,void 0,function*(){if("string"!=typeof e)e=""
else if(e.length>0&&!c.isFolder(e))return Promise.reject("Not a folder: "+e)
...
const i=n.map(n=>this.storage.get(this.makePath(e+n),t).then(e=>{if("string"==typeof e.body)try{e.body=JSON.parse(e.body)}catch(e){}"object"==typeof e.body&&(r.body[n]=e.body)}))
return Promise.all(i).then(()=>r.body)}})})}getFile(e,t){return n(this,void 0,void 0,function*(){return"string"!=typeof e?Promise.reject("Argument 'path' of baseClient.getFile must be a string"):this.storage.get(this.makePath(e),t).then(e=>({data:e.body,contentType:e.contentType,revision:e.revision}))})}storeFile(e,t,r){return n(this,void 0,void 0,function*(){return"string"!=typeof e?Promise.reject("Argument 'mimeType' of baseClient.storeFile must be a string"):"string"!=typeof t?Promise.reject("Argument 'path' of baseClient.storeFile must be a string"):"string"!=typeof r&&"object"!=typeof r?Promise.reject("Argument 'body' of baseClient.storeFile must be a string, ArrayBuffer, or ArrayBufferView"):(this.storage.access.checkPathPermission(this.makePath(t),"rw")||console.warn("WARNING: Editing a document to which only read access ('r') was claimed"),this.storage.put(this.makePath(t),r,e).then(e=>200===e.statusCode||201===e.statusCode?e.revision:Promise.reject("Request (PUT "+this.makePath(t)+") failed with status: "+e.statusCode)))})}getObject(e,t){return n(this,void 0,void 0,function*(){return"string"!=typeof e?Promise.reject("Argument 'path' of baseClient.getObject must be a string"):this.storage.get(this.makePath(e),t).then(t=>{if("object"==typeof t.body)return t.body
if("string"==typeof t.body)try{return JSON.parse(t.body)}catch(t){throw new Error("Not valid JSON: "+this.makePath(e))}else if(void 0!==t.body&&200===t.statusCode)return Promise.reject("Not an object: "+this.makePath(e))})})}storeObject(e,t,r){return n(this,void 0,void 0,function*(){if("string"!=typeof e)return Promise.reject("Argument 'typeAlias' of baseClient.storeObject must be a string")
...
if(r&&"string"==typeof t)n=t
else if(r||"string"==typeof t){if(!r&&"string"==typeof t)throw new Error("declareType() requires a JSON Schema object to be passed, in order to validate object types/formats")}else r=t,n=this._defaultTypeURI(e)
p.Types.declare(this.moduleName,e,n,r)}validate(e){const t=p.Types.getSchema(e["@context"])
if(t)return o.default.validateResult(e,t)
throw new a.default(e["@context"])}_defaultTypeURI(e){return"http://remotestorage.io/spec/modules/"+encodeURIComponent(this.moduleName)+"/"+encodeURIComponent(e)}_attachType(e,t){e["@context"]=p.Types.resolveAlias(this.moduleName+"/"+t)||this._defaultTypeURI(t)}makePath(e){return this.base+(e||"")}_fireChange(e){l.default.changeEvents[e.origin]&&(["new","old","lastCommon"].forEach(function(t){if((!e[t+"ContentType"]||/^application\/(.*)json(.*)/.exec(e[t+"ContentType"]))&&"string"==typeof e[t+"Value"])try{e[t+"Value"]=JSON.parse(e[t+"Value"])}catch(e){}}),this._emit("change",e))}static _rs_init(){}}p.Types=s.default,c.applyMixins(p,[u.default]),e.exports=p},function(e,t,r){"use strict";(function(t){var n=this&&this.__awaiter||function(e,t,r,n){return new(r||(r=Promise))(function(i,o){function s(e){try{u(n.next(e))}catch(e){o(e)}}function a(e){try{u(n.throw(e))}catch(e){o(e)}}function u(e){var t
e.done?i(e.value):(t=e.value,t instanceof r?t:new r(function(e){e(t)})).then(s,a)}u((n=n.apply(e,t||[])).next())})},i=this&&this.__importDefault||function(e){return e&&e.__esModule?e:{default:e}}
const o=i(r(6)),s=i(r(2)),a=i(r(4)),u=i(r(3)),l=i(r(1)),c=r(0)
let p
...
let d
if("function"==typeof(t||window).ArrayBufferView)d=function(e){return e&&e instanceof(t||window).ArrayBufferView}
else{const e=[Int8Array,Uint8Array,Int16Array,Uint16Array,Int32Array,Uint32Array,Float32Array,Float64Array]
d=function(t){for(let r=0;r<8;r++)if(t instanceof e[r])return!0
return!1}}function m(e){return"string"!=typeof e?e:"*"===e?"*":'"'+e+'"'}function v(e){return"string"!=typeof e?e:e.replace(/^["']|["']$/g,"")}class g{constructor(e){if(this._revisionCache={},p=c.localStorageAvailable(),this.rs=e,this.connected=!1,this.addEvents(["connected","not-connected"]),p){const e=function(){const e=c.getJSONFromLocalStorage(h)||{},{userAddress:t,href:r,storageApi:n,token:i,properties:o}=e
return{userAddress:t,href:r,storageApi:n,token:i,properties:o}}()
...
return e?e[1]:"2012.04"}}_request(e,t,r,i,s,u,p){return n(this,void 0,void 0,function*(){if(function(e,t){return("PUT"===e||"DELETE"===e)&&c.isFolder(t)}(e,t))return Promise.reject(`Don't use ${e} on directories!`)
let n
return r!==o.default.IMPLIED_FAKE_TOKEN&&(i.Authorization="Bearer "+r),this.rs._emit("wire-busy",{method:e,isFolder:c.isFolder(t)}),g.request(e,t,{body:s,headers:i,responseType:"arraybuffer"}).then(r=>{if(this.online||(this.online=!0,this.rs._emit("network-online")),this.rs._emit("wire-done",{method:e,isFolder:c.isFolder(t),success:!0}),i=r.status,[401,403,404,412].indexOf(i)>=0)return l.default("[WireClient] Error response status",r.status),n=u?v(r.getResponseHeader("ETag")):void 0,401===r.status&&this.rs._emit("error",new a.default),Promise.resolve({statusCode:r.status,revision:n})
if(function(e){return[201,204,304].indexOf(e)>=0}(r.status)||200===r.status&&"GET"!==e)return n=v(r.getResponseHeader("ETag")),l.default("[WireClient] Successful request",n),Promise.resolve({statusCode:r.status,revision:n})
{const e=r.getResponseHeader("Content-Type")
n=u?v(r.getResponseHeader("ETag")):200===r.status?p:void 0
const t=function(e){let t,r="utf-8"
return e&&((t=e.match(/charset=(.+)$/))&&(r=t[1])),r}(e)
...
!r.match(/charset=/)&&(t instanceof ArrayBuffer||d(t))&&(r+="; charset=binary")
...
t||(t={})
const r={}
return this.supportsRevs&&t.ifMatch&&(r["If-Match"]=m(t.ifMatch)),this._request("DELETE",this.href+c.cleanPath(e),this.token,r,void 0,this.supportsRevs)}static request(e,t,r){return n(this,void 0,void 0,function*(){return"function"==typeof fetch?g._fetchRequest(e,t,r):"function"==typeof XMLHttpRequest?g._xhrRequest(e,t,r):(l.default("[WireClient] You need to add a polyfill for fetch or XMLHttpRequest"),Promise.reject("[WireClient] You need to add a polyfill for fetch or XMLHttpRequest"))})}static _fetchRequest(e,t,r){let n
const i={}
let o
"function"==typeof AbortController&&(o=new AbortController)
const s=fetch(t,{method:e,headers:r.headers,body:r.body,signal:o?o.signal:void 0}).then(e=>{switch(l.default("[WireClient fetch]",e),e.headers.forEach((e,t)=>{i[t.toUpperCase()]=e}),n={readyState:4,status:e.status,statusText:e.statusText,response:void 0,getResponseHeader:e=>i[e.toUpperCase()]||null,responseType:r.responseType,responseURL:t},r.responseType){case"arraybuffer":return e.arrayBuffer()
case"blob":return e.blob()
case"json":return e.json()
case void 0:case"":case"text":return e.text()
default:throw new Error("responseType 'document' is not currently supported using fetch")}}).then(e=>(n.response=e,r.responseType&&"text"!==r.responseType||(n.responseText=e),n)),a=new Promise((e,t)=>{setTimeout(()=>{t("timeout"),o&&o.abort()},u.default.requestTimeout)})
return Promise.race([s,a])}static _xhrRequest(e,t,r){return new Promise((n,i)=>{l.default("[WireClient]",e,t)
let o=!1
const s=setTimeout(()=>{o=!0,i("timeout")},u.default.requestTimeout),a=new XMLHttpRequest
...
a.onload=(()=>{o||(clearTimeout(s),n(a))}),a.onerror=(e=>{o||(clearTimeout(s),i(e))})
let c=r.body
"object"==typeof c&&!d(c)&&c instanceof ArrayBuffer&&(c=new Uint8Array(c)),a.send(c)})}static _rs_init(e){e.remote=new g(e),e.remote.online=!0}static _rs_supported(){return"function"==typeof fetch||"function"==typeof XMLHttpRequest}static _rs_cleanup(){p&&delete localStorage[h]}}g.isArrayBufferView=d,c.applyMixins(g,[s.default]),e.exports=g}).call(this,r(5))},function(e,t,r){"use strict"
e.exports=class extends Error{constructor(e){super(),this.name="SyncError",this.message="Sync failed: ","string"==typeof e?this.message+=e:(this.message+=e.message,this.stack=e.stack,this.originalError=e)}}},function(e,t,r){"use strict"
var n=this&&this.__awaiter||function(e,t,r,n){return new(r||(r=Promise))(function(i,o){function s(e){try{u(n.next(e))}catch(e){o(e)}}function a(e){try{u(n.throw(e))}catch(e){o(e)}}function u(e){var t
e.done?i(e.value):(t=e.value,t instanceof r?t:new r(function(e){e(t)})).then(s,a)}u((n=n.apply(e,t||[])).next())})},i=this&&this.__importDefault||function(e){return e&&e.__esModule?e:{default:e}}
const o=i(r(2)),s=i(r(3)),a=i(r(1)),u=r(0)
function l(e){if("object"==typeof e&&"string"==typeof e.path)if(u.isFolder(e.path)){if(e.local&&e.local.itemsMap)return e.local
...
if(!n)return!0}return!0}function p(e){const t={path:e,common:{}}
return u.isFolder(e)&&(t.common.itemsMap={}),t}function h(e,t){return e.common||(e.common={itemsMap:{}}),e.common.itemsMap||(e.common.itemsMap={}),e.local||(e.local=u.deepClone(e.common)),e.local.itemsMap||(e.local.itemsMap=e.common.itemsMap),e.local.itemsMap[t]=!0,e}class f{constructor(){this._updateNodesRunning=!1,this._updateNodesQueued=[]}get(e,t,r){return n(this,void 0,void 0,function*(){return"number"==typeof t?this.getNodes(u.pathsFromRoot(e)).then(n=>{const i=l(n[e])
...
if(r){if(u.isFolder(e))for(const e in r.itemsMap)r.itemsMap.hasOwnProperty(e)&&!1===r.itemsMap[e]&&delete r.itemsMap[e]
return{statusCode:200,body:r.body||r.itemsMap,contentType:r.contentType}}return{statusCode:404}})})}put(e,t,r){return n(this,void 0,void 0,function*(){const n=u.pathsFromRoot(e)
return this._updateNodes(n,function(e,n){try{for(let i=0,o=e.length;i<o;i++){const o=e[i]
let s,a=n[o]
a||(n[o]=a=p(o)),0===i?(s=l(a),a.local={body:t,contentType:r,previousBody:s?s.body:void 0,previousContentType:s?s.contentType:void 0}):a=h(a,e[i-1].substring(o.length))}return n}catch(e){throw a.default("[Cachinglayer] Error during PUT",n,e),e}})})}delete(e){const t=u.pathsFromRoot(e)
return this._updateNodes(t,function(e,t){for(let r=0,n=e.length;r<n;r++){const n=e[r],i=t[n]
let o
if(i)if(0===r)o=l(i),i.local={body:!1,previousBody:o?o.body:void 0,previousContentType:o?o.contentType:void 0}
else{i.local||(i.local=u.deepClone(i.common))
...
this._rootPaths[e]=t,"ALL"===t&&(this.activateHandler?this.activateHandler(e):this.pendingActivations.push(e))}enable(e){this.set(e,"ALL")}disable(e){this.set(e,"FLUSH")}onActivate(e){o.default("[Caching] Setting activate handler",e,this.pendingActivations),this.activateHandler=e
...
var n=this&&this.__importDefault||function(e){return e&&e.__esModule?e:{default:e}}
const i=n(r(7)),o=n(r(8)),s=n(r(2)),a=r(0),u="https://www.googleapis.com",l="remotestorage:googledrive"
let c
function p(e){return"/"===e.substr(-1)&&(e=e.substr(0,e.length-1)),decodeURIComponent(e)}function h(e){return e.replace(/[^\/]+\/?$/,"")}function f(e){const t=e.split("/")
return"/"===e.substr(-1)?t[t.length-2]+"/":t[t.length-1]}function d(e){return a.cleanPath(`/remotestorage/${e}`)}function m(e){return e.replace(/^["'](.*)["']$/,"$1")}class v{constructor(e){this._items={},this.maxAge=e,this._items={}}get(e){const t=this._items[e],r=(new Date).getTime()
return t&&t.t>=r-this.maxAge?t.v:void 0}set(e,t){this._items[e]={v:t,t:(new Date).getTime()}}}class g{constructor(e,t){if(this.connected=!1,this.online=!0,this.addEvents(["connected","not-connected"]),this.rs=e,this.clientId=t,this._fileIdCache=new v(300),c=a.localStorageAvailable()){const e=a.getJSONFromLocalStorage(l)
...
return Promise.resolve(t)}catch(e){return Promise.reject(e)}})}_updateFile(e,t,r,n,i){const o={mimeType:n},s={"Content-Type":"application/json; charset=UTF-8"}
return i&&i.ifMatch&&(s["If-Match"]='"'+i.ifMatch+'"'),this._request("PUT",u+"/upload/drive/v2/files/"+e+"?uploadType=resumable",{body:JSON.stringify(o),headers:s}).then(e=>412===e.status?e:this._request("PUT",e.getResponseHeader("Location"),{body:n.match(/^application\/json/)?JSON.stringify(r):r}))}_createFile(e,t,r){return this._getParentId(e).then(n=>{const i={title:p(f(e)),mimeType:r,parents:[{kind:"drive#fileLink",id:n}]}
...
const o="'"+t+"' in parents"
return this._request("GET",u+"/drive/v2/files?q="+encodeURIComponent(o)+"&fields="+encodeURIComponent("items(downloadUrl,etag,fileSize,id,mimeType,title,labels)")+"&maxResults=1000&trashed=false",{}).then(t=>{var o
...
for(const s of r.items)null!==(o=s.labels)&&void 0!==o&&o.trashed||(n=m(s.etag),"application/vnd.google-apps.folder"===s.mimeType?(this._fileIdCache.set(e+a.cleanPath(s.title)+"/",s.id),i[s.title+"/"]={ETag:n}):(this._fileIdCache.set(e+a.cleanPath(s.title),s.id),i[s.title]={ETag:n,"Content-Type":s.mimeType,"Content-Length":s.fileSize}))
...
return this._getFileId(t).then(e=>e?Promise.resolve(e):this._createFolder(t))}_createFolder(e){return this._getParentId(e).then(t=>this._request("POST",u+"/drive/v2/files",{body:JSON.stringify({title:p(f(e)),mimeType:"application/vnd.google-apps.folder",parents:[{id:t}]}),headers:{"Content-Type":"application/json; charset=UTF-8"}}).then(e=>{const t=JSON.parse(e.responseText)
return Promise.resolve(t.id)}))}_getFileId(e){let t
return"/"===e?Promise.resolve("root"):(t=this._fileIdCache.get(e))?Promise.resolve(t):this._getFolder(h(e)).then(()=>(t=this._fileIdCache.get(e),t?Promise.resolve(t):"/"===e.substr(-1)?this._createFolder(e).then(()=>this._getFileId(e)):Promise.resolve()))}_getMeta(e){return this._request("GET",u+"/drive/v2/files/"+e,{}).then(function(t){return 200===t.status?Promise.resolve(JSON.parse(t.responseText)):Promise.reject("request (getting metadata for "+e+") failed with status: "+t.status)})}_request(e,t,r){return r.headers||(r.headers={}),r.headers.Authorization="Bearer "+this.token,this.rs._emit("wire-busy",{method:e,isFolder:a.isFolder(t)}),o.default.request.call(this,e,t,r).then(r=>r&&401===r.status?void this.connect():(this.online||(this.online=!0,this.rs._emit("network-online")),this.rs._emit("wire-done",{method:e,isFolder:a.isFolder(t),success:!0}),Promise.resolve(r)),r=>(this.online&&(this.online=!1,this.rs._emit("network-offline")),this.rs._emit("wire-done",{method:e,isFolder:a.isFolder(t),success:!1}),Promise.reject(r)))}static _rs_init(e){const t=e.apiKeys.googledrive
var r
t&&(e.googledrive=new g(e,t.clientId),"googledrive"===e.backend&&(e._origRemote=e.remote,e.remote=e.googledrive,(r=e)._origBaseClientGetItemURL||(r._origBaseClientGetItemURL=i.default.prototype.getItemURL,i.default.prototype.getItemURL=function(){throw new Error("getItemURL is not implemented for Google Drive yet")})))}static _rs_supported(){return!0}static _rs_cleanup(e){var t
e.setBackend(void 0),e._origRemote&&(e.remote=e._origRemote,delete e._origRemote),(t=e)._origBaseClientGetItemURL&&(i.default.prototype.getItemURL=t._origBaseClientGetItemURL,delete t._origBaseClientGetItemURL)}}a.applyMixins(g,[s.default]),e.exports=g},function(e,t,r){"use strict"
var n=this&&this.__awaiter||function(e,t,r,n){return new(r||(r=Promise))(function(i,o){function s(e){try{u(n.next(e))}catch(e){o(e)}}function a(e){try{u(n.throw(e))}catch(e){o(e)}}function u(e){var t
e.done?i(e.value):(t=e.value,t instanceof r?t:new r(function(e){e(t)})).then(s,a)}u((n=n.apply(e,t||[])).next())})},i=this&&this.__importDefault||function(e){return e&&e.__esModule?e:{default:e}}
const o=i(r(2)),s=i(r(8)),a=i(r(7)),u=i(r(26)),l=i(r(9)),c=i(r(4)),p=r(0)
let h
const f="remotestorage:dropbox"
function d(e){return p.cleanPath("/remotestorage/"+e).replace(/\/$/,"")}function m(e,t){return new RegExp("^"+t.join("\\/")+"(\\/|$)").test(e.error_summary)}function v(e){return e instanceof ArrayBuffer||s.default.isArrayBufferView(e)}class g{constructor(e){if(this.rs=e,this.connected=!1,this.online=!0,this._initialFetchDone=!1,this.addEvents(["connected","not-connected"]),this.clientId=e.apiKeys.dropbox.appKey,this._revCache=new u.default("rev"),this._fetchDeltaCursor=null,this._fetchDeltaPromise=null,this._itemRefs={},h=p.localStorageAvailable()){const e=p.getJSONFromLocalStorage(f)
e&&this.configure(e),this._itemRefs=p.getJSONFromLocalStorage(`${f}:shares`)||{}}this.connected&&setTimeout(this._emit.bind(this),0,"connected")}connect(){this.rs.setBackend("dropbox"),this.token?_(this.rs):this.rs.authorize({authURL:"https://www.dropbox.com/oauth2/authorize",scope:"",clientId:this.clientId})}configure(e){void 0!==e.userAddress&&(this.userAddress=e.userAddress),void 0!==e.token&&(this.token=e.token)
...
const o=i.entries.reduce((r,n)=>{const i="folder"===n[".tag"],o=n.path_lower.split("/").slice(-1)[0]+(i?"/":"")
return i?r[o]={ETag:t.get(e+o)}:(r[o]={ETag:n.rev},this._revCache.set(e+o,n.rev)),r},{})
return i.has_more?n(i.cursor).then(function(e){return Object.assign(o,e)}):Promise.resolve(o)},n=e=>{const t={body:{cursor:e}}
return this._request("POST","https://api.dropboxapi.com/2/files/list_folder/continue",t).then(r)}
return this._request("POST","https://api.dropboxapi.com/2/files/list_folder",{body:{path:d(e)}}).then(r).then(function(r){return Promise.resolve({statusCode:200,body:r,contentType:"application/json; charset=UTF-8",revision:t.get(e)})})}get(e,t){if(!this.connected)return Promise.reject("not connected (path: "+e+")")
...
const n={headers:{"Dropbox-API-Arg":JSON.stringify({path:d(e)})},responseType:"arraybuffer"}
...
let n,i,o,s
return 200!==r&&409!==r?Promise.resolve({statusCode:r}):(n=t.getResponseHeader("Dropbox-API-Result"),p.getTextFromArrayBuffer(t.response,"UTF-8").then(a=>{i=a,409===r&&(n=i)
...
if(o=t.getResponseHeader("Content-Type"),s=n.rev,this._revCache.set(e,s),this._shareIfNeeded(e),p.shouldBeTreatedAsBinary(a,o))i=t.response
else try{i=JSON.parse(i),o="application/json; charset=UTF-8"}catch(e){}return{statusCode:r,body:i,contentType:o,revision:s}}))})}put(e,t,r,n){if(!this.connected)throw new Error("not connected (path: "+e+")")
...
if(!r.match(/charset=/)&&v(t)&&(r+="; charset=binary"),t.length>157286400)return Promise.reject(new Error("Cannot upload file larger than 150MB"))
let o
const s=n&&(n.ifMatch||"*"===n.ifNoneMatch),a={body:t,contentType:r,path:e}
return(o=s?this._getMetadata(e).then(e=>n&&"*"===n.ifNoneMatch&&e?Promise.resolve({statusCode:412,revision:e.rev}):n&&n.ifMatch&&e&&e.rev!==n.ifMatch?Promise.resolve({statusCode:412,revision:e.rev}):this._uploadSimple(a)):this._uploadSimple(a)).then(t=>(this._shareIfNeeded(e),t))}delete(e,t){if(!this.connected)throw new Error("not connected (path: "+e+")")
const r=this._revCache.get(e)
return t&&t.ifMatch&&r&&t.ifMatch!==r?Promise.resolve({statusCode:412,revision:r}):t&&t.ifMatch?this._getMetadata(e).then(r=>t&&t.ifMatch&&r&&r.rev!==t.ifMatch?Promise.resolve({statusCode:412,revision:r.rev}):this._deleteSimple(e)):this._deleteSimple(e)}_shareIfNeeded(e){e.match(/^\/public\/.*[^/]$/)&&void 0===this._itemRefs[e]&&this.share(e)}share(e){const t={body:{path:d(e)}}
...
let t
try{t=JSON.parse(e.responseText)}catch(t){return Promise.reject(new Error("Invalid response body: "+e.responseText))}return 409===e.status?Promise.reject(new Error("API error: "+e.error_summary)):t.links.length?Promise.resolve(t.links[0].url):Promise.reject(new Error("No links returned"))},t=>(t.message='Could not get link to a shared file or folder ("'+e+'"): '+t.message,Promise.reject(t)))})}static _rs_init(e){h=p.localStorageAvailable(),e.apiKeys.dropbox&&(e.dropbox=new g(e)),"dropbox"===e.backend&&_(e)}static _rs_supported(){return!0}static _rs_cleanup(e){!function(e){(function(e){e._origRemote&&(e.remote=e._origRemote,delete e._origRemote)})(e),function(e){e._dropboxOrigSync&&(e.sync.sync=e._dropboxOrigSync,delete e._dropboxOrigSync)}(e),function(e){e._origBaseClientGetItemURL&&(a.default.prototype.getItemURL=e._origBaseClientGetItemURL,delete e._origBaseClientGetItemURL)}(e),b(e)}(e),h&&localStorage.removeItem(f),e.setBackend(void 0)}}function y(e,...t){e._dropboxOrigSync||(e._dropboxOrigSync=e.sync.sync.bind(e.sync),e.sync.sync=function(){return this.dropbox.fetchDelta(e,...t).then(e._dropboxOrigSync,function(t){e._emit("error",new l.default(t)),e._emit("sync-done")})}.bind(e))}function b(e){e._dropboxOrigSyncCycle&&(e.syncCycle=e._dropboxOrigSyncCycle,delete e._dropboxOrigSyncCycle)}function _(e){!function(e){e._origRemote||(e._origRemote=e.remote,e.remote=e.dropbox)}(e),e.sync?y(e):function(e,...t){e._dropboxOrigSyncCycle||(e._dropboxOrigSyncCycle=e.syncCycle,e.syncCycle=(()=>{if(!e.sync)throw new Error("expected sync to be initialized by now")
y(e),e._dropboxOrigSyncCycle(e,...t),b(e)}))}(e),function(e){e._origBaseClientGetItemURL||(e._origBaseClientGetItemURL=a.default.prototype.getItemURL,a.default.prototype.getItemURL=function(){throw new Error("getItemURL is not implemented for Dropbox yet")})}(e)}p.applyMixins(g,[o.default]),e.exports=g},function(e,t,r){"use strict"
var n=this&&this.__importDefault||function(e){return e&&e.__esModule?e:{default:e}}
const i=n(r(27)),o=n(r(1)),s=r(0)
let a,u,l={}
...
if("object"!=typeof i.idx.links.remotestorage||"number"!=typeof i.idx.links.remotestorage.length||i.idx.links.remotestorage.length<=0)return o.default("[Discover] WebFinger record for "+e+" does not have remotestorage defined in the links section ",JSON.stringify(i.json)),r("WebFinger record for "+e+" does not have remotestorage defined in the links section.")
const s=i.idx.links.remotestorage[0],a=s.properties["http://tools.ietf.org/html/rfc6749#section-4.2"]||s.properties["auth-endpoint"],c=s.properties["http://remotestorage.io/spec/version"]||s.type
return l[e]={href:s.href,storageApi:c,authURL:a,properties:s.properties},u&&(localStorage["remotestorage:discover"]=JSON.stringify({cache:l})),t(l[e])}))};(c.DiscoveryError=function(e){this.name="DiscoveryError",this.message=e,this.stack=(new Error).stack}).prototype=Object.create(Error.prototype),c.DiscoveryError.prototype.constructor=c.DiscoveryError,c._rs_init=function(){if(u=s.localStorageAvailable())try{const t=JSON.parse(localStorage["remotestorage:discover"])
l=t.cache}catch(e){}},c._rs_supported=function(){return a=Object.prototype.hasOwnProperty.call(s.globalContext,"XMLHttpRequest")},c._rs_cleanup=function(){u&&delete localStorage["remotestorage:discover"]},e.exports=c},function(e,t,r){"use strict"
const n=(this&&this.__importDefault||function(e){return e&&e.__esModule?e:{default:e}})(r(2))
class i{constructor(){this.addEvents(["background","foreground"]),this.mode="undefined"!=typeof window?"browser":"node","browser"===this.mode&&(this.setBrowserPrefixedNames(),document.addEventListener(this.visibilityChangeEvent,this.setVisibility.bind(this),!1),this.setVisibility())}setBrowserPrefixedNames(){"browser"===this.mode&&(void 0!==document.hidden?(this.hiddenProperty="hidden",this.visibilityChangeEvent="visibilitychange"):void 0!==document.mozHidden?(this.hiddenProperty="mozHidden",this.visibilityChangeEvent="mozvisibilitychange"):void 0!==document.msHidden?(this.hiddenProperty="msHidden",this.visibilityChangeEvent="msvisibilitychange"):void 0!==document.webkitHidden&&(this.hiddenProperty="webkitHidden",this.visibilityChangeEvent="webkitvisibilitychange"))}setVisibility(){document[this.hiddenProperty]?this.goBackground():this.goForeground()}isBrowser(){return"browser"===this.mode}isNode(){return"node"===this.mode}goBackground(){this._emit("background")}goForeground(){this._emit("foreground")}static _rs_init(){}static _rs_cleanup(){}}r(0).applyMixins(i,[n.default]),e.exports=i},function(e,t,r){e.exports=r(18)},function(e,t,r){"use strict"
...
const a=s(r(3)),u=s(r(1)),l=r(0),c=s(r(11)),p=s(r(6)),h=s(r(7)),f=s(r(12)),d=s(r(2)),m=s(r(13)),v=s(r(14)),g=s(r(15)),y=s(r(9)),b=s(r(4)),_=s(r(29)),w=o(r(0)),E=l.getGlobalContext()
let x
function C(e){return"number"==typeof e&&e>=2e3&&e<=36e5}class T{constructor(e){this._pending=[],this._cleanups=[],this._pathHandlers={change:{}},this.apiKeys={},this._init=_.default.loadFeatures,this.features=_.default.features,this.loadFeature=_.default.loadFeature,this.featureSupported=_.default.featureSupported,this.featureDone=_.default.featureDone,this.featuresDone=_.default.featuresDone,this.featuresLoaded=_.default.featuresLoaded,this.featureInitialized=_.default.featureInitialized,this.featureFailed=_.default.featureFailed,this.hasFeature=_.default.hasFeature,this._setCachingModule=_.default._setCachingModule,this._collectCleanupFunctions=_.default._collectCleanupFunctions,this._fireReady=_.default._fireReady,this.initFeature=_.default.initFeature,"object"==typeof e&&l.extend(a.default,e),this.addEvents(["ready","authing","connecting","connected","disconnected","not-connected","conflict","error","features-loaded","sync-interval-change","sync-req-done","sync-done","wire-busy","wire-done","network-offline","network-online"]),this._setGPD({get:this._pendingGPD("get"),put:this._pendingGPD("put"),delete:this._pendingGPD("delete")}),(x=l.localStorageAvailable())&&(this.apiKeys=l.getJSONFromLocalStorage("remotestorage:api-keys")||{},this.setBackend(localStorage.getItem("remotestorage:backend")||"remotestorage"))
const t=this.on
...
break
case"not-connected":this.remote&&!this.remote.connected&&setTimeout(r,0)}return t.call(this,e,r)},this._init(),this.fireInitial=function(){this.local&&setTimeout(this.local.fireInitial.bind(this.local),0)}.bind(this),this.on("ready",this.fireInitial.bind(this)),this.loadModules()}get connected(){return this.remote.connected}loadModules(){a.default.modules.forEach(this.addModule.bind(this))}authorize(e){if(this.access.setStorageType(this.remote.storageApi),void 0===e.scope&&(e.scope=this.access.scopeParameter),E.cordova)e.redirectUri=a.default.cordovaRedirectUri
else{const t=p.default.getLocation()
let r=t.origin
"/"!==t.pathname&&(r+=t.pathname),e.redirectUri=r}void 0===e.clientId&&(e.clientId=e.redirectUri.match(/^(https?:\/\/[^/]+)/)[0]),p.default.authorize(this,e)}impliedauth(e,t){e=e||this.remote.storageApi,t=t||String(document.location),u.default("ImpliedAuth proceeding due to absent authURL; storageApi = "+e+" redirectUri = "+t),this.remote.configure({token:p.default.IMPLIED_FAKE_TOKEN}),document.location.href=t}connect(e,t){if(this.setBackend("remotestorage"),e.indexOf("@")<0&&!e.match(/^(https?:\/\/)?[^\s\/$\.?#]+\.[^\s]*$/))return void this._emit("error",new T.DiscoveryError("Not a valid user address or URL."))
if(e.indexOf("@")<0&&!e.match(/^https?:\/\//)&&(e=`https://${e}`),E.cordova){if("string"!=typeof a.default.cordovaRedirectUri)return void this._emit("error",new T.DiscoveryError("Please supply a custom HTTPS redirect URI for your Cordova app"))
if(!E.cordova.InAppBrowser)return void this._emit("error",new T.DiscoveryError("Please include the InAppBrowser Cordova plugin to enable OAuth"))}this.remote.configure({userAddress:e}),this._emit("connecting")
const r=setTimeout(()=>{this._emit("error",new T.DiscoveryError("No storage information found for this user address."))},a.default.discoveryTimeout)
g.default(e).then(n=>{if(clearTimeout(r),this._emit("authing"),n.userAddress=e,this.remote.configure(n),!this.remote.connected)if(n.authURL)if(void 0===t)this.authorize({authURL:n.authURL})
else{if("string"!=typeof t)throw new Error("Supplied bearer token must be a string")
u.default("Skipping authorization sequence and connecting with known token"),this.remote.configure({token:t})}else this.impliedauth()},()=>{clearTimeout(r),this._emit("error",new T.DiscoveryError("No storage information found for this user address."))})}reconnect(){this.remote.configure({token:null}),"remotestorage"===this.backend?this.connect(this.remote.userAddress):this.remote.connect()}disconnect(){this.remote&&this.remote.configure({userAddress:null,href:null,storageApi:null,token:null,properties:null}),this._setGPD({get:this._pendingGPD("get"),put:this._pendingGPD("put"),delete:this._pendingGPD("delete")})
const e=this._cleanups.length
let t=0
const r=()=>{++t>=e&&(this._init(),this._emit("disconnected"))}
e>0?this._cleanups.forEach(e=>{const t=e(this)
"object"==typeof t&&"function"==typeof t.then?t.then(r):r()}):r()}setBackend(e){this.backend=e,x&&(e?localStorage.setItem("remotestorage:backend",e):localStorage.removeItem("remotestorage:backend"))}onChange(e,t){this._pathHandlers.change[e]||(this._pathHandlers.change[e]=[]),this._pathHandlers.change[e].push(t)}enableLog(){a.default.logging=!0}disableLog(){a.default.logging=!1}log(...e){u.default.apply(T,e)}setApiKeys(e){const t=[A.GOOGLE,A.DROPBOX]
...
if(r){switch(t){case A.DROPBOX:this.apiKeys[A.DROPBOX]={appKey:r},void 0!==this.dropbox&&this.dropbox.clientId===r||v.default._rs_init(this)
break
case A.GOOGLE:this.apiKeys[A.GOOGLE]={clientId:r},void 0!==this.googledrive&&this.googledrive.clientId===r||m.default._rs_init(this)}return!0}delete this.apiKeys[t]}),x&&localStorage.setItem("remotestorage:api-keys",JSON.stringify(this.apiKeys))}setCordovaRedirectUri(e){if("string"!=typeof e||!e.match(/http(s)?:\/\//))throw new Error("Cordova redirect URI must be a URI string")
a.default.cordovaRedirectUri=e}_setGPD(e,t){function r(e){return function(...r){return e.apply(t,r).then(function(e){return 403!==e.statusCode&&401!==e.statusCode||this._emit("error",new b.default),Promise.resolve(e)}.bind(this))}}this.get=r(e.get),this.put=r(e.put),this.delete=r(e.delete)}_pendingGPD(e){return(...t)=>{const r=Array.prototype.slice.call(t)
...
return this.access.checkPathPermission(e,"r")||console.warn("WARNING: Please use remoteStorage.access.claim() to ask for access permissions first: https://remotestoragejs.readthedocs.io/en/latest/js-api/access.html#claim"),new h.default(this,e)}getSyncInterval(){return a.default.syncInterval}setSyncInterval(e){if(!C(e))throw e+" is not a valid sync interval"
const t=a.default.syncInterval
a.default.syncInterval=e,this._emit("sync-interval-change",{oldValue:t,newValue:e})}getBackgroundSyncInterval(){return a.default.backgroundSyncInterval}setBackgroundSyncInterval(e){if(!C(e))throw e+" is not a valid sync interval"
...
throw"Unknown module: "+e}}var A
T.Authorize=p.default,T.SyncError=y.default,T.Unauthorized=b.default,T.DiscoveryError=g.default.DiscoveryError,T.util=w,Object.defineProperty(T.prototype,"access",{get:function(){const e=new c.default
return Object.defineProperty(this,"access",{value:e}),e},configurable:!0}),Object.defineProperty(T.prototype,"caching",{configurable:!0,get:function(){const e=new f.default
return Object.defineProperty(this,"caching",{value:e}),e}}),l.applyMixins(T,[d.default]),function(e){e.GOOGLE="googledrive",e.DROPBOX="dropbox"}(A||(A={})),e.exports=T},function(e,t,r){"use strict";(function(e){var n=r(20),i=r(21),o=r(22)
...
throw new TypeError("val must be string, number or Buffer")}function g(e,t,r,n,i){var o,s=1,a=e.length,u=t.length
...
break}if(p)return o}return-1}function y(e,t,r,n){r=Number(r)||0
var i=e.length-r
...
if(isNaN(a))return s
e[r+s]=a}return s}function b(e,t,r,n){return U(F(t,e.length-r),e,r,n)}function _(e,t,r,n){return U(function(e){for(var t=[],r=0;r<e.length;++r)t.push(255&e.charCodeAt(r))
return t}(t),e,r,n)}function w(e,t,r,n){return _(e,t,r,n)}function E(e,t,r,n){return U(B(t),e,r,n)}function x(e,t,r,n){return U(function(e,t){for(var r,n,i,o=[],s=0;s<e.length&&!((t-=2)<0);++s)n=(r=e.charCodeAt(s))>>8,i=r%256,o.push(i),o.push(n)
...
return r}(n)}function A(e,t,r){var n=""
r=Math.min(e.length,r)
for(var i=t;i<r;++i)n+=String.fromCharCode(127&e[i])
return n}function R(e,t,r){var n=""
r=Math.min(e.length,r)
for(var i=t;i<r;++i)n+=String.fromCharCode(e[i])
return n}function k(e,t,r){var n=e.length;(!t||t<0)&&(t=0),(!r||r<0||r>n)&&(r=n)
for(var i="",o=t;o<r;++o)i+=z(e[o])
return i}function O(e,t,r){for(var n=e.slice(t,r),i="",o=0;o<n.length;o+=2)i+=String.fromCharCode(n[o]+256*n[o+1])
return i}function S(e,t,r){if(e%1!=0||e<0)throw new RangeError("offset is not uint")
if(e+t>r)throw new RangeError("Trying to access beyond buffer length")}function P(e,t,r,n,i,o){if(!u.isBuffer(e))throw new TypeError('"buffer" argument must be a Buffer instance')
...
for(var i=0,o=Math.min(e.length-r,4);i<o;++i)e[r+i]=t>>>8*(n?i:3-i)&255}function j(e,t,r,n,i,o){if(r+n>e.length)throw new RangeError("Index out of range")
if(r<0)throw new RangeError("Index out of range")}function I(e,t,r,n,o){return o||j(e,0,r,4),i.write(e,t,r,n,23,4),r+4}function L(e,t,r,n,o){return o||j(e,0,r,8),i.write(e,t,r,n,52,8),r+8}t.Buffer=u,t.SlowBuffer=function(e){return+e!=e&&(e=0),u.alloc(+e)},t.INSPECT_MAX_BYTES=50,u.TYPED_ARRAY_SUPPORT=void 0!==e.TYPED_ARRAY_SUPPORT?e.TYPED_ARRAY_SUPPORT:function(){try{var e=new Uint8Array(1)
...
if((r>>>=0)<=(t>>>=0))return""
for(e||(e="utf8");;)switch(e){case"hex":return k(this,t,r)
...
r=new u(i,void 0)
for(var o=0;o<i;++o)r[o]=this[o+e]}return r},u.prototype.readUIntLE=function(e,t,r){e|=0,t|=0,r||S(e,t,this.length)
for(var n=this[e],i=1,o=0;++o<t&&(i*=256);)n+=this[e+o]*i
return n},u.prototype.readUIntBE=function(e,t,r){e|=0,t|=0,r||S(e,t,this.length)
for(var n=this[e+--t],i=1;t>0&&(i*=256);)n+=this[e+--t]*i
return n},u.prototype.readUInt8=function(e,t){return t||S(e,1,this.length),this[e]},u.prototype.readUInt16LE=function(e,t){return t||S(e,2,this.length),this[e]|this[e+1]<<8},u.prototype.readUInt16BE=function(e,t){return t||S(e,2,this.length),this[e]<<8|this[e+1]},u.prototype.readUInt32LE=function(e,t){return t||S(e,4,this.length),(this[e]|this[e+1]<<8|this[e+2]<<16)+16777216*this[e+3]},u.prototype.readUInt32BE=function(e,t){return t||S(e,4,this.length),16777216*this[e]+(this[e+1]<<16|this[e+2]<<8|this[e+3])},u.prototype.readIntLE=function(e,t,r){e|=0,t|=0,r||S(e,t,this.length)
for(var n=this[e],i=1,o=0;++o<t&&(i*=256);)n+=this[e+o]*i
return n>=(i*=128)&&(n-=Math.pow(2,8*t)),n},u.prototype.readIntBE=function(e,t,r){e|=0,t|=0,r||S(e,t,this.length)
for(var n=t,i=1,o=this[e+--n];n>0&&(i*=256);)o+=this[e+--n]*i
return o>=(i*=128)&&(o-=Math.pow(2,8*t)),o},u.prototype.readInt8=function(e,t){return t||S(e,1,this.length),128&this[e]?-1*(255-this[e]+1):this[e]},u.prototype.readInt16LE=function(e,t){t||S(e,2,this.length)
var r=this[e]|this[e+1]<<8
return 32768&r?4294901760|r:r},u.prototype.readInt16BE=function(e,t){t||S(e,2,this.length)
var r=this[e+1]|this[e]<<8
return 32768&r?4294901760|r:r},u.prototype.readInt32LE=function(e,t){return t||S(e,4,this.length),this[e]|this[e+1]<<8|this[e+2]<<16|this[e+3]<<24},u.prototype.readInt32BE=function(e,t){return t||S(e,4,this.length),this[e]<<24|this[e+1]<<16|this[e+2]<<8|this[e+3]},u.prototype.readFloatLE=function(e,t){return t||S(e,4,this.length),i.read(this,e,!0,23,4)},u.prototype.readFloatBE=function(e,t){return t||S(e,4,this.length),i.read(this,e,!1,23,4)},u.prototype.readDoubleLE=function(e,t){return t||S(e,8,this.length),i.read(this,e,!0,52,8)},u.prototype.readDoubleBE=function(e,t){return t||S(e,8,this.length),i.read(this,e,!1,52,8)},u.prototype.writeUIntLE=function(e,t,r,n){e=+e,t|=0,r|=0,n||P(this,e,t,r,Math.pow(2,8*r)-1,0)
var i=1,o=0
for(this[t]=255&e;++o<r&&(i*=256);)this[t+o]=e/i&255
return t+r},u.prototype.writeUIntBE=function(e,t,r,n){e=+e,t|=0,r|=0,n||P(this,e,t,r,Math.pow(2,8*r)-1,0)
var i=r-1,o=1
for(this[t+i]=255&e;--i>=0&&(o*=256);)this[t+i]=e/o&255
return t+r},u.prototype.writeUInt8=function(e,t,r){return e=+e,t|=0,r||P(this,e,t,1,255,0),u.TYPED_ARRAY_SUPPORT||(e=Math.floor(e)),this[t]=255&e,t+1},u.prototype.writeUInt16LE=function(e,t,r){return e=+e,t|=0,r||P(this,e,t,2,65535,0),u.TYPED_ARRAY_SUPPORT?(this[t]=255&e,this[t+1]=e>>>8):N(this,e,t,!0),t+2},u.prototype.writeUInt16BE=function(e,t,r){return e=+e,t|=0,r||P(this,e,t,2,65535,0),u.TYPED_ARRAY_SUPPORT?(this[t]=e>>>8,this[t+1]=255&e):N(this,e,t,!1),t+2},u.prototype.writeUInt32LE=function(e,t,r){return e=+e,t|=0,r||P(this,e,t,4,4294967295,0),u.TYPED_ARRAY_SUPPORT?(this[t+3]=e>>>24,this[t+2]=e>>>16,this[t+1]=e>>>8,this[t]=255&e):M(this,e,t,!0),t+4},u.prototype.writeUInt32BE=function(e,t,r){return e=+e,t|=0,r||P(this,e,t,4,4294967295,0),u.TYPED_ARRAY_SUPPORT?(this[t]=e>>>24,this[t+1]=e>>>16,this[t+2]=e>>>8,this[t+3]=255&e):M(this,e,t,!1),t+4},u.prototype.writeIntLE=function(e,t,r,n){if(e=+e,t|=0,!n){var i=Math.pow(2,8*r-1)
P(this,e,t,r,i-1,-i)}var o=0,s=1,a=0
...
P(this,e,t,r,i-1,-i)}var o=r-1,s=1,a=0
...
var D=/[^+\/0-9A-Za-z-_]/g
function z(e){return e<16?"0"+e.toString(16):e.toString(16)}function F(e,t){var r
t=t||1/0
...
if((t-=4)<0)break
o.push(r>>18|240,r>>12&63|128,r>>6&63|128,63&r|128)}}return o}function B(e){return n.toByteArray(function(e){if((e=function(e){return e.trim?e.trim():e.replace(/^\s+|\s+$/g,"")}(e).replace(D,"")).length<2)return""
for(;e.length%4!=0;)e+="="
return e}(e))}function U(e,t,r,n){for(var i=0;i<n&&!(i+r>=t.length||i>=e.length);++i)t[i+r]=e[i]
return i}}).call(this,r(5))},function(e,t,r){"use strict"
t.byteLength=function(e){var t=l(e),r=t[0],n=t[1]
return 3*(r+n)/4-n},t.toByteArray=function(e){var t,r,n=l(e),s=n[0],a=n[1],u=new o(3*(s+a)/4-a),c=0,p=a>0?s-4:s
for(r=0;r<p;r+=4)t=i[e.charCodeAt(r)]<<18|i[e.charCodeAt(r+1)]<<12|i[e.charCodeAt(r+2)]<<6|i[e.charCodeAt(r+3)],u[c++]=t>>16&255,u[c++]=t>>8&255,u[c++]=255&t
return 2===a&&(t=i[e.charCodeAt(r)]<<2|i[e.charCodeAt(r+1)]>>4,u[c++]=255&t),1===a&&(t=i[e.charCodeAt(r)]<<10|i[e.charCodeAt(r+1)]<<4|i[e.charCodeAt(r+2)]>>2,u[c++]=t>>8&255,u[c++]=255&t),u},t.fromByteArray=function(e){for(var t,r=e.length,i=r%3,o=[],s=0,a=r-i;s<a;s+=16383)o.push(c(e,s,s+16383>a?a:s+16383))
...
i.push(p.substitution),n.push(p.prefix),r.push(c),o=o.concat(p.substitution.varNames)}this.fill=function(e){for(var t=r[0],n=0;n<i.length;n++)t+=(0,i[n])(e),t+=r[n+1]
...
return this},l.prototype.banUnknownProperties=function(e,t){for(var r in this.unknownPropertyPaths){var n=this.createError(y.UNKNOWN_PROPERTY,{path:r},r,"",null,e,t),i=this.handleError(n)
...
this.scannedFrozen=[],this.scannedFrozenSchemas=[]}if(f||h!==this.errors.length)for(;r&&r.length||n&&n.length;){var d=r&&r.length?""+r.pop():null,m=n&&n.length?""+n.pop():null
...
if("string"==typeof s||"number"==typeof s)return this.createError(y.KEYWORD_CUSTOM,{key:n,message:s},"","",null,e,t).prefixWith(null,n)
...
if(o===r||"integer"===o&&"number"===r&&e%1==0)return null}return this.createError(y.INVALID_TYPE,{type:r,expected:n.join("/")},"","",null,e,t)},l.prototype.validateEnum=function(e,t){if(void 0===t.enum)return null
for(var r=0;r<t.enum.length;r++)if(c(e,t.enum[r]))return null
return this.createError(y.ENUM_MISMATCH,{value:"undefined"!=typeof JSON?JSON.stringify(e):e},"","",null,e,t)},l.prototype.validateNumeric=function(e,t,r){return this.validateMultipleOf(e,t,r)||this.validateMinMax(e,t,r)||this.validateNaN(e,t,r)||null}
...
else for(var n in"string"==typeof e.$ref&&(e.$ref=d(t,e.$ref)),e)"enum"!==n&&v(e[n],t)}function g(e){var t=x[e=e||"en"]
...
if(n>=p&&n<h)return this.createError(y.NUMBER_MULTIPLE_OF,{value:e,multipleOf:r},"","",null,e,t)}return null},l.prototype.validateMinMax=function(e,t){if("number"!=typeof e)return null
...
if(t.exclusiveMaximum&&e===t.maximum)return this.createError(y.NUMBER_MAXIMUM_EXCLUSIVE,{value:e,maximum:t.maximum},"","/exclusiveMaximum",null,e,t)}return null},l.prototype.validateNaN=function(e,t){return"number"!=typeof e?null:!0===isNaN(e)||e===1/0||e===-1/0?this.createError(y.NUMBER_NOT_A_NUMBER,{value:e},"","/type",null,e,t):null},l.prototype.validateString=function(e,t,r){return this.validateStringLength(e,t,r)||this.validateStringPattern(e,t,r)||null},l.prototype.validateStringLength=function(e,t){return"string"!=typeof e?null:void 0!==t.minLength&&e.length<t.minLength?this.createError(y.STRING_LENGTH_SHORT,{length:e.length,minimum:t.minLength},"","/minLength",null,e,t):void 0!==t.maxLength&&e.length>t.maxLength?this.createError(y.STRING_LENGTH_LONG,{length:e.length,maximum:t.maxLength},"","/maxLength",null,e,t):null},l.prototype.validateStringPattern=function(e,t){if("string"!=typeof e||"string"!=typeof t.pattern&&!(t.pattern instanceof RegExp))return null
var r
if(t.pattern instanceof RegExp)r=t.pattern
else{var n,i="",o=t.pattern.match(/^\/(.+)\/([img]*)$/)
o?(n=o[1],i=o[2]):n=t.pattern,r=new RegExp(n,i)}return r.test(e)?null:this.createError(y.STRING_PATTERN,{pattern:t.pattern},"","/pattern",null,e,t)},l.prototype.validateArray=function(e,t,r){return Array.isArray(e)&&(this.validateArrayLength(e,t,r)||this.validateArrayUniqueItems(e,t,r)||this.validateArrayItems(e,t,r))||null},l.prototype.validateArrayLength=function(e,t){var r
return void 0!==t.minItems&&e.length<t.minItems&&(r=this.createError(y.ARRAY_LENGTH_SHORT,{length:e.length,minimum:t.minItems},"","/minItems",null,e,t),this.handleError(r))?r:void 0!==t.maxItems&&e.length>t.maxItems&&(r=this.createError(y.ARRAY_LENGTH_LONG,{length:e.length,maximum:t.maxItems},"","/maxItems",null,e,t),this.handleError(r))?r:null},l.prototype.validateArrayUniqueItems=function(e,t){if(t.uniqueItems)for(var r=0;r<e.length;r++)for(var n=r+1;n<e.length;n++)if(c(e[r],e[n])){var i=this.createError(y.ARRAY_UNIQUE,{match1:r,match2:n},"","/uniqueItems",null,e,t)
if(this.handleError(i))return i}return null},l.prototype.validateArrayItems=function(e,t,r){if(void 0===t.items)return null
var n,i
if(Array.isArray(t.items)){for(i=0;i<e.length;i++)if(i<t.items.length){if(n=this.validateAll(e[i],t.items[i],[i],["items",i],r+"/"+i))return n}else if(void 0!==t.additionalItems)if("boolean"==typeof t.additionalItems){if(!t.additionalItems&&(n=this.createError(y.ARRAY_ADDITIONAL_ITEMS,{},"/"+i,"/additionalItems",null,e,t),this.handleError(n)))return n}else if(n=this.validateAll(e[i],t.additionalItems,[i],["additionalItems"],r+"/"+i))return n}else for(i=0;i<e.length;i++)if(n=this.validateAll(e[i],t.items,[i],["items"],r+"/"+i))return n
...
return void 0!==t.minProperties&&n.length<t.minProperties&&(r=this.createError(y.OBJECT_PROPERTIES_MINIMUM,{propertyCount:n.length,minimum:t.minProperties},"","/minProperties",null,e,t),this.handleError(r))?r:void 0!==t.maxProperties&&n.length>t.maxProperties&&(r=this.createError(y.OBJECT_PROPERTIES_MAXIMUM,{propertyCount:n.length,maximum:t.maxProperties},"","/maxProperties",null,e,t),this.handleError(r))?r:null},l.prototype.validateObjectRequiredProperties=function(e,t){if(void 0!==t.required)for(var r=0;r<t.required.length;r++){var n=t.required[r]
if(void 0===e[n]){var i=this.createError(y.OBJECT_REQUIRED,{key:n},"","/required/"+r,null,e,t)
...
a=!1
continue}return null}p&&o.push(p.prefixWith(null,""+u).prefixWith(null,"anyOf"))}return this.trackUnknownProperties&&(this.unknownPropertyPaths=n,this.knownPropertyPaths=i),a?(o=o.concat(this.errors.slice(s)),this.errors=this.errors.slice(0,s),this.createError(y.ANY_OF_MISSING,{},"","/anyOf",o,e,t)):void 0},l.prototype.validateOneOf=function(e,t,r){if(void 0===t.oneOf)return null
...
if(null===p&&c===this.errors.length){if(null!==o)return this.errors=this.errors.slice(0,a),this.createError(y.ONE_OF_MULTIPLE,{index1:o,index2:u},"","/oneOf",null,e,t)
if(o=u,this.trackUnknownProperties){for(var h in this.knownPropertyPaths)i[h]=!0,delete n[h]
for(var f in this.unknownPropertyPaths)i[f]||(n[f]=!0)}}else p&&s.push(p)}return this.trackUnknownProperties&&(this.unknownPropertyPaths=n,this.knownPropertyPaths=i),null===o?(s=s.concat(this.errors.slice(a)),this.errors=this.errors.slice(0,a),this.createError(y.ONE_OF_MISSING,{},"","/oneOf",s,e,t)):(this.errors=this.errors.slice(0,a),null)},l.prototype.validateNot=function(e,t,r){if(void 0===t.not)return null
...
return this.errors=this.errors.slice(0,o),this.trackUnknownProperties&&(this.unknownPropertyPaths=n,this.knownPropertyPaths=i),null===s&&0===a.length?this.createError(y.NOT_PASSED,{},"","/not",null,e,t):null},l.prototype.validateHypermedia=function(e,t,r){if(!t.links)return null
...
for(r in y)t[r]&&!t[y[r]]&&(t[y[r]]=t[r])
var n=e.split("-")[0]
if(x[n])for(r in x[e]=Object.create(x[n]),t)void 0===x[n][r]&&(x[n][r]=t[r]),x[e][r]=t[r]
else x[e]=t,x[n]=t
return this},freshApi:function(t){var r=e()
return t&&r.language(t),r},validate:function(e,t,o,s){var a=g(r),u=new l(i,!1,n?function(e,t,r){return n(e,t,r)||a(e,t,r)}:a,o,s)
...
return this.validate.apply(e,arguments),e},validateMultiple:function(e,t,o,s){var a=g(r),u=new l(i,!0,n?function(e,t,r){return n(e,t,r)||a(e,t,r)}:a,o,s)
...
for(var n in y[e]=t,b[t]=e,w[e]=w[t]=r,x){var i=x[n]
...
return C.addLanguage("en-gb",w),C.tv4=C,C})?n.apply(t,[]):n)||(e.exports=i)},function(e,t,r){"use strict"
...
if(n.extends){const t=n.extends.split("/"),r=1===t.length?e+"/"+t.shift():t.join("/"),o=this.uris[r]
if(!o)throw"Type '"+i+"' tries to extend unknown schema '"+r+"'"
n.extends=this.schemas[o]}this.uris[i]=r,this.aliases[r]=i,this.schemas[r]=n}resolveAlias(e){return this.uris[e]}getSchema(e){return this.schemas[e]}inScope(e){const t=e.length,r={}
...
e.exports=class extends Error{constructor(e){super()
const t=new Error("Schema not found: "+e)
return t.name="SchemaNotFound",t}}},function(e,t,r){"use strict"
...
return void 0===t&&(t=this.defaultValue,this._storage[e]=t),t}set(e,t){return e=e.toLowerCase(),this._storage[e]===t?t:(this._storage[e]=t,t||delete this._itemsRev[e],this._updateParentFolderItemRev(e,t),this._canPropagate&&this._propagate(e),t)}delete(e){return this.set(e,null)}deactivatePropagation(){return this._canPropagate=!1,!0}activatePropagation(){return!!this._canPropagate||(this._generateFolderRev("/"),this._canPropagate=!0,!0)}_hashCode(e){let t=0
...
var n=this&&this.__importDefault||function(e){return e&&e.__esModule?e:{default:e}}
const i=n(r(3)),o=n(r(16)),s=n(r(1)),a=r(0),u=n(r(30)),l=n(r(11)),c=n(r(6)),p=n(r(15)),h=n(r(7)),f=n(r(13)),d=n(r(14)),m=n(r(8)),v=n(r(31)),g=n(r(12)),y=n(r(32)),b=n(r(33)),_=n(r(34)),w={features:[],featuresDone:0,readyFired:!1,loadFeatures(){this.features=[],this.featuresDone=0,this.readyFired=!1,this.featureModules={WireClient:m.default,Dropbox:d.default,GoogleDrive:f.default,Access:l.default,Discover:p.default,Authorize:c.default,BaseClient:h.default,Env:o.default},i.default.cache&&a.extend(this.featureModules,{Caching:g.default,IndexedDB:y.default,LocalStorage:b.default,InMemoryStorage:_.default,Sync:v.default}),i.default.disableFeatures.forEach(e=>{this.featureModules[e]&&delete this.featureModules[e]}),this._allLoaded=!1
...
s.default(`[RemoteStorage] [FEATURE ${e}] initializing ...`),"object"==typeof r?r.then(()=>{this.featureSupported(e,!0),this.initFeature(e)},()=>{this.featureSupported(e,!1)}):"boolean"==typeof r?(this.featureSupported(e,r),r&&this.initFeature(e)):this.featureSupported(e,!1)},initFeature(e){const t=this.featureModules[e]
let r
...
var n=this&&this.__awaiter||function(e,t,r,n){return new(r||(r=Promise))(function(i,o){function s(e){try{u(n.next(e))}catch(e){o(e)}}function a(e){try{u(n.throw(e))}catch(e){o(e)}}function u(e){var t
e.done?i(e.value):(t=e.value,t instanceof r?t:new r(function(e){e(t)})).then(s,a)}u((n=n.apply(e,t||[])).next())})}
const i=(this&&this.__importDefault||function(e){return e&&e.__esModule?e:{default:e}})(r(1))
const o={get:function(e,t){if(this.local){if(void 0===t)t="object"==typeof(r=this).remote&&r.remote.connected&&r.remote.online?2*r.getSyncInterval():(i.default("Not setting default maxAge, because remote is offline or not connected"),!1)
...
var r},put:function(e,t,r){return function(e){return"dropbox"===this.backend&&!!e.match(/^\/public\/.*[^\/]$/)}.bind(this)(e)?o._wrapBusyDone.call(this,this.remote.put(e,t,r)):this.local?this.local.put(e,t,r):o._wrapBusyDone.call(this,this.remote.put(e,t,r))},delete:function(e){return this.local?this.local.delete(e):o._wrapBusyDone.call(this,this.remote.delete(e))},_wrapBusyDone:function(e){return n(this,void 0,void 0,function*(){return this._emit("wire-busy"),e.then(e=>(this._emit("wire-done",{success:!0}),Promise.resolve(e)),e=>(this._emit("wire-done",{success:!1}),Promise.reject(e)))})}}
e.exports=o},function(e,t,r){"use strict"
var n=this&&this.__awaiter||function(e,t,r,n){return new(r||(r=Promise))(function(i,o){function s(e){try{u(n.next(e))}catch(e){o(e)}}function a(e){try{u(n.throw(e))}catch(e){o(e)}}function u(e){var t
e.done?i(e.value):(t=e.value,t instanceof r?t:new r(function(e){e(t)})).then(s,a)}u((n=n.apply(e,t||[])).next())})},i=this&&this.__importDefault||function(e){return e&&e.__esModule?e:{default:e}}
const o=i(r(3)),s=i(r(16)),a=i(r(2)),u=i(r(1)),l=i(r(6)),c=i(r(9)),p=i(r(4)),h=r(0)
let f,d
function m(e,t,r){return{action:e,path:t,promise:r}}function v(e,t){return e.common.revision!==t&&(!e.remote||e.remote.revision!==t)}function g(e){return e.common&&e.common.revision}class y{constructor(e){this.rs=e,this._tasks={},this._running={},this._timeStarted={},this.numThreads=10,this.rs.local.onDiff(e=>{this.addTask(e),this.doTasks()}),this.rs.caching.onActivate(e=>{this.addTask(e),this.doTasks()}),this.addEvents(["done","req-done"])}now(){return(new Date).getTime()}queueGetRequest(e){return new Promise((t,r)=>{this.rs.remote.connected?this.rs.remote.online?(this.addTask(e,function(){this.rs.local.get(e).then(e=>t(e))}.bind(this)),this.doTasks()):r("cannot fulfill maxAge requirement - remote is not online"):r("cannot fulfill maxAge requirement - remote is not connected")})}corruptServerItemsMap(e,t){if("object"!=typeof e||Array.isArray(e))return!0
...
return this.rs.local.forAllNodes(t=>{e>100||(this.isCorrupt(t)?(u.default("[Sync] WARNING: corrupt node in local cache",t),"object"==typeof t&&t.path&&(this.addTask(t.path),e++)):this.needsFetch(t)&&this.rs.access.checkPathPermission(t.path,"r")?(this.addTask(t.path),e++):h.isDocument(t.path)&&this.needsPush(t)&&this.rs.access.checkPathPermission(t.path,"rw")&&(this.addTask(t.path),e++))}).then(()=>e).catch(e=>{throw e})})}inConflict(e){return e.local&&e.remote&&(void 0!==e.remote.body||e.remote.itemsMap)}needsRefresh(e){return!!e.common&&(!e.common.timestamp||this.now()-e.common.timestamp>o.default.syncInterval)}needsFetch(e){return!!this.inConflict(e)||!(!e.common||void 0!==e.common.itemsMap||void 0!==e.common.body)||!(!e.remote||void 0!==e.remote.itemsMap||void 0!==e.remote.body)}needsPush(e){return!this.inConflict(e)&&(!(!e.local||e.push)||void 0)}needsRemotePut(e){return e.local&&e.local.body}needsRemoteDelete(e){return e.local&&!1===e.local.body}getParentPath(e){const t=e.match(/^(.*\/)([^\/]+\/?)$/)
if(t)return t[1]
...
return void 0===r?m("get",e,this.rs.remote.get(e)):function(e){return e.remote&&e.remote.revision&&!e.remote.itemsMap&&!e.remote.body}(r)?m("get",e,this.rs.remote.get(e)):this.needsRemotePut(r)?(r.push=h.deepClone(r.local),r.push.timestamp=this.now(),this.rs.local.setNodes(this.flush(t)).then(()=>{let t
return t=g(r)?{ifMatch:r.common.revision}:{ifNoneMatch:"*"},m("put",e,this.rs.remote.put(e,r.push.body,r.push.contentType,t))})):this.needsRemoteDelete(r)?(r.push={body:!1,timestamp:this.now()},this.rs.local.setNodes(this.flush(t)).then(()=>g(r)?m("delete",e,this.rs.remote.delete(e,{ifMatch:r.common.revision})):m("get",e,this.rs.remote.get(e)))):g(r)?m("get",e,this.rs.remote.get(e,{ifNoneMatch:r.common.revision})):m("get",e,this.rs.remote.get(e))})}autoMergeFolder(e){if(e.remote.itemsMap&&(e.common=e.remote,delete e.remote,e.common.itemsMap)){for(const t in e.common.itemsMap)e.local.itemsMap[t]||(e.local.itemsMap[t]=!1)
...
e.common=e.remote,delete e.remote}return e}e.common.body&&this.rs.local._emitChange({origin:"remote",path:e.path,oldValue:e.common.body,newValue:void 0,oldContentType:e.common.contentType,newContentType:void 0})}updateCommonTimestamp(e,t){return n(this,void 0,void 0,function*(){return this.rs.local.getNodes([e]).then(r=>(r[e]&&r[e].common&&r[e].common.revision===t&&(r[e].common.timestamp=this.now()),this.rs.local.setNodes(this.flush(r))))})}markChildren(e,t,r,i){return n(this,void 0,void 0,function*(){const n=[],o={},s={}
for(const r in t)n.push(e+r),o[e+r]=t[r]
for(const t in i)n.push(e+t)
return this.rs.local.getNodes(n).then(t=>{let n,a
for(const u in t)if(a=t[u],o[u])a&&a.common?v(a,o[u].ETag)&&(r[u]=h.deepClone(a),r[u].remote={revision:o[u].ETag,timestamp:this.now()},r[u]=this.autoMerge(r[u])):"ALL"===(n=this.rs.caching.checkPath(u))&&(r[u]={path:u,common:{timestamp:this.now()},remote:{revision:o[u].ETag,timestamp:this.now()}}),r[u]&&o[u]["Content-Type"]&&(r[u].remote.contentType=o[u]["Content-Type"]),r[u]&&o[u]["Content-Length"]&&(r[u].remote.contentLength=o[u]["Content-Length"])
else if(i[u.substring(e.length)]&&a&&a.common){if(a.common.itemsMap)for(const e in a.common.itemsMap)s[u+e]=!0
...
r&&(h.isFolder(i)?(n(r.common,i),n(r.local,i)):r.common&&void 0!==typeof r.common.body&&(t[i]=h.deepClone(r),t[i].remote={body:!1,timestamp:this.now()},t[i]=this.autoMerge(t[i])))}return this.deleteRemoteTrees(Object.keys(r),t).then(e=>this.rs.local.setNodes(this.flush(e)))}))})}completeFetch(e,t,r,i){return n(this,void 0,void 0,function*(){let n,o
const s=h.pathsFromRoot(e)
return h.isFolder(e)?n=[e]:(o=s[1],n=[e,o]),this.rs.local.getNodes(n).then(n=>{let s,a,u=n[e]
const l={}
function c(e){if(e&&e.itemsMap)for(s in e.itemsMap)t[s]||(l[s]=!0)}if("object"==typeof u&&u.path===e&&"object"==typeof u.common||(u={path:e,common:{}},n[e]=u),u.remote={revision:i,timestamp:this.now()},h.isFolder(e))for(s in c(u.common),c(u.remote),u.remote.itemsMap={},t)u.remote.itemsMap[s]=!0
else u.remote.body=t,u.remote.contentType=r,(a=n[o])&&a.local&&a.local.itemsMap&&(s=e.substring(o.length),a.local.itemsMap[s]=!0,h.equal(a.local.itemsMap,a.common.itemsMap)&&delete a.local)
return n[e]=this.autoMerge(u),{toBeSaved:n,missingChildren:l}})})}completePush(e,t,r,i){return n(this,void 0,void 0,function*(){return this.rs.local.getNodes([e]).then(n=>{const o=n[e]
if(!o.push)throw this.stopped=!0,new Error("completePush called but no push version!")
return r?(u.default("[Sync] We have a conflict"),o.remote&&o.remote.revision===i||(o.remote={revision:i||"conflict",timestamp:this.now()},delete o.push),n[e]=this.autoMerge(o)):(o.common={revision:i,timestamp:this.now()},"put"===t?(o.common.body=o.push.body,o.common.contentType=o.push.contentType,h.equal(o.local.body,o.push.body)&&o.local.contentType===o.push.contentType&&delete o.local,delete o.push):"delete"===t&&(!1===o.local.body?n[e]=void 0:delete o.push)),this.rs.local.setNodes(this.flush(n))})})}dealWithFailure(e){return n(this,void 0,void 0,function*(){return this.rs.local.getNodes([e]).then(t=>{if(t[e])return delete t[e].push,this.rs.local.setNodes(this.flush(t))})})}interpretStatus(e){const t={statusCode:e,successful:void 0,conflict:void 0,unAuth:void 0,notFound:void 0,changed:void 0,networkProblems:void 0}
...
return t.successful=2===r||304===e||412===e||404===e,t.conflict=412===e,t.unAuth=401===e&&this.rs.remote.token!==l.default.IMPLIED_FAKE_TOKEN||402===e||403===e,t.notFound=404===e,t.changed=304!==e,t}}handleGetResponse(e,t,r,i,o){return n(this,void 0,void 0,function*(){return t.notFound&&(r=!!h.isFolder(e)&&{}),t.changed?this.completeFetch(e,r,i,o).then(t=>h.isFolder(e)?this.corruptServerItemsMap(r)?(u.default("[Sync] WARNING: Discarding corrupt folder description from server for "+e),!1):this.markChildren(e,r,t.toBeSaved,t.missingChildren).then(()=>!0):this.rs.local.setNodes(this.flush(t.toBeSaved)).then(()=>!0)):this.updateCommonTimestamp(e,o).then(()=>!0)})}handleResponse(e,t,r){const n=this.interpretStatus(r.statusCode)
...
const n=(e=this.rs.remote.connected?this.rs.remote.online?this.numThreads:1:0)-Object.getOwnPropertyNames(this._running).length
if(n<=0)return!0
for(t in this._tasks)if(!this._running[t]&&(this._timeStarted[t]=this.now(),this._running[t]=this.doTask(t),this._running[t].then(this.finishTask.bind(this)),++r>=n))return!0
...
o.default.isBackground=!e
const n=t.getCurrentSyncInterval()
t._emit("sync-interval-change",{oldValue:r,newValue:n})}e.on("background",()=>r(!1)),e.on("foreground",()=>r(!0))}(t,e),e.sync||(e.sync=new y(e),e.syncStopped&&(u.default("[Sync] Instantiating sync stopped"),e.sync.stopped=!0,delete e.syncStopped)),u.default("[Sync] syncCycleCb calling syncCycle"),e.syncCycle()},d=function(){e.removeEventListener("connected",d),e.startSync()},e.on("ready",f),e.on("connected",d)}static _rs_cleanup(e){e.stopSync(),e.removeEventListener("ready",f),e.removeEventListener("connected",d),e.sync=void 0,delete e.sync}}h.applyMixins(y,[a.default]),e.exports=y},function(e,t,r){"use strict";(function(t){var n=this&&this.__awaiter||function(e,t,r,n){return new(r||(r=Promise))(function(i,o){function s(e){try{u(n.next(e))}catch(e){o(e)}}function a(e){try{u(n.throw(e))}catch(e){o(e)}}function u(e){var t
e.done?i(e.value):(t=e.value,t instanceof r?t:new r(function(e){e(t)})).then(s,a)}u((n=n.apply(e,t||[])).next())})},i=this&&this.__importDefault||function(e){return e&&e.__esModule?e:{default:e}}
const o=i(r(2)),s=i(r(10)),a=i(r(1)),u=r(0)
let l
class c extends s.default{constructor(e){super(),this.addEvents(["change","local-events-done"]),this.db=e||l,this.db?(this.getsRunning=0,this.putsRunning=0,this.changesQueued={},this.changesRunning={},this.commitSlownessWarning=null):a.default("[IndexedDB] Failed to open DB")}getNodes(e){return n(this,void 0,void 0,function*(){const t=[],r={}
...
try{const i=indexedDB.open(e,2)
i.onerror=function(){a.default("[IndexedDB] Opening DB failed",i),clearTimeout(r),t(i.error)},i.onupgradeneeded=function(e){const t=i.result
a.default("[IndexedDB] Upgrade: from ",e.oldVersion," to ",e.newVersion),1!==e.oldVersion&&(a.default("[IndexedDB] Creating object store: nodes"),t.createObjectStore("nodes",{keyPath:"path"})),a.default("[IndexedDB] Creating object store: changes"),t.createObjectStore("changes",{keyPath:"path"})},i.onsuccess=function(){clearTimeout(r)
const n=i.result
if(!n.objectStoreNames.contains("nodes")||!n.objectStoreNames.contains("changes"))return a.default("[IndexedDB] Missing object store. Resetting the database."),void c.clean(e,function(){c.open(e,t)})
t(null,i.result)}}catch(n){a.default("[IndexedDB] Failed to open database: "+n),a.default("[IndexedDB] Resetting database and trying again."),clearTimeout(r),c.clean(e,function(){c.open(e,t)})}}static clean(e,t){const r=indexedDB.deleteDatabase(e)
...
r.onerror=function(){t()},r.onsuccess=function(){r.result.close(),indexedDB.deleteDatabase("rs-check"),e()}}catch(e){t()}else t()})}static _rs_cleanup(e){return new Promise(t=>{e.local&&e.local.closeDB(),c.clean("remotestorage",t)})}diffHandler(){}}u.applyMixins(c,[o.default]),e.exports=c}).call(this,r(5))},function(e,t,r){"use strict"
var n=this&&this.__importDefault||function(e){return e&&e.__esModule?e:{default:e}}
const i=n(r(10)),o=n(r(2)),s=n(r(1)),a=r(0),u="remotestorage:cache:nodes:"
...
l(r)&&e.push(r)}e.forEach(e=>{s.default("[LocalStorage] Removing",e),delete localStorage[e]})}}a.applyMixins(c,[o.default]),e.exports=c},function(e,t,r){"use strict"
var n=this&&this.__importDefault||function(e){return e&&e.__esModule?e:{default:e}}
const i=n(r(2)),o=n(r(10))
class s extends o.default{constructor(){super(),this._storage={},this.addEvents(["change","local-events-done"])}getNodes(e){const t={}
...
l?t&&u?this._hasCrossedThreshold(l,p)&&this._queuedEntries.push(p):l&&l.isIntersecting&&this._queuedEntries.push(p):this._queuedEntries.push(p)},this),this._queuedEntries.length&&this._callback(this.takeRecords(),this)},i.prototype._computeTargetAndRootIntersection=function(r,n){if("none"!=e.getComputedStyle(r).display){for(var i,o,s,u,c,p,h,f,d=a(r),m=l(r),v=!1;!v;){var g=null,y=1==m.nodeType?e.getComputedStyle(m):{}
if("none"==y.display)return
if(m==this.root||m==t?(v=!0,g=n):m!=t.body&&m!=t.documentElement&&"visible"!=y.overflow&&(g=a(m)),g&&(i=g,o=d,s=void 0,u=void 0,c=void 0,p=void 0,h=void 0,f=void 0,s=Math.max(i.top,o.top),u=Math.min(i.bottom,o.bottom),c=Math.max(i.left,o.left),p=Math.min(i.right,o.right),f=u-s,!(d=(h=p-c)>=0&&f>=0&&{top:s,bottom:u,left:c,right:p,width:h,height:f})))break
...
p&&c.registerWaiter(function(){return 0===g}),e.default=Ember.Mixin.create({contentType:"application/x-www-form-urlencoded; charset=UTF-8",headers:{},request:function(e,t){var r=this.options(e,t),n=this._makeRequest(r),i=new a.default(function(e,t){n.then(function(t){var r=t.response
...
return"GET"!==e&&!(!f(r)&&!f((0,i.default)(o,"Content-Type")))&&"object"===(void 0===n?"undefined":u(n))})(s,e)&&(e.data=JSON.stringify(e.data)),g+=1
...
u=s instanceof Error?s:"timeout"===i?new t.TimeoutError:"abort"===i?new t.AbortError:o.handleResponse(e.status,(0,n.default)(e.getAllResponseHeaders()),a,l),Ember.run.join(null,r,{payload:a,textStatus:i,jqXHR:e,errorThrown:s,response:u})}).always(function(){g-=1})},"ember-ajax: "+e.type+" "+e.url)
...
m.push(o),n&&(g["key".concat(r,"DidChange")]=Ember.observer(o,v))})
var y,b=a.extend(g,{onInit:Ember.on("init",function(){v.call(this)})}),_=Ember.computed.apply(void 0,(y=(0,n.default)(c),function(e){if(Array.isArray(e)){for(var t=0,r=new Array(e.length);t<e.length;t++)r[t]=e[t]
return r}}(y)||function(e){if(Symbol.iterator in Object(e)||"[object Arguments]"===Object.prototype.toString.call(e))return Array.from(e)}(y)||function(){throw new TypeError("Invalid attempt to spread non-iterable instance")}()).concat([function(e){var r=this,n=function(e,t,r,n){var i=s.get(e)
i||(i=new o,s.set(e,i))
var a=i.get(n)
if(a)return a
