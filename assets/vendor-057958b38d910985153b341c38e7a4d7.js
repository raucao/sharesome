...
return i||(t=n.body.appendChild(n.createElement(r)),i=he.css(t,"display"),t.parentNode.removeChild(t),"none"===i&&(i="block"),qe[r]=i,i)}function y(e,t){for(var n,r,i=[],o=0,s=e.length;o<s;o++)(r=e[o]).style&&(n=r.style.display,t?("none"===n&&(i[o]=Ne.get(r,"display")||null,i[o]||(r.style.display="")),""===r.style.display&&Be(r)&&(i[o]=g(r))):"none"!==n&&(i[o]="none",Ne.set(r,"display",n)))
...
if(u)for(l=a[a.length-1].ownerDocument,he.map(a,T),f=0;f<u;f++)c=a[f],We.test(c.type||"")&&!Ne.access(c,"globalEval")&&he.contains(l,c)&&(c.src?he._evalUrl&&he._evalUrl(c.src):n(c.textContent.replace(nt,""),l))}return e}function R(e,t,n){for(var r,i=t?he.filter(t,e):e,o=0;null!=(r=i[o]);o++)n||1!==r.nodeType||he.cleanData(v(r)),r.parentNode&&(n&&he.contains(r.ownerDocument,r)&&b(v(r,"script")),r.parentNode.removeChild(r))
...
return it.test(o)?o:(r=s&&(pe.boxSizingReliable()||o===e.style[t]),"auto"===o&&(o=e["offset"+t[0].toUpperCase()+t.slice(1)]),(o=parseFloat(o)||0)+L(e,t,n||(s?"border":"content"),r,i)+"px")}function F(e,t,n,r,i){return new F.prototype.init(e,t,n,r,i)}function B(){ht&&(!1===te.hidden&&e.requestAnimationFrame?e.requestAnimationFrame(B):e.setTimeout(B,he.fx.interval),he.fx.tick())}function U(){return e.setTimeout(function(){pt=void 0}),pt=he.now()}function q(e,t){var n,r=0,i={height:e}
...
for(var t=pt||U(),n=Math.max(0,c.startTime+c.duration-t),r=1-(n/c.duration||0),o=0,s=c.tweens.length;o<s;o++)c.tweens[o].run(r)
...
p=l.join(","),h=ge.test(e)&&c(t.parentNode)||t}if(p)try{return $.apply(n,h.querySelectorAll(p)),n}catch(e){}finally{a===z&&t.removeAttribute("id")}}}return S(e.replace(oe,"$1"),t,n,r)}function n(){function e(n,r){return t.push(n+" ")>w.cacheLength&&delete e[t.shift()],e[n+" "]=r}var t=[]
...
o(null,b=[],c,u)}for(l=b.length;l--;)(f=b[l])&&(c=o?X(r,f):p[l])>-1&&(r[c]=!(s[c]=f))}}else b=m(b===s?b.splice(g,b.length):b),o?o(null,s,b,u):$.apply(s,b)})}function y(e){for(var t,n,r,i=e.length,o=w.relative[e[0].type],s=o||w.relative[" "],a=o?1:0,u=p(function(e){return e===t},s,!0),c=p(function(e){return X(t,e)>-1},s,!0),l=[function(e,n,r){var i=!o&&(r||n!==T)||((t=n).nodeType?u(e,n,r):c(e,n,r))
return t=null,i}];a<i;a++)if(n=w.relative[e[a].type])l=[p(h(l),n)]
else{if((n=w.filter[e[a].type].apply(null,e[a].matches))[z]){for(r=++a;r<i&&!w.relative[e[r].type];r++);return g(a>1&&h(l),a>1&&f(e.slice(0,a-1).concat({value:" "===e[a-2].type?"*":""})).replace(oe,"$1"),n,a<r&&y(e.slice(a,r)),r<i&&y(e=e.slice(r)),r<i&&f(e))}l.push(n)}return h(l)}function v(e,n){var i=n.length>0,o=e.length>0,s=function(r,s,a,u,c){var l,f,p,h=0,d="0",g=r&&[],y=[],v=T,b=r||o&&w.find.TAG("*",c),_=B+=null==v?1:Math.random()||.1,x=b.length
for(c&&(T=s===R||s||c);d!==x&&null!=(l=b[d]);d++){if(o&&l){for(f=0,s||l.ownerDocument===R||(k(l),a=!N);p=e[f++];)if(p(l,s||R,a)){u.push(l)
break}c&&(B=_)}i&&((l=!p&&l)&&h--,r&&g.push(l))}if(h+=d,i&&d!==h){for(f=0;p=n[f++];)p(g,y,s,a)
if(r){if(h>0)for(;d--;)g[d]||y[d]||(y[d]=Y.call(u))
y=m(y)}$.apply(u,y),c&&!r&&y.length>0&&h+n.length>1&&t.uniqueSort(u)}return c&&(B=_,T=v),g}
return i?r(s):s}var b,_,w,x,E,O,C,S,T,A,P,k,R,j,N,M,I,D,L,z="sizzle"+1*new Date,F=e.document,B=0,U=0,q=n(),H=n(),V=n(),W=function(e,t){return e===t&&(P=!0),0},G={}.hasOwnProperty,K=[],Y=K.pop,Q=K.push,$=K.push,J=K.slice,X=function(e,t){for(var n=0,r=e.length;n<r;n++)if(e[n]===t)return n
...
return r!==r||n?t:r<0?String.fromCharCode(r+65536):String.fromCharCode(r>>10|55296,1023&r|56320)},be=/([\0-\x1f\x7f]|^-?\d)|^-$|[^\0-\x1f\x7f-\uFFFF\w-]/g,_e=function(e,t){return t?"\0"===e?"�":e.slice(0,-1)+"\\"+e.charCodeAt(e.length-1).toString(16)+" ":"\\"+e},we=function(){k()},xe=p(function(e){return!0===e.disabled&&("form"in e||"label"in e)},{dir:"parentNode",next:"legend"})
try{$.apply(K=J.call(F.childNodes),F.childNodes),K[F.childNodes.length].nodeType}catch(e){$={apply:K.length?function(e,t){Q.apply(e,J.call(t))}:function(e,t){for(var n=e.length,r=0;e[n++]=t[r++];);e.length=n-1}}}_=t.support={},E=t.isXML=function(e){var t=e&&(e.ownerDocument||e).documentElement
return!!t&&"HTML"!==t.nodeName},k=t.setDocument=function(e){var t,n,r=e?e.ownerDocument||e:F
return r!==R&&9===r.nodeType&&r.documentElement?(R=r,j=R.documentElement,N=!E(R),F!==R&&(n=R.defaultView)&&n.top!==n&&(n.addEventListener?n.addEventListener("unload",we,!1):n.attachEvent&&n.attachEvent("onunload",we)),_.attributes=i(function(e){return e.className="i",!e.getAttribute("className")}),_.getElementsByTagName=i(function(e){return e.appendChild(R.createComment("")),!e.getElementsByTagName("*").length}),_.getElementsByClassName=de.test(R.getElementsByClassName),_.getById=i(function(e){return j.appendChild(e).id=z,!R.getElementsByName||!R.getElementsByName(z).length}),_.getById?(w.filter.ID=function(e){var t=e.replace(ye,ve)
...
return n||(1&(n=(e.ownerDocument||e)===(t.ownerDocument||t)?e.compareDocumentPosition(t):1)||!_.sortDetached&&t.compareDocumentPosition(e)===n?e===R||e.ownerDocument===F&&L(F,e)?-1:t===R||t.ownerDocument===F&&L(F,t)?1:A?X(A,e)-X(A,t):0:4&n?-1:1)}:function(e,t){if(e===t)return P=!0,0
...
for(;a[r]===u[r];)r++
return r?s(a[r],u[r]):a[r]===F?-1:u[r]===F?1:0},R):R},t.matches=function(e,n){return t(e,null,null,n)},t.matchesSelector=function(e,n){if((e.ownerDocument||e)!==R&&k(e),n=n.replace(ue,"='$1']"),_.matchesSelector&&N&&!V[n+" "]&&(!I||!I.test(n))&&(!M||!M.test(n)))try{var r=D.call(e,n)
...
d=m="only"===e&&!d&&"nextSibling"}return!0}if(d=[s?g.firstChild:g.lastChild],s&&v){for(b=(h=(c=(l=(f=(p=g)[z]||(p[z]={}))[p.uniqueID]||(f[p.uniqueID]={}))[e]||[])[0]===B&&c[1])&&c[2],p=h&&g.childNodes[h];p=++h&&p&&p[m]||(b=h=0)||d.pop();)if(1===p.nodeType&&++b&&p===t){l[e]=[B,h,b]
break}}else if(v&&(b=h=(c=(l=(f=(p=t)[z]||(p[z]={}))[p.uniqueID]||(f[p.uniqueID]={}))[e]||[])[0]===B&&c[1]),!1===b)for(;(p=++h&&p&&p[m]||(b=h=0)||d.pop())&&((a?p.nodeName.toLowerCase()!==y:1!==p.nodeType)||!++b||(v&&((l=(f=p[z]||(p[z]={}))[p.uniqueID]||(f[p.uniqueID]={}))[e]=[B,b]),p!==t)););return(b-=i)===r||b%r==0&&b/r>=0}}},PSEUDO:function(e,n){var i,o=w.pseudos[e]||w.setFilters[e.toLowerCase()]||t.error("unsupported pseudo: "+e)
...
for(a in n)Re(e,t,a,n[a],!0,o,s)}else if(void 0!==r&&(i=!0,he.isFunction(r)||(s=!0),c&&(s?(t.call(e,r),t=null):(c=t,t=function(e,t,n){return c.call(he(e),n)})),t))for(;a<u;a++)t(e[a],n,s?r:r.call(e[a],a,t(e[a],n)))
...
var Le=/[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source,ze=new RegExp("^(?:([+-])=|)("+Le+")([a-z%]*)$","i"),Fe=["Top","Right","Bottom","Left"],Be=function(e,t){return"none"===(e=t||e).style.display||""===e.style.display&&he.contains(e.ownerDocument,e)&&"none"===he.css(e,"display")},Ue=function(e,t,n,r){var i,o,s={}
...
n[Ne.expando]=void 0}n[Me.expando]&&(n[Me.expando]=void 0)}}}),he.fn.extend({detach:function(e){return R(this,e,!0)},remove:function(e){return R(this,e)},text:function(e){return Re(this,function(e){return void 0===e?he.text(this):this.empty().each(function(){1!==this.nodeType&&11!==this.nodeType&&9!==this.nodeType||(this.textContent=e)})},null,e,arguments.length)},append:function(){return k(this,arguments,function(e){1!==this.nodeType&&11!==this.nodeType&&9!==this.nodeType||C(this,e).appendChild(e)})},prepend:function(){return k(this,arguments,function(e){if(1===this.nodeType||11===this.nodeType||9===this.nodeType){var t=C(this,e)
...
for(var n,r=0,i=e.length;r<i;r++)n=e[r],W.tweeners[n]=W.tweeners[n]||[],W.tweeners[n].unshift(t)},prefilters:[function(e,t,n){var r,i,o,s,a,u,c,l,f="width"in t||"height"in t,p=this,h={},d=e.style,m=e.nodeType&&Be(e),g=Ne.get(e,"fxshow")
...
return this.lastRevision=e.tag.value(),this.initialized=!0,t},e}(),R="adb3b78e-3d22-4e4b-877a-6317c2c5c145",j=function(){function e(t){u(this,e),this.inner=t,this.tag=v}return e.prototype.value=function(){return this.inner},e}(),N=function(e){function t(n,r){l(this,t)
...
r!==v&&i.push(r)}return a(i)},e.CachedTag=E,e.UpdatableTag=S,e.CachedReference=A,e.map=function(e,t){return new P(e,t)},e.ReferenceCache=k,e.isModified=function(e){return e!==R}}),e("@glimmer/runtime",["exports","@glimmer/util","@glimmer/reference","@glimmer/wire-format"],function(e,t,n,r){"use strict"
...
e.prototype=Object.create(t&&t.prototype,{constructor:{value:e,enumerable:!1,writable:!0,configurable:!0}}),t&&(Object.setPrototypeOf?Object.setPrototypeOf(e,t):D(e,t))}function F(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function B(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function U(e){return"object"==typeof e&&null!==e&&e[On]}function q(e,t){var n,r,i,o=Object.getOwnPropertyNames(t)
for(n=0;n<o.length;n++)r=o[n],(i=Object.getOwnPropertyDescriptor(t,r))&&i.configurable&&void 0===e[r]&&Object.defineProperty(e,r,i)
...
return"attr"===i?mt(n,o):dt(n,o)}function dt(e,t){return je(e,t)?new Fr(t):vt(e,t)?Br:bt(e,t)?Ur:new zr(t)}function mt(e,t){return je(e,t)?new qr(t):new Lr(t)}function gt(e){return!1===e||void 0===e||null===e?null:!0===e?"":"function"==typeof e?null:String(e)}function yt(e){return null===e||void 0===e}function vt(e,t){return("INPUT"===e||"TEXTAREA"===e)&&"value"===t}function bt(e,t){return"OPTION"===e&&"selected"===t}function _t(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function wt(e,t){var n,r,i,o=Object.getOwnPropertyNames(t)
for(n=0;n<o.length;n++)r=o[n],(i=Object.getOwnPropertyDescriptor(t,r))&&i.configurable&&void 0===e[r]&&Object.defineProperty(e,r,i)
...
o?(n=e.constants.getString(o),e.elements().setStaticAttributeNS(n,s,a)):e.elements().setStaticAttribute(s,a)}),Rt.add(35,function(e,t){var n=t.op1,r=e.constants.getOther(n),i=e.stack.pop(),o=i.tag,s=e.elements(),a=s.constructing,u=s.updateOperations,c=e.dynamicScope(),l=r.create(a,i,c,u)
...
Yt.setup(r,!!n),r.push(Yt)}),Rt.add(59,function(e,t){var n,r,i,o,s,a,u,c,l,f,p=t.op1,h=e.stack,d=e.fetchValue(p),m=d.definition,g=d.manager,y=h.pop(),v=g.prepareArgs(m,y)
...
h.push(u),y.setup(h,!1)}h.push(y)}),Rt.add(60,function(e,t){var n,r=t.op1,i=t.op2,o=void 0,s=void 0,a=e.stack.pop(),u=e.dynamicScope(),c=(n=e.fetchValue(i),o=n.definition,s=n.manager,n),l=s.create(e.env,o,a,u,e.getSelf(),!!(1&r))
c.component=l,e.updateWith(new fn(a.tag,o.name,l,s,u))}),Rt.add(61,function(e,t){var n=t.op1,r=e.fetchValue(n),i=r.manager,o=r.component,s=i.getDestructor(o)
...
s.newBounds(u),o&&e.updateWith(this.updateWith(e,t,o,u,a))},e}(),Rn=function(e){function t(){return ee(this,t),X(this,e.apply(this,arguments))}return Z(t,e),t.create=function(e){return new t(e)},t.prototype.toBool=function(e){return U(e)},t}(Bt),jn=function(e){function t(n,r,i){ee(this,t)
...
var Un=function e(t){ue(this,e),this.handle=t},qn=function e(t,n){ue(this,e),this.handle=t,this.symbolTable=n},Hn=function(){function e(e,t){var n,r
...
return this.layout.asLayout(this.componentName,this.attrs.buffer).compileDynamic(e)},Hn(e,[{key:"tag",get:function(){throw new Error("BUG: Cannot call `tag` on an UnwrappedBuilder")}}]),e}(),Kn=function(){function e(){ce(this,e),this.isDynamic=null,this.isStatic=null,this.staticTagName=null,this.dynamicTagName=null}return e.prototype.getDynamic=function(){if(this.isDynamic)return this.dynamicTagName},e.prototype.getStatic=function(){if(this.isStatic)return this.staticTagName},e.prototype.static=function(e){this.isStatic=!0,this.staticTagName=e},e.prototype.dynamic=function(e){this.isDynamic=!0,this.dynamicTagName=[r.Ops.ClientSideExpression,Bn.FunctionExpression,e]},e}(),Yn=function(){function e(){ce(this,e),this.buffer=[]}return e.prototype.static=function(e,t){this.buffer.push([r.Ops.StaticAttr,e,t,null])},e.prototype.dynamic=function(e,t){this.buffer.push([r.Ops.DynamicAttr,e,[r.Ops.ClientSideExpression,Bn.FunctionExpression,t],null])},e}(),Qn=function(){function e(t){ce(this,e),this.builder=t,this.env=t.env}return e.prototype.static=function(e,t){var n=t[0],r=t[1],i=t[2],o=t[3],s=this.builder
...
t.concat(r.length)}),cr.add(Bn.FunctionExpression,function(e,t){t.function(e[2])}),ur.add(er.Helper,function(e,t){var n=t.env,r=t.meta,i=e[1],o=e[2],s=e[3]
...
var n=t
n=et(kr,n),n=Be(kr,n),n=Ke(kr,n,Cr),e.DOMTreeConstruction=n})(Ar||(Ar={}))
...
if(!Qe(e,n))return t
var r=e.createElement("div")
return function(e){function t(){return Ve(this,t),We(this,e.apply(this,arguments))}return Ge(t,e),t.prototype.insertHTMLBefore=function(t,i,o){return null===o||""===o?e.prototype.insertHTMLBefore.call(this,t,i,o):t.namespaceURI!==n?e.prototype.insertHTMLBefore.call(this,t,i,o):Ye(t,r,o,i)},t}(t)}(kr,Nr,Cr),Dr=Ar.DOMTreeConstruction,Lr=function(){function e(t){pt(this,e),this.attr=t}return e.prototype.setAttribute=function(e,t,n,r){var i=e.getAppendOperations(),o=gt(n)
...
n?e.getDOM().removeAttributeNS(t,n,r):e.getDOM().removeAttribute(t,r)},t.prototype.updateAttribute=function(e,t,n,r){t[this.attr]=n,yt(n)&&this.removeAttribute(e,t,r)},t}(Lr),Fr=function(e){function t(){return pt(this,t),lt(this,e.apply(this,arguments))}return ft(t,e),t.prototype.setAttribute=function(t,n,r){e.prototype.setAttribute.call(this,t,n,Ne(t,n,this.attr,r))},t.prototype.updateAttribute=function(t,n,r){e.prototype.updateAttribute.call(this,t,n,Ne(t,n,this.attr,r))},t}(zr),Br=new(function(e){function t(){return pt(this,t),lt(this,e.apply(this,arguments))}return ft(t,e),t.prototype.setAttribute=function(e,t,n){t.value=ne(n)},t.prototype.updateAttribute=function(e,t,n){var r=t,i=r.value,o=ne(n)
...
this.offset=this.offset-o},e}(),Qr=function(){function e(){_t(this,e),this.heap=new Yr,this._opcode=new Gr(this.heap),this.constants=new yr}return e.prototype.opcode=function(e){return this._opcode.offset=e,this._opcode},e}(),$r=function(){function e(t){var n=t.appendOperations,r=t.updateOperations
...
return o||(o=JSON.parse(i)),new li(s,a,e,o)}}},e.NULL_REFERENCE=Lt,e.UNDEFINED_REFERENCE=Dt,e.PrimitiveReference=Nt,e.ConditionalReference=Bt,e.OpcodeBuilderDSL=Zn,e.compileLayout=function(e,t){var n=new Vn(t)
return e.compile(n),n.compile()},e.CompiledStaticTemplate=Un,e.CompiledDynamicTemplate=qn,e.IAttributeManager=Lr,e.AttributeManager=Lr,e.PropertyManager=zr,e.INPUT_VALUE_PROPERTY_MANAGER=Br,e.defaultManagers=ht,e.defaultAttributeManagers=mt,e.defaultPropertyManagers=dt,e.readDOMAttr=function(e,t){var n=e.namespaceURI===Cr,r=Me(e,t),i=r.type,o=r.normalized
...
Object.defineProperty(e,"DOMChanges",{enumerable:!0,get:function(){return t.DOMChanges}}),Object.defineProperty(e,"DOMTreeConstruction",{enumerable:!0,get:function(){return t.DOMTreeConstruction}}),Object.defineProperty(e,"NodeDOMTreeConstruction",{enumerable:!0,get:function(){return n.NodeDOMTreeConstruction}})}),e("ember-glimmer/environment",["exports","ember-babel","ember-utils","ember-metal","ember-debug","ember-views","@glimmer/runtime","ember-glimmer/component-managers/curly","ember-glimmer/syntax","ember-glimmer/utils/iterable","ember-glimmer/utils/references","ember-glimmer/utils/debug-stack","ember-glimmer/helpers/if-unless","ember-glimmer/helpers/action","ember-glimmer/helpers/component","ember-glimmer/helpers/concat","ember-glimmer/helpers/get","ember-glimmer/helpers/hash","ember-glimmer/helpers/loc","ember-glimmer/helpers/log","ember-glimmer/helpers/mut","ember-glimmer/helpers/readonly","ember-glimmer/helpers/unbound","ember-glimmer/helpers/-class","ember-glimmer/helpers/-input-type","ember-glimmer/helpers/query-param","ember-glimmer/helpers/each-in","ember-glimmer/helpers/-normalize-class","ember-glimmer/helpers/-html-safe","ember-glimmer/protocol-for-url","ember-glimmer/modifiers/action","ember/features"],function(e,t,n,r,i,o,s,a,u,c,l,f,p,h,d,m,g,y,v,b,_,w,x,E,O,C,S,T,A,P,k){"use strict"
function R(e){return{object:"component:"+e}}var j=function(e){function i(i){var u=i[n.OWNER],c=(0,t.possibleConstructorReturn)(this,e.apply(this,arguments))
...
void 0!==r&&r.revalidate(t)}function A(){Et++}function P(){--Et<=0&&(wt.clear(),xt.flush())}function k(e,t){A()
...
if(void 0!==u){var c=[]
for(i=u.length-3;i>=0;i-=3)o=u[i],s=u[i+1],a=u[i+2],-1===R(n,o,s)&&(n.push(o,s,a),c.push(o,s,a))
...
Et>0?j(e,r,xt.add(e,t,r),n):d(e,r,[e,t])}}function I(){this.isDescriptor=!0}function D(e,t,n,r,i){void 0===i&&(i=$(e))
var o=i.peekWatching(t),s=void 0!==o&&o>0,a=e[t]
null!==a&&"object"==typeof a&&a.isDescriptor&&a.teardown(e,t,i)
var u=void 0
return n instanceof I?(u=n,e[t]=u,L(e.constructor),"function"==typeof n.setup&&n.setup(e,t)):void 0===n||null===n?(u=r,e[t]=r):(u=n,Object.defineProperty(e,t,n)),s&&T(e,t,i),"function"==typeof e.didDefineProperty&&e.didDefineProperty(e,t,u),this}function L(e){if(!1!==St){var t=$(e).readableCache()
...
1===s?(o.writeWatching(n,0),null!==(i=t[n])&&"object"==typeof i&&i.isDescriptor&&i.didUnwatch&&i.didUnwatch(t,n),"function"==typeof t.didUnwatchProperty&&t.didUnwatchProperty(n)):s>1&&o.writeWatching(n,s-1)}}}function B(e){return new Pt(null,null,e)}function U(e,t,n){if("object"==typeof e&&null!==e){var r=n||$(e),i=r.peekWatching(t)||0
...
return Dt(t,i),i}function J(e){return Bt.get(e)}function X(e){return-1!==Ut.get(e)}function Z(e){return qt.get(e)}function ee(e){return Ht.get(e)}function te(e,t){var n=e[t]
...
for(e+=t.substring(0,n),a=u.length;o<a;)(s=c.indexOf("{"))<0?r((e+u[o++]+c).replace(Wt,".[]")):ue(e+u[o++],c,s,r)}function ce(e,t,n){X(t)?U(e,t,n):z(e,t,n)}function le(t,n){var r=e.peekMeta(t)
...
if(o!==kt)return o}function ge(e,t){throw new r.Error("Cannot set read-only property '"+t+"' on object: "+n.inspect(e))}function ye(e,t,n){return D(e,t,null),ie(e,t,n)}function ve(e){var t,n=[],r=void 0
...
return null===o||void 0===o?n.makeArray(r):fn(o)?null===r||void 0===r?o:ln.call(o,r):ln.call(n.makeArray(o),r)}function Qe(e,t,r,i){var o,s=i[t]||e[t]
if(!s)return r
...
n._getter&&(n=Ge(r,t,n,o,i,e)),i[t]=n,o[t]=void 0}else s&&s.indexOf(t)>=0||"concatenatedProperties"===t||"mergedProperties"===t?n=Ye(e,t,n,o):a&&a.indexOf(t)>-1?n=Qe(e,t,n,o):He(n)&&(n=Ke(e,t,n,o,i)),i[t]=void 0,o[t]=n}function Je(e,t,n,r,i,o){var s,a=void 0,u=void 0,c=void 0,l=void 0,f=void 0
...
"function"==typeof r&&(nt(e,t,r.__ember_observesBefore__,Ue),nt(e,t,r.__ember_observes__,ze),nt(e,t,r.__ember_listens__,f)),"function"==typeof n&&(nt(e,t,n.__ember_observesBefore__,Fe),nt(e,t,n.__ember_observes__,Le),nt(e,t,n.__ember_listens__,l))}function it(e,t,r){var i,o,s={},a={},u=$(e),c=[],l=void 0,f=void 0,p=void 0
...
return o&&s===u?u:(_(e,t,r),o?i[t]=void 0:pe(this,e,t,r),i[t]=void 0===u?kt:u,w(e,t,r),u)},Gt.teardown=function(e,t,n){if(!this._volatile){var r=n.readableCache()
...
return o?be(n,o,i,r):n.call(r)},e._instrumentStart=we,e.instrumentationReset=function(){Qt.length=0,$t={}},e.instrumentationSubscribe=function(e,t){var n,r=e.split("."),i=void 0,o=[]
...
void 0!==t&&t.revalidateAll(),void 0!==e.readableChains()&&e.writableChains(B)},e.removeChainWatcher=Y,e.watchPath=U,e.unwatchPath=q,e.destroy=function(t){var n=e.peekMeta(t)
void 0!==n&&n.destroy()}
...
for(n=0;n<r.length;n++)i=r[n],ie(e,i,t[i])}),t):t},e.expandProperties=ae,e._suspendObserver=Be,e._suspendObservers=function(e,t,n,r,i){return h(e,t.map(Ie),n,r,i)},e.addObserver=Le,e.observersFor=function(e,t){return m(e,Ie(t))},e.removeObserver=ze,e._addBeforeObserver=Fe,e._removeBeforeObserver=Ue,e.Mixin=hn,e.aliasMethod=function(e){return new at(e)},e._immediateObserver=function(){var e
...
for(g.length=p.length,r=0;r<p.length;r++){if(i=p[r],o=i.names,s=i.shouldDecodes,a=T,u=!1,o!==A&&s!==A)for(c=0;c<o.length;c++)u=!0,l=o[c],f=d&&d[m++],a===T&&(a={}),R.ENCODE_AND_DECODE_PATH_SEGMENTS&&s[c]?a[l]=f&&decodeURIComponent(f):a[l]=f
...
R.prototype.add=function(e,t){var n,r,i,o,s,a,u=this.rootState,l="^",f=[0,0,0],p=new Array(e.length),h=[],d=!0,m=0
...
return L(o.handlerInfos,i.handlerInfos)?s&&(n=this.queryParamsTransition(s,r,i,o))?(n.queryParamsOnly=!0,n):this.activeTransition||new _(this):t?void R(this,o):(n=new _(this,e,o,void 0,this.activeTransition),z(o.handlerInfos,i.handlerInfos)&&(n.queryParamsOnly=!0),this.activeTransition&&this.activeTransition.abort(),this.activeTransition=n,n.promise=n.promise.then(function(e){return I(n,e.state)},null,h("Settle transition promise when transition is finalized")),r||U(this,o,n),k(this,o,s),n)}function k(e,t,n){n&&(e._changedQueryParams=n.all,f(e,t.handlerInfos,!0,["queryParamsDidChange",n.changed,n.all,n.removed]),e._changedQueryParams=null)}function R(e,t,n){var r,i,o,s=N(e.state,t)
...
S.klasses={resolved:K,param:Q,object:Y}
...
return i&&"replace"===i.urlMethod&&l.method(i.urlMethod),l},replaceWith:function(){return D(this,arguments).method("replace")},generate:function(e){var t,n,r=o(H.call(arguments,1)),s=r[0],a=r[1],u=new $({name:e,contexts:s}).applyToState(this.state,this.recognizer,this.getHandler,null,this.getSerializer),c={}
...
u&&!0!==u&&(r=U(u,r))}a[t]=r}var c=new I(d)
return a[s]=function(e,t){e?E(c,e):void 0===n?_(c,t):!0===n?_(c,B(arguments)):ge(n)?_(c,F(arguments,n)):_(c,t)},u?V(c,a,e,o):H(c,a,e,o)}
...
return r.length=o,r})}):I.reject(new TypeError("RSVP.filter expects function as a second argument"),n):I.reject(new TypeError("RSVP.filter must be called with an array or promise"),n)}function oe(e,t){Fe[je]=e,Fe[je+1]=t,2===(je+=2)&&Be()}function se(){return void 0!==Ne?function(){Ne(ue)}:ae()}function ae(){return function(){return setTimeout(ue,1)}}function ue(){var e
...
o===p?(n=m(e))===k&&e._state!==be?(e._onError=null,this._settledAt(e._state,t,e._result)):"function"!=typeof n?(this._remaining--,this._result[t]=this._makeResult(_e,t,e)):i===I?(b(r=new i(d),e,n),this._willSettleAt(r,t)):this._willSettleAt(new i(function(t){return t(e)}),t):this._willSettleAt(o(e),t)},R.prototype._eachEntry=function(e,t){c(e)?this._settleMaybeThenable(e,t):(this._remaining--,this._result[t]=this._makeResult(_e,t,e))},R.prototype._settledAt=function(e,t,n){var r=this.promise
...
return n.then(function(t){return r.resolve(e()).then(function(){return t})},function(t){return r.resolve(e()).then(function(){throw t})},t)},I.cast=p,I.all=function(e,t){return ge(e)?new R(this,e,!0,t).promise:this.reject(new TypeError("Promise.all must be called with an array"),t)},I.race=function(e,t){var n,r=this,i=new r(d,t)
...
return E(n,e),n},I.prototype._guidKey=Oe,I.prototype.then=k
var Se=new D,Te=new D,Ae=function(e){function n(n,r,i){return(0,t.possibleConstructorReturn)(this,e.call(this,n,r,!1,i))}return(0,t.inherits)(n,e),n}(R)
...
var Ue=ee,qe=function(e,t){return de.async(e,t)}
...
for(var He in pe)pe.hasOwnProperty(He)&&ce(He,pe[He])}var Ve=(fe={asap:oe,cast:Ue,Promise:I,EventTarget:he,all:G,allSettled:K,race:Y,hash:Q,hashSettled:$,rethrow:J,defer:X,denodeify:q,configure:o,on:ce,off:le,resolve:ee,reject:te,map:Z},fe.async=qe,fe.filter=ie,fe)
e.asap=oe,e.cast=Ue,e.Promise=I,e.EventTarget=he,e.all=G,e.allSettled=K,e.race=Y,e.hash=Q,e.hashSettled=$,e.rethrow=J,e.defer=X,e.denodeify=q,e.configure=o,e.on=ce,e.off=le,e.resolve=ee,e.reject=te,e.map=Z,e.async=qe,e.filter=ie,e.default=Ve}),t("ember")}(),function e(t,n,r){function i(s,a){if(!n[s]){if(!t[s]){var u="function"==typeof require&&require
if(!a&&u)return u(s,!0)
if(o)return o(s,!0)
...
i+="rsDiscovery="+btoa(JSON.stringify(u))}var c=n,l=i.indexOf("#")
if(c+=n.indexOf("?")>0?"&":"?",c+="redirect_uri="+encodeURIComponent(i.replace(/#.*$/,"")),c+="&scope="+encodeURIComponent(r),c+="&client_id="+encodeURIComponent(a),-1!==l&&l+1!==i.length&&(c+="&state="+encodeURIComponent(i.substring(l+1))),c+="&response_type=token",s.globalContext.cordova)return e.openWindow(c,i,"location=yes,clearsessioncache=yes,clearcache=yes").then(function(e){t.remote.configure({token:e.access_token})})
e.setLocation(c)}
...
var r="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(e){return typeof e}:function(e){return e&&"function"==typeof Symbol&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e},i=n(2),o=n(0),s=n(3),a=n(18),u=n(19),c=u.SchemaNotFound,l=function(e,t){if("/"!==t[t.length-1])throw"Not a folder: "+t
...
return e&&(t=e.match(/charset=(.+)$/))&&(n=t[1]),n}function u(e){return"http://remotestorage.io/spec/folder-description"===e["@context"]&&"object"===h(e.items)}function c(e){return[201,204,304].indexOf(e)>=0}function l(e){return[401,403,404,412].indexOf(e)>=0}var f,p,h="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(e){return typeof e}:function(e){return e&&"function"==typeof Symbol&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e},d=n(1),m=n(0),g=n(2),y=n(4),v=n(3),b="remotestorage:wireclient",_={"draft-dejong-remotestorage-00":2,"draft-dejong-remotestorage-01":3,"draft-dejong-remotestorage-02":4,"https://www.w3.org/community/rww/wiki/read-write-web-00#simple":1}
...
return!1}}var x=m.isFolder,E=m.cleanPath,O=m.shouldBeTreatedAsBinary,C=function(e){if(this.rs=e,this.connected=!1,g(this,"connected","not-connected"),f){var t
...
C.prototype={_request:function(e,t,n,r,i,u,f){if(("PUT"===e||"DELETE"===e)&&"/"===t[t.length-1])return Promise.reject("Don't "+e+" on directories!")
var p,h=this
return n!==y.IMPLIED_FAKE_TOKEN&&(r.Authorization="Bearer "+n),this.rs._emit("wire-busy",{method:e,isFolder:x(t)}),C.request(e,t,{body:i,headers:r,responseType:"arraybuffer"}).then(function(n){if(h.online||(h.online=!0,h.rs._emit("network-online")),h.rs._emit("wire-done",{method:e,isFolder:x(t),success:!0}),l(n.status))return d("[WireClient] Error response status",n.status),p=u?o(n.getResponseHeader("ETag")):void 0,401===n.status&&h.rs._emit("error",new y.Unauthorized),Promise.resolve({statusCode:n.status,revision:p})
if(c(n.status)||200===n.status&&"GET"!==e)return p=o(n.getResponseHeader("ETag")),d("[WireClient] Successful request",p),Promise.resolve({statusCode:n.status,revision:p})
...
t||(t={})
var n={}
return this.supportsRevs&&t.ifMatch&&(n["If-Match"]=i(t.ifMatch)),this._request("DELETE",this.href+E(e),this.token,n,void 0,this.supportsRevs)}},C.isArrayBufferView=p,C.request=function(e,t,n){return new Promise(function(r,i){d("[WireClient]",e,t)
...
var c=n.body
"object"===(void 0===c?"undefined":h(c))&&!p(c)&&c instanceof ArrayBuffer&&(c=new Uint8Array(c)),a.send(c)})},Object.defineProperty(C.prototype,"storageType",{get:function(){if(this.storageApi){var e=this.storageApi.match(/draft-dejong-(remotestorage-\d\d)/)
return e?e[1]:"2012.04"}}}),C._rs_init=function(e){f=m.localStorageAvailable(),e.remote=new C(e),this.online=!0},C._rs_supported=function(){return!!XMLHttpRequest},C._rs_cleanup=function(){f&&delete localStorage[b]},e.exports=C}).call(t,n(20).Buffer,n(6))},function(e,t,n){"use strict"
function r(e,t,n){return{action:e,path:t,promise:n}}function i(e,t){return e.common.revision!==t&&(!e.remote||e.remote.revision!==t)}function o(e){return e.remote&&e.remote.revision&&!e.remote.itemsMap&&!e.remote.body}function s(e){return e.common&&e.common.revision}function a(e){return(!e.remote||!e.remote.revision||e.remote.revision===e.common.revision)&&(void 0===e.common.body&&!1===e.remote.body||e.remote.body===e.common.body&&e.remote.contentType===e.common.contentType)}function u(e){return e.remote&&!1===e.remote.body&&e.local&&!1===e.local.body&&delete e.local,e}function c(){function e(e){var n,r
...
return void 0===n?r("get",e,this.remote.get(e)):o(n)?r("get",e,this.remote.get(e)):this.needsRemotePut(n)?(n.push=_(n.local),n.push.timestamp=this.now(),this.local.setNodes(this.flush(t)).then(function(){var t
...
for(var c in r)o.push(e+c)
return this.local.getNodes(o).then(function(t){var o
for(var u in t)if(o=t[u],s[u])o&&o.common?i(o,s[u].ETag)&&(n[u]=_(o),n[u].remote={revision:s[u].ETag,timestamp:this.now()},n[u]=this.autoMerge(n[u])):"ALL"===this.caching.checkPath(u)&&(n[u]={path:u,common:{timestamp:this.now()},remote:{revision:s[u].ETag,timestamp:this.now()}}),n[u]&&s[u]["Content-Type"]&&(n[u].remote.contentType=s[u]["Content-Type"]),n[u]&&s[u]["Content-Length"]&&(n[u].remote.contentLength=s[u]["Content-Length"])
else if(r[u.substring(e.length)]&&o&&o.common){if(o.common.itemsMap)for(var c in o.common.itemsMap)a[u+c]=!0
if(o.local&&o.local.itemsMap)for(var l in o.local.itemsMap)a[u+l]=!0
...
o&&(y(i)?(r(o.common,i),r(o.local,i)):o.common&&void 0!==l(o.common.body)&&(t[i]=_(o),t[i].remote={body:!1,timestamp:this.now()},t[i]=this.autoMerge(t[i])))}return this.deleteRemoteTrees(Object.keys(n),t).then(function(e){return this.local.setNodes(this.flush(e))}.bind(this))}.bind(this))},completeFetch:function(e,t,n,r){var i,o,s=w(e)
return y(e)?i=[e]:(o=s[1],i=[e,o]),this.local.getNodes(i).then(function(i){var s,a,u={},c=i[e],f=function(e){if(e&&e.itemsMap)for(s in e.itemsMap)t[s]||(u[s]=!0)}
if("object"===(void 0===c?"undefined":l(c))&&c.path===e&&"object"===l(c.common)||(c={path:e,common:{}},i[e]=c),c.remote={revision:r,timestamp:this.now()},y(e)){f(c.common),f(c.remote),c.remote.itemsMap={}
for(s in t)c.remote.itemsMap[s]=!0}else c.remote.body=t,c.remote.contentType=n,(a=i[o])&&a.local&&a.local.itemsMap&&(s=e.substring(o.length),a.local.itemsMap[s]=!0,b(a.local.itemsMap,a.common.itemsMap)&&delete a.local)
return i[e]=this.autoMerge(c),{toBeSaved:i,missingChildren:u}}.bind(this))},completePush:function(e,t,n,r){return this.local.getNodes([e]).then(function(i){var o=i[e]
...
return f(e)&&(t.common.itemsMap={}),t}function s(e,t){return e.common||(e.common={itemsMap:{}}),e.common.itemsMap||(e.common.itemsMap={}),e.local||(e.local=h(e.common)),e.local.itemsMap||(e.local.itemsMap=e.common.itemsMap),e.local.itemsMap[t]=!0,e}var a="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(e){return typeof e}:function(e){return e&&"function"==typeof Symbol&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e},u=n(0),c=n(3),l=n(1),f=u.isFolder,p=u.isDocument,h=u.deepClone,d=u.pathsFromRoot,m={get:function(e,t,n){var o=this
...
return this._updateNodes(i,function(e,i){try{for(var a=0,u=e.length;a<u;a++){var c=e[a],f=i[c],p=void 0
f||(i[c]=f=o(c)),0===a?(p=r(f),f.local={body:t,contentType:n,previousBody:p?p.body:void 0,previousContentType:p?p.contentType:void 0}):f=s(f,e[a-1].substring(c.length))}return i}catch(e){throw l("[Cachinglayer] Error during PUT",i,e),e}})},delete:function(e){var t=d(e)
...
i=t(e,i)
for(var l in i)o=i[l],c(o,s[l])?delete i[l]:p(l)&&(c(o.local.body,o.local.previousBody)&&o.local.contentType===o.local.previousContentType||a.push({path:l,origin:"window",oldValue:o.local.previousBody,newValue:!1===o.local.body?void 0:o.local.body,oldContentType:o.local.previousContentType,newContentType:o.local.contentType}),delete o.local.previousBody,delete o.local.previousContentType)
...
function r(e){return 403!==e.statusCode&&401!==e.statusCode||this._emit("error",new h.Unauthorized),Promise.resolve(e)}function i(e){return"number"==typeof e&&e>1e3&&e<36e5}var o,s="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(e){return typeof e}:function(e){return e&&"function"==typeof Symbol&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e},a=n(0),u=n(11),c=n(13),l=n(14),f=n(5),p=n(3),h=n(4),d=n(8),m=n(1),g=n(26),y=a.getGlobalContext(),v=n(2),b=function(e){if("object"===(void 0===e?"undefined":s(e))&&a.extend(p,e),v(this,"ready","authing","connecting","connected","disconnected","not-connected","conflict","error","features-loaded","sync-interval-change","sync-req-done","sync-done","wire-busy","wire-done","network-offline","network-online"),this._pending=[],this._setGPD({get:this._pendingGPD("get"),put:this._pendingGPD("put"),delete:this._pendingGPD("delete")}),this._cleanups=[],this._pathHandlers={change:{}},this.apiKeys={},o=a.localStorageAvailable()){try{this.apiKeys=JSON.parse(localStorage.getItem("remotestorage:api-keys"))||{}}catch(e){}this.setBackend(localStorage.getItem("remotestorage:backend")||"remotestorage")}var t=this.on
...
b.Authorize=h,b.SyncError=d.SyncError,b.Unauthorized=h.Unauthorized,b.DiscoveryError=l.DiscoveryError,b.prototype={loadModules:function(){p.modules.forEach(this.addModule.bind(this))},authorize:function(e,t){this.access.setStorageType(this.remote.storageType)
...
l(e).then(function(i){if(clearTimeout(r),n._emit("authing"),i.userAddress=e,n.remote.configure(i),!n.remote.connected)if(i.authURL)if(void 0===t)n.authorize(i.authURL,p.cordovaRedirectUri)
...
try{t=JSON.parse(localStorage.getItem(_))}catch(e){}t&&this.configure(t)
try{this._itemRefs=JSON.parse(localStorage.getItem(_+":shares"))||{}}catch(e){}}this.connected&&setTimeout(this._emit.bind(this),0,"connected")}
A.prototype={online:!0,connect:function(){this.rs.setBackend("dropbox"),this.token?l(this.rs):h(this.rs,"https://www.dropbox.com/oauth2/authorize","",String(h.getLocation()),this.clientId)},configure:function(e){void 0!==e.userAddress&&(this.userAddress=e.userAddress),void 0!==e.token&&(this.token=e.token)
var t=function(){b&&localStorage.setItem(_,JSON.stringify({userAddress:this.userAddress,token:this.token}))},n=function(){this.connected=!1,b&&localStorage.removeItem(_)}
...
try{r=JSON.parse(n.responseText)}catch(e){return Promise.reject(e)}return 409===n.status?S(r,["path","not_found"])?Promise.resolve({}):Promise.reject(new Error("API returned an error: "+r.error_summary)):(o=r.entries.reduce(function(n,r){var i="folder"===r[".tag"],o=r.path_lower.split("/").slice(-1)[0]+(i?"/":"")
...
return this._request("POST","https://api.dropboxapi.com/2/files/list_folder",{body:{path:C(e)}}).then(r).then(function(n){return Promise.resolve({statusCode:200,body:n,contentType:"application/json; charset=UTF-8",revision:t.get(e)})})},get:function(e,t){if(!this.connected)return Promise.reject("not connected (path: "+e+")")
...
var i={headers:{"Dropbox-API-Arg":JSON.stringify({path:C(e)})}}
...
try{r=JSON.parse(r)}catch(e){return Promise.reject(e)}if(409===a)return S(r,["path","not_found"])?Promise.resolve({statusCode:404}):Promise.reject(new Error('API error while downloading file ("'+e+'"): '+r.error_summary))
...
return t&&t.ifMatch&&r&&t.ifMatch!==r?Promise.resolve({statusCode:412,revision:r}):t&&t.ifMatch?this._getMetadata(e).then(function(r){return t&&t.ifMatch&&r&&r.rev!==t.ifMatch?Promise.resolve({statusCode:412,revision:r.rev}):n._deleteSimple(e)}):this._deleteSimple(e)},_shareIfNeeded:function(e){e.match(/^\/public\/.*[^\/]$/)&&void 0===this._itemRefs[e]&&this.share(e)},share:function(e){var t=this,n={body:{path:C(e)}}
...
return n.headers||(n.headers={}),n.headers.Authorization="Bearer "+this.token,"object"!==p(n.body)||T(n.body)||(n.body=JSON.stringify(n.body),n.headers["Content-Type"]="application/json; charset=UTF-8"),this.rs._emit("wire-busy",{method:e,isFolder:w(t)}),m.request.call(this,e,t,n).then(function(i){return i&&503===i.status?(r.online&&(r.online=!1,r.rs._emit("network-offline")),setTimeout(r._request(e,t,n),3210)):(r.online||(r.online=!0,r.rs._emit("network-online")),r.rs._emit("wire-done",{method:e,isFolder:w(t),success:!0}),Promise.resolve(i))},function(n){return r.online&&(r.online=!1,r.rs._emit("network-offline")),r.rs._emit("wire-done",{method:e,isFolder:w(t),success:!1}),Promise.reject(n)})},fetchDelta:function(){var e=Array.prototype.slice.call(arguments),t=this
...
var i=void 0
try{i=JSON.parse(r.responseText)}catch(e){return Promise.reject(new Error("Invalid response body: "+r.responseText))}if(409===r.status){if(!S(i,["path","not_found"]))return Promise.reject(new Error("API returned an error: "+i.error_summary))
i={cursor:null,entries:[],has_more:!1}}return i.entries.forEach(function(e){var n=e.path_lower.substr("/remotestorage".length)
"deleted"===e[".tag"]?(t._revCache.set(n,null),t._revCache.set(n+"/",null)):"file"===e[".tag"]&&t._revCache.set(n,e.rev)}),i.has_more?n(i.cursor):void 0}).catch(function(e){return"timeout"===e||e instanceof ProgressEvent?Promise.resolve():Promise.reject(e)})}().then(void 0,function(e){return"object"===(void 0===e?"undefined":p(e))&&"message"in e?e.message="Dropbox: fetchDelta: "+e.message:e="Dropbox: fetchDelta: "+e,Promise.reject(e)}).then(function(){return t._revCache&&t._revCache._activatePropagation(),Promise.resolve(e)})},_getMetadata:function(e){var t={path:C(e)}
...
try{r=JSON.parse(r)}catch(e){return Promise.reject(new Error("Invalid API result: "+r))}return 409===n.status?S(r,["path","conflict"])?t._getMetadata(e.path).then(function(e){return Promise.resolve({statusCode:412,revision:e.rev})}):Promise.reject(new Error("API error: "+r.error_summary)):(t._revCache.propagateSet(e.path,r.rev),Promise.resolve({statusCode:n.status,revision:r.rev}))})},_deleteSimple:function(e){var t=this,n={path:C(e)}
...
return"/"===e.substr(-1)?t[t.length-2]+"/":t[t.length-1]}function s(e){return b(y+"/"+e)}function a(e){e._origBaseClientGetItemURL||(e._origBaseClientGetItemURL=f.prototype.getItemURL,f.prototype.getItemURL=function(){throw new Error("getItemURL is not implemented for Google Drive yet")})}function u(e){e._origBaseClientGetItemURL&&(f.prototype.getItemURL=e._origBaseClientGetItemURL,delete e._origBaseClientGetItemURL)}var c="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(e){return typeof e}:function(e){return e&&"function"==typeof Symbol&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e},l=n(4),f=n(5),p=n(7),h=n(2),d=n(0),m="https://www.googleapis.com",g="remotestorage:googledrive",y="/remotestorage",v=d.isFolder,b=d.cleanPath,_=d.shouldBeTreatedAsBinary,w=d.readBinaryData,x=void 0,E=function(e){this.maxAge=e,this._items={}}
...
if("object"===(void 0===e?"undefined":c(e))&&"string"==typeof e.etag&&(r=e.etag.substring(1,e.etag.length-1)),t&&t.ifNoneMatch&&r===t.ifNoneMatch)return Promise.resolve({statusCode:304})
var i={}
...
if(e.mimeType.match(/^application\/json/))try{n=JSON.parse(n)}catch(e){}else if(_(n,e.mimeType))return w(n,e.mimeType).then(function(t){return{statusCode:200,body:t,contentType:e.mimeType,revision:r}})
...
try{for(var c,l=o.items[Symbol.iterator]();!(r=(c=l.next()).done);r=!0){var f=c.value
s=f.etag.substring(1,f.etag.length-1),"application/vnd.google-apps.folder"===f.mimeType?(t._fileIdCache.set(e+f.title+"/",f.id),a[f.title+"/"]={ETag:s}):(t._fileIdCache.set(e+f.title,f.id),a[f.title]={ETag:s,"Content-Type":f.mimeType,"Content-Length":f.fileSize})}}catch(e){i=!0,u=e}finally{try{!r&&l.return&&l.return()}finally{if(i)throw u}}return Promise.resolve({statusCode:200,body:a,contentType:"application/json; charset=UTF-8",revision:void 0})})):Promise.resolve({statusCode:404})})},_getParentId:function(e){var t=this,n=i(e)
...
var r,i,o="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(e){return typeof e}:function(e){return e&&"function"==typeof Symbol&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e},s=n(1),a=n(0),u=n(24),c={},l=function(e){return new Promise(function(t,n){return e in c?t(c[e]):new u({tls_only:!1,uri_fallback:!0,request_timeout:5e3}).lookup(e,function(r,a){if(r)return n(r)
...
var u=a.idx.links.remotestorage[0],l=u.properties["http://tools.ietf.org/html/rfc6749#section-4.2"]||u.properties["auth-endpoint"],f=u.properties["http://remotestorage.io/spec/version"]||u.type
return c[e]={href:u.href,storageType:f,authURL:l,properties:u.properties},i&&(localStorage["remotestorage:discover"]=JSON.stringify({cache:c})),t(c[e])})})};(l.DiscoveryError=function(e){this.name="DiscoveryError",this.message=e,this.stack=(new Error).stack}).prototype=Object.create(Error.prototype),l.DiscoveryError.prototype.constructor=l.DiscoveryError,l._rs_init=function(){if(i=a.localStorageAvailable()){var e
try{e=JSON.parse(localStorage["remotestorage:discover"])}catch(e){}e&&(c=e.cache)}},l._rs_supported=function(){return r=!!a.globalContext.XMLHttpRequest},l._rs_cleanup=function(){i&&delete localStorage["remotestorage:discover"]},e.exports=l},function(e,t,n){"use strict"
...
for(var u=[],c=t.split(","),l=[],f={},d=0;d<c.length;d++){var m=c[d],g=null
...
l.push(b),f[m]=b,u.push(m)}var _=function(t){for(var n="",u=0,c=0;c<l.length;c++){var f=l[c],p=t(f.name)
if(null===p||void 0===p||Array.isArray(p)&&0===p.length||"object"==typeof p&&0===Object.keys(p).length)u++
else if(n+=c===u?i:r||",",Array.isArray(p)){s&&(n+=f.name+"=")
...
for(var r in e)"enum"!==r&&a(e[r],t)}}function u(e){var t=w[e=e||"en"]
...
if(this.stack=o.stack||o.stacktrace,!this.stack)try{throw o}catch(o){this.stack=o.stack||o.stacktrace}}function l(e,t){if(t.substring(0,e.length)===e){var n=t.substring(e.length)
...
return e&&t.language(e),t},validate:function(e,i,o,s){var a=u(t),c=new d(r,!1,n?function(e,t,r){return n(e,t,r)||a(e,t,r)}:a,o,s)
"string"==typeof i&&(i={$ref:i}),c.addSchema("",i)
var l=c.validateAll(e,i,null,null,"")
return!l&&s&&(l=c.banUnknownProperties(e,i)),this.error=l,this.missing=c.missing,this.valid=null===l,this.valid},validateResult:function(){var e={toString:function(){return this.valid?"valid":this.error.message}}
return this.validate.apply(e,arguments),e},validateMultiple:function(e,i,o,s){var a=u(t),c=new d(r,!0,n?function(e,t,r){return n(e,t,r)||a(e,t,r)}:a,o,s)
...
d.prototype.defineKeyword=function(e,t){this.definedKeywords[e]=this.definedKeywords[e]||[],this.definedKeywords[e].push(t)},d.prototype.createError=function(e,t,n,r,i,o,s){var a=new c(e,t,n,r,i)
...
else if(e&&"object"==typeof e){"string"==typeof e.id&&l(t,e.id)&&void 0===this.schemas[e.id]&&(this.schemas[e.id]=e)
...
return this.createError(a,u,s.dataPath||null,c,null,e,t)}}return null},d.prototype.validateBasic=function(e,t,n){var r
...
if(null===f&&l===this.errors.length){if(null!==o)return this.errors=this.errors.slice(0,a),this.createError(y.ONE_OF_MULTIPLE,{index1:o,index2:u},"","/oneOf",null,e,t)
...
return this}
var w={},x=f()
return x.addLanguage("en-gb",_),x.tv4=x,x})},function(e,t,n){"use strict"
...
return"undefined"!=typeof ArrayBuffer&&t instanceof ArrayBuffer?p(e,t,n,r):"string"==typeof t?l(e,t,n):h(e,t)}function a(e){if("number"!=typeof e)throw new TypeError('"size" argument must be a number')
if(e<0)throw new RangeError('"size" argument must not be negative')}function u(e,t,n,r){return a(t),t<=0?i(e,t):void 0!==n?"string"==typeof r?i(e,t).fill(n,r):i(e,t).fill(n):i(e,t)}function c(e,t){if(a(t),e=i(e,t<0?0:0|d(t)),!o.TYPED_ARRAY_SUPPORT)for(var n=0;n<t;++n)e[n]=0
return e}function l(e,t,n){if("string"==typeof n&&""!==n||(n="utf8"),!o.isEncoding(n))throw new TypeError('"encoding" must be a valid string encoding')
...
s=2,a/=2,u/=2,n/=2}var c
if(i){var l=-1
for(c=n;c<a;c++)if(o(e,c)===o(t,-1===l?0:c-l)){if(-1===l&&(l=c),c-l+1===u)return l*s}else-1!==l&&(c-=c-l),l=-1}else for(n+u>a&&(n=a-u),c=n;c>=0;c--){for(var f=!0,p=0;p<u;p++)if(o(e,c+p)!==o(t,p)){f=!1
break}if(f)return c}return-1}function _(e,t,n,r){n=Number(n)||0
var i=e.length-n
...
if(i+a<=n){var u,c,l,f
switch(a){case 1:o<128&&(s=o)
break
case 2:128==(192&(u=e[i+1]))&&(f=(31&o)<<6|63&u)>127&&(s=f)
break
case 3:u=e[i+1],c=e[i+2],128==(192&u)&&128==(192&c)&&(f=(15&o)<<12|(63&u)<<6|63&c)>2047&&(f<55296||f>57343)&&(s=f)
break
case 4:u=e[i+1],c=e[i+2],l=e[i+3],128==(192&u)&&128==(192&c)&&128==(192&l)&&(f=(15&o)<<18|(63&u)<<12|(63&c)<<6|63&l)>65535&&f<1114112&&(s=f)}}null===s?(s=65533,a=1):s>65535&&(s-=65536,r.push(s>>>10&1023|55296),s=56320|1023&s),r.push(s),i+=a}return A(r)}function A(e){var t=e.length
...
if(n<0)throw new RangeError("Index out of range")}function z(e,t,n,r,i){return i||L(e,t,n,4,3.4028234663852886e38,-3.4028234663852886e38),$.write(e,t,n,r,23,4),n+4}function F(e,t,n,r,i){return i||L(e,t,n,8,1.7976931348623157e308,-1.7976931348623157e308),$.write(e,t,n,r,52,8),n+8}function B(e){if((e=U(e).replace(Z,"")).length<2)return""
for(;e.length%4!=0;)e+="="
return e}function U(e){return e.trim?e.trim():e.replace(/^\s+|\s+$/g,"")}function q(e){return e<16?"0"+e.toString(16):e.toString(16)}function H(e,t){t=t||1/0
...
return o}function G(e){return Q.toByteArray(B(e))}function K(e,t,n,r){for(var i=0;i<r&&!(i+n>=t.length||i>=e.length);++i)t[i+n]=e[i]
return i}function Y(e){return e!==e}var Q=n(21),$=n(22),J=n(23)
...
r||(r="utf8")
for(var o=!1;;)switch(r){case"hex":return _(this,e,t,n)
...
return o.join("")}t.byteLength=function(e){return 3*e.length/4-r(e)},t.toByteArray=function(e){var t,n,i,o,s,c=e.length
o=r(e),s=new u(3*c/4-o),n=o>0?c-4:c
var l=0
for(t=0;t<n;t+=4)i=a[e.charCodeAt(t)]<<18|a[e.charCodeAt(t+1)]<<12|a[e.charCodeAt(t+2)]<<6|a[e.charCodeAt(t+3)],s[l++]=i>>16&255,s[l++]=i>>8&255,s[l++]=255&i
return 2===o?(i=a[e.charCodeAt(t)]<<2|a[e.charCodeAt(t+1)]>>4,s[l++]=255&i):1===o&&(i=a[e.charCodeAt(t)]<<10|a[e.charCodeAt(t+1)]<<4|a[e.charCodeAt(t+2)]>>2,s[l++]=i>>8&255,s[l++]=255&i),s},t.fromByteArray=function(e){for(var t,n=e.length,r=n%3,i="",a=[],u=0,c=n-r;u<c;u+=16383)a.push(o(e,u,u+16383>c?c:u+16383))
...
"undefined"==typeof XMLHttpRequest&&(XMLHttpRequest=n(25)),function(n){function o(e){return e.toString=function(){return this.message},e}function s(e){return"string"==typeof e&&"https"===e.split("://")[0]}function a(e){"object"!=typeof e&&(e={}),this.config={tls_only:void 0===e.tls_only||e.tls_only,webfist_fallback:void 0!==e.webfist_fallback&&e.webfist_fallback,uri_fallback:void 0!==e.uri_fallback&&e.uri_fallback,request_timeout:void 0!==e.request_timeout?e.request_timeout:1e4}}var u={"http://webfist.org/spec/rel":"webfist","http://webfinger.net/rel/avatar":"avatar",remotestorage:"remotestorage","http://tools.ietf.org/id/draft-dejong-remotestorage":"remotestorage",remoteStorage:"remotestorage","http://www.packetizer.com/rel/share":"share","http://webfinger.net/rel/profile-page":"profile",me:"profile",vcard:"vcard",blog:"blog","http://packetizer.com/rel/blog":"blog","http://schemas.google.com/g/2010#updates-from":"updates","https://camlistore.org/rel/server":"camilstore"},c={avatar:[],remotestorage:[],blog:[],vcard:[],updates:[],share:[],profile:[],webfist:[],camlistore:[]},l=["webfinger","host-meta","host-meta.json"]
a.prototype.__fetchJRD=function(e,t,n){function r(){if(!u)return u=!0,200===c.status?a.__isValidJSON(c.responseText)?n(c.responseText):t(o({message:"invalid json",url:e,status:c.status})):404===c.status?t(o({message:"resource not found",url:e,status:c.status})):c.status>=301&&c.status<=302?s(c.getResponseHeader("Location"))?i():t(o({message:"no redirect URL found",url:e,status:c.status})):t(o({message:"error during request",url:e,status:c.status}))}function i(){c.onreadystatechange=function(){4===c.readyState&&r()},c.onload=function(){r()},c.ontimeout=function(){return t(o({message:"request timed out",url:e,status:c.status}))},c.open("GET",e,!0),c.timeout=a.config.request_timeout,c.setRequestHeader("Accept","application/jrd+json, application/json"),c.send()}var a=this,u=!1,c=new XMLHttpRequest
...
a.idx.properties={name:void 0},a.idx.links=JSON.parse(JSON.stringify(c)),s.map(function(e,t){if(u.hasOwnProperty(e.rel)&&a.idx.links[u[e.rel]]){var n={}
Object.keys(e).map(function(t,r){n[t]=e[t]}),a.idx.links[u[e.rel]].push(n)}})
var l=JSON.parse(t).properties
for(var f in l)l.hasOwnProperty(f)&&"http://packetizer.com/ns/name"===f&&(a.idx.properties.name=l[f])
return r(a)},a.prototype.lookup=function(e,t){function n(){var t=""
return e.split("://")[1]||(t="acct:"),u+"://"+s+"/.well-known/"+l[a]+"?resource="+t+e}function r(e){if(o.config.uri_fallback&&"webfist.org"!==s&&a!==l.length-1)return a+=1,i()
...
var a=0,u="https"
return o.__isLocalhost(s)&&(u="http"),setTimeout(i,0)},a.prototype.lookupLink=function(e,t,n){if(!c.hasOwnProperty(t))return n("unsupported rel "+t)
...
var r="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(e){return typeof e}:function(e){return e&&"function"==typeof Symbol&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e},i=n(0),o=n(1),s=n(27),a=n(3),u={features:[],featuresDone:0,readyFired:!1,loadFeatures:function(){var e=this
this.features=[],this.featuresDone=0,this.readyFired=!1,this.featureModules={WireClient:n(7),Dropbox:n(11),GoogleDrive:n(13),Access:n(15),Discover:n(14),Authorize:n(4),BaseClient:n(5),Env:n(12)},a.cache&&i.extend(this.featureModules,{Caching:n(16),IndexedDB:n(28),LocalStorage:n(29),InMemoryStorage:n(30),Sync:n(8)}),a.disableFeatures.forEach(function(t){e.featureModules[t]&&delete e.featureModules[t]}),this._allLoaded=!1
...
var r,i="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(e){return typeof e}:function(e){return e&&"function"==typeof Symbol&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e},o=n(1),s=n(9),a=n(2),u=n(0),c=function(e){this.db=e||r,this.db?(s(this),a(this,"change","local-events-done"),this.getsRunning=0,this.putsRunning=0,this.changesQueued={},this.changesRunning={}):o("[IndexedDB] Failed to open DB")}
...
i?(e(t.migrate(i.value)),i.continue()):n()}})},closeDB:function(){this.db.close()}},c.open=function(e,t){var n=setTimeout(function(){t("timeout trying to open db")},1e4)
...
n.onsuccess=function(){o("[IndexedDB] Done removing DB"),t()},n.onerror=n.onabort=function(t){console.error('Failed to remove database "'+e+'"',t)}},c._rs_init=function(e){return new Promise(function(t,n){c.open("remotestorage",function(i,o){i?n(i):(r=o,o.onerror=function(){e._emit("error",i)},t())})})},c._rs_supported=function(){return new Promise(function(e,t){var n=u.getGlobalContext(),r=!1
...
i.onerror=function(){t()},i.onsuccess=function(){i.result.close(),indexedDB.deleteDatabase("rs-check"),e()}}catch(e){t()}else t()})},c._rs_cleanup=function(e){return new Promise(function(t){e.local&&e.local.closeDB(),c.clean("remotestorage",t)})},e.exports=c},function(e,t,n){"use strict"
function r(e){return e.substr(0,c.length)===c||e.substr(0,l.length)===l}function i(e){return e.substr(0,c.length)===c}var o=n(9),s=n(1),a=n(2),u=n(0),c="remotestorage:cache:nodes:",l="remotestorage:cache:changes:",f=function(){o(this),s("[LocalStorage] Registering events"),a(this,"change","local-events-done")}
